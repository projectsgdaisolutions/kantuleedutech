...
Please change the parent <Route path="${e}"> to <Route path="${e===`/`?`*`:`${e}/*`}">.`)}let u=mt(),d;if(t){let e=typeof t==`string`?ce(t):t;T(c===`/`||e.pathname?.startsWith(c),`When overriding the location using \`<Routes location>\` or \`useRoutes(routes, location)\`, the location pathname must begin with the portion of the URL pathname that was matched by all parent routes. The current pathname base is "${c}" but pathname "${e.pathname}" was given in the \`location\` prop.`),d=e}else d=u;let f=d.pathname||`/`,p=f;if(c!==`/`){let e=c.replace(/^\//,``).split(`/`);p=`/`+f.replace(/^\//,``).split(`/`).slice(e.length).join(`/`)}let m=n&&n.state.matches.length?n.state.matches.map(e=>Object.assign(e,{route:n.manifest[e.route.id]||e.route})):D(e,{pathname:p});re(l||m!=null,`No routes matched location "${d.pathname}${d.search}${d.hash}" `),re(m==null||m[m.length-1].route.element!==void 0||m[m.length-1].route.Component!==void 0||m[m.length-1].route.lazy!==void 0,`Matched leaf route at location "${d.pathname}${d.search}${d.hash}" does not have an element or Component. This means it will render an <Outlet /> with a null value by default resulting in an "empty" page.`);let h=kt(m&&m.map(e=>Object.assign({},e,{params:Object.assign({},o,e.params),pathname:Ie([c,r.encodeLocation?r.encodeLocation(e.pathname.replace(/%/g,`%25`).replace(/\?/g,`%3F`).replace(/#/g,`%23`)).pathname:e.pathname]),pathnameBase:e.pathnameBase===`/`?c:Ie([c,r.encodeLocation?r.encodeLocation(e.pathnameBase.replace(/%/g,`%25`).replace(/\?/g,`%3F`).replace(/#/g,`%23`)).pathname:e.pathnameBase])})),i,n);return t&&h?x.createElement(it.Provider,{value:{location:{pathname:`/`,search:``,hash:``,state:null,key:`default`,mask:void 0,...d},navigationType:`POP`}},h):h}function Ct(){let e=It(),t=He(e)?`${e.status} ${e.statusText}`:e instanceof Error?e.message:JSON.stringify(e),n=e instanceof Error?e.stack:null,r=`rgba(200,200,200, 0.5)`,i={padding:`0.5rem`,backgroundColor:r},a={padding:`2px 4px`,backgroundColor:r},o=null;return console.error(`Error handled by React Router default ErrorBoundary:`,e),o=x.createElement(x.Fragment,null,x.createElement(`p`,null,`💿 Hey developer 👋`),x.createElement(`p`,null,`You can provide a way better UX than this when your app throws errors by providing your own `,x.createElement(`code`,{style:a},`ErrorBoundary`),` or`,` `,x.createElement(`code`,{style:a},`errorElement`),` prop on your route.`)),x.createElement(x.Fragment,null,x.createElement(`h2`,null,`Unexpected Application Error!`),x.createElement(`h3`,{style:{fontStyle:`italic`}},t),n?x.createElement(`pre`,{style:i},n):null,o)}var wt=x.createElement(Ct,null),Tt=class extends x.Component{constructor(e){super(e),this.state={location:e.location,revalidation:e.revalidation,error:e.error}}static getDerivedStateFromError(e){return{error:e}}static getDerivedStateFromProps(e,t){return t.location!==e.location||t.revalidation!==`idle`&&e.revalidation===`idle`?{error:e.error,location:e.location,revalidation:e.revalidation}:{error:e.error===void 0?t.error:e.error,location:t.location,revalidation:e.revalidation||t.revalidation}}componentDidCatch(e,t){this.props.onError?this.props.onError(e,t):console.error(`React Router caught the following error during render`,e)}render(){let e=this.state.error;if(this.context&&typeof e==`object`&&e&&`digest`in e&&typeof e.digest==`string`){let t=dt(e.digest);t&&(e=t)}let t=e===void 0?this.props.children:x.createElement(at.Provider,{value:this.props.routeContext},x.createElement(ot.Provider,{value:e,children:this.props.component}));return this.context?x.createElement(Dt,{error:e},t):t}};Tt.contextType=Qe;var Et=new WeakMap;function Dt({children:e,error:t}){let{basename:n}=x.useContext(rt);if(typeof t==`object`&&t&&`digest`in t&&typeof t.digest==`string`){let e=ut(t.digest);if(e){let r=Et.get(t);if(r)throw r;let i=Ge(e.location,n),a=i.absoluteURL||i.to;if(Ye(a))throw Error(`Invalid redirect location`);if(We&&!Et.get(t)){if(i.isExternal||e.reloadDocument)window.location.href=a;else{let n=Promise.resolve().then(()=>window.__reactRouterDataRouter.navigate(i.to,{replace:e.replace}));throw Et.set(t,n),n}}return x.createElement(`meta`,{httpEquiv:`refresh`,content:`0;url=${a}`})}}return e}function Ot({routeContext:e,match:t,children:n}){let r=x.useContext(Xe);return r&&r.static&&r.staticContext&&(t.route.errorElement||t.route.ErrorBoundary)&&(r.staticContext._deepestRenderedBoundaryId=t.route.id),x.createElement(at.Provider,{value:e},n)}function kt(e,t=[],n){let r=n?.state;if(e==null){if(!r)return null;if(r.errors)e=r.matches;else if(t.length===0&&!r.initialized&&r.matches.length>0)e=r.matches;else return null}let i=e,a=r?.errors;if(a!=null){let e=i.findIndex(e=>e.route.id&&a?.[e.route.id]!==void 0);T(e>=0,`Could not find a matching route for errors on route IDs: ${Object.keys(a).join(`,`)}`),i=i.slice(0,Math.min(i.length,e+1))}let o=!1,s=-1;if(n&&r){o=r.renderFallback;for(let e=0;e<i.length;e++){let t=i[e];if((t.route.HydrateFallback||t.route.hydrateFallbackElement)&&(s=e),t.route.id){let{loaderData:e,errors:a}=r,c=t.route.loader&&!e.hasOwnProperty(t.route.id)&&(!a||a[t.route.id]===void 0);if(t.route.lazy||c){n.isStatic&&(o=!0),i=s>=0?i.slice(0,s+1):[i[0]];break}}}}let c=n?.onError,l=r&&c?(e,t)=>{c(e,{location:r.location,params:r.matches?.[0]?.params??{},pattern:Ue(r.matches),errorInfo:t})}:void 0;return i.reduceRight((e,n,c)=>{let u,d=!1,f=null,p=null;r&&(u=a&&n.route.id?a[n.route.id]:void 0,f=n.route.errorElement||wt,o&&(s<0&&c===0?(zt(`route-fallback`,!1,"No `HydrateFallback` element provided to render during initial hydration"),d=!0,p=null):s===c&&(d=!0,p=n.route.hydrateFallbackElement||null)));let m=t.concat(i.slice(0,c+1)),h=()=>{let t;return t=u?f:d?p:n.route.Component?x.createElement(n.route.Component,null):n.route.element?n.route.element:e,x.createElement(Ot,{match:n,routeContext:{outlet:e,matches:m,isDataRoute:r!=null},children:t})};return r&&(n.route.ErrorBoundary||n.route.errorElement||c===0)?x.createElement(Tt,{location:r.location,revalidation:r.revalidation,component:f,error:u,children:h(),routeContext:{outlet:null,matches:m,isDataRoute:!0},onError:l}):h()},null)}function At(e){return`${e} must be used within a data router.  See https://reactrouter.com/en/main/routers/picking-a-router.`}function jt(e){let t=x.useContext(Xe);return T(t,At(e)),t}function Mt(e){let t=x.useContext(Ze);return T(t,At(e)),t}function Nt(e){let t=x.useContext(at);return T(t,At(e)),t}function Pt(e){let t=Nt(e),n=t.matches[t.matches.length-1];return T(n.route.id,`${e} can only be used on routes that contain a unique "id"`),n.route.id}function Ft(){return Pt(`useRouteId`)}function It(){let e=x.useContext(ot),t=Mt(`useRouteError`),n=Pt(`useRouteError`);return e===void 0?t.errors?.[n]:e}function Lt(){let{router:e}=jt(`useNavigate`),t=Pt(`useNavigate`),n=x.useRef(!1);return gt(()=>{n.current=!0}),x.useCallback(async(r,i={})=>{re(n.current,ht),n.current&&(typeof r==`number`?await e.navigate(r):await e.navigate(r,{fromRouteId:t,...i}))},[e,t])}var Rt={};function zt(e,t,n){!t&&!Rt[e]&&(Rt[e]=!0,re(!1,n))}x.memo(Bt);function Bt({routes:e,manifest:t,future:n,state:r,isStatic:i,onError:a}){return St(e,void 0,{manifest:t,state:r,isStatic:i,onError:a,future:n})}function Vt(e){T(!1,`A <Route> is only ever to be used as the child of <Routes> element, never rendered directly. Please wrap your <Route> in a <Routes>.`)}function Ht({basename:e=`/`,children:t=null,location:n,navigationType:r=`POP`,navigator:i,static:a=!1,useTransitions:o}){T(!pt(),`You cannot render a <Router> inside another <Router>. You should never have more than one in your app.`);let s=e.replace(/^\/*/,`/`),c=x.useMemo(()=>({basename:s,navigator:i,static:a,useTransitions:o,future:{}}),[s,i,a,o]);typeof n==`string`&&(n=ce(n));let{pathname:l=`/`,search:u=``,hash:d=``,state:f=null,key:p=`default`,mask:m}=n,h=x.useMemo(()=>{let e=Oe(l,s);return e==null?null:{location:{pathname:e,search:u,hash:d,state:f,key:p,mask:m},navigationType:r}},[s,l,u,d,f,p,r,m]);return re(h!=null,`<Router basename="${s}"> is not able to match the URL "${l}${u}${d}" because it does not start with the basename, so the <Router> won't render anything.`),h==null?null:x.createElement(rt.Provider,{value:c},x.createElement(it.Provider,{children:t,value:h}))}function Ut({children:e,location:t}){return xt(Wt(e),t)}x.Component;function Wt(e,t=[]){let n=[];return x.Children.forEach(e,(e,r)=>{if(!x.isValidElement(e))return;let i=[...t,r];if(e.type===x.Fragment){n.push.apply(n,Wt(e.props.children,i));return}T(e.type===Vt,`[${typeof e.type==`string`?e.type:e.type.name}] is not a <Route> component. All component children of <Routes> must be a <Route> or <React.Fragment>`),T(!e.props.index||!e.props.children,`An index route cannot have child routes.`);let a={id:e.props.id||i.join(`-`),caseSensitive:e.props.caseSensitive,element:e.props.element,Component:e.props.Component,index:e.props.index,path:e.props.path,middleware:e.props.middleware,loader:e.props.loader,action:e.props.action,hydrateFallbackElement:e.props.hydrateFallbackElement,HydrateFallback:e.props.HydrateFallback,errorElement:e.props.errorElement,ErrorBoundary:e.props.ErrorBoundary,hasErrorBoundary:e.props.hasErrorBoundary===!0||e.props.ErrorBoundary!=null||e.props.errorElement!=null,shouldRevalidate:e.props.shouldRevalidate,handle:e.props.handle,lazy:e.props.lazy};e.props.children&&(a.children=Wt(e.props.children,i)),n.push(a)}),n}var Gt=`get`,Kt=`application/x-www-form-urlencoded`;function qt(e){return typeof HTMLElement<`u`&&e instanceof HTMLElement}function Jt(e){return qt(e)&&e.tagName.toLowerCase()===`button`}function Yt(e){return qt(e)&&e.tagName.toLowerCase()===`form`}function Xt(e){return qt(e)&&e.tagName.toLowerCase()===`input`}function Zt(e){return!!(e.metaKey||e.altKey||e.ctrlKey||e.shiftKey)}function Qt(e,t){return e.button===0&&(!t||t===`_self`)&&!Zt(e)}function $t(e=``){return new URLSearchParams(typeof e==`string`||Array.isArray(e)||e instanceof URLSearchParams?e:Object.keys(e).reduce((t,n)=>{let r=e[n];return t.concat(Array.isArray(r)?r.map(e=>[n,e]):[[n,r]])},[]))}function en(e,t){let n=$t(e);return t&&t.forEach((e,r)=>{n.has(r)||t.getAll(r).forEach(e=>{n.append(r,e)})}),n}var tn=null;function nn(){if(tn===null)try{new FormData(document.createElement(`form`),0),tn=!1}catch{tn=!0}return tn}var rn=new Set([`application/x-www-form-urlencoded`,`multipart/form-data`,`text/plain`]);function an(e){return e!=null&&!rn.has(e)?(re(!1,`"${e}" is not a valid \`encType\` for \`<Form>\`/\`<fetcher.Form>\` and will default to "${Kt}"`),null):e}function on(e,t){let n,r,i,a,o;if(Yt(e)){let o=e.getAttribute(`action`);r=o?Oe(o,t):null,n=e.getAttribute(`method`)||Gt,i=an(e.getAttribute(`enctype`))||Kt,a=new FormData(e)}else if(Jt(e)||Xt(e)&&(e.type===`submit`||e.type===`image`)){let o=e.form;if(o==null)throw Error(`Cannot submit a <button> or <input type="submit"> without a <form>`);let s=e.getAttribute(`formaction`)||o.getAttribute(`action`);if(r=s?Oe(s,t):null,n=e.getAttribute(`formmethod`)||o.getAttribute(`method`)||Gt,i=an(e.getAttribute(`formenctype`))||an(o.getAttribute(`enctype`))||Kt,a=new FormData(o,e),!nn()){let{name:t,type:n,value:r}=e;if(n===`image`){let e=t?`${t}.`:``;a.append(`${e}x`,`0`),a.append(`${e}y`,`0`)}else t&&a.append(t,r)}}else if(qt(e))throw Error(`Cannot submit element that is not <form>, <button>, or <input type="submit|image">`);else n=Gt,r=null,i=Kt,o=e;return a&&i===`text/plain`&&(o=a,a=void 0),{action:r,method:n.toLowerCase(),encType:i,formData:a,body:o}}Object.getOwnPropertyNames(Object.prototype).sort().join(`\0`);function sn(e,t){if(e===!1||e==null)throw Error(t)}function cn(e,t,n,r){let i=typeof e==`string`?new URL(e,typeof window>`u`?`server://singlefetch/`:window.location.origin):e;return i.pathname=n?i.pathname.endsWith(`/`)?`${i.pathname}_.${r}`:`${i.pathname}.${r}`:i.pathname===`/`?`_root.${r}`:t&&Oe(i.pathname,t)===`/`?`${Le(t)}/_root.${r}`:`${Le(i.pathname)}.${r}`,i}async function ln(e,t){if(e.id in t)return t[e.id];try{let n=await b(()=>import(e.module),[]);return t[e.id]=n,n}catch(t){return console.error(`Error loading route module \`${e.module}\`, reloading page...`),console.error(t),window.__reactRouterContext&&window.__reactRouterContext.isSpaMode,window.location.reload(),new Promise(()=>{})}}function un(e){return e!=null&&typeof e.page==`string`}function dn(e){return e==null?!1:e.href==null?e.rel===`preload`&&typeof e.imageSrcSet==`string`&&typeof e.imageSizes==`string`:typeof e.rel==`string`&&typeof e.href==`string`}async function fn(e,t,n){return _n((await Promise.all(e.map(async e=>{let r=t.routes[e.route.id];if(r){let e=await ln(r,n);return e.links?e.links():[]}return[]}))).flat(1).filter(dn).filter(e=>e.rel===`stylesheet`||e.rel===`preload`).map(e=>e.rel===`stylesheet`?{...e,rel:`prefetch`,as:`style`}:{...e,rel:`prefetch`}))}function pn(e,t,n,r,i,a){let o=(e,t)=>!n[t]||e.route.id!==n[t].route.id,s=(e,t)=>n[t].pathname!==e.pathname||n[t].route.path?.endsWith(`*`)&&n[t].params[`*`]!==e.params[`*`];return a===`assets`?t.filter((e,t)=>o(e,t)||s(e,t)):a===`data`?t.filter((t,a)=>{let c=r.routes[t.route.id];if(!c||!c.hasLoader)return!1;if(o(t,a)||s(t,a))return!0;if(t.route.shouldRevalidate){let r=t.route.shouldRevalidate({currentUrl:new URL(i.pathname+i.search+i.hash,window.origin),currentParams:n[0]?.params||{},nextUrl:new URL(e,window.origin),nextParams:t.params,defaultShouldRevalidate:!0});if(typeof r==`boolean`)return r}return!0}):[]}function mn(e,t,{includeHydrateFallback:n}={}){return hn(e.map(e=>{let r=t.routes[e.route.id];if(!r)return[];let i=[r.module];return r.clientActionModule&&(i=i.concat(r.clientActionModule)),r.clientLoaderModule&&(i=i.concat(r.clientLoaderModule)),n&&r.hydrateFallbackModule&&(i=i.concat(r.hydrateFallbackModule)),r.imports&&(i=i.concat(r.imports)),i}).flat(1))}function hn(e){return[...new Set(e)]}function gn(e){let t={},n=Object.keys(e).sort();for(let r of n)t[r]=e[r];return t}function _n(e,t){let n=new Set,r=new Set(t);return e.reduce((e,i)=>{if(t&&!un(i)&&i.as===`script`&&i.href&&r.has(i.href))return e;let a=JSON.stringify(gn(i));return n.has(a)||(n.add(a),e.push({key:a,link:i})),e},[])}function vn(){let e=x.useContext(Xe);return sn(e,`You must render this element inside a <DataRouterContext.Provider> element`),e}function yn(){let e=x.useContext(Ze);return sn(e,`You must render this element inside a <DataRouterStateContext.Provider> element`),e}var bn=x.createContext(void 0);bn.displayName=`FrameworkContext`;function xn(){let e=x.useContext(bn);return sn(e,`You must render this element inside a <HydratedRouter> element`),e}function Sn(e,t){let n=x.useContext(bn),[r,i]=x.useState(!1),[a,o]=x.useState(!1),{onFocus:s,onBlur:c,onMouseEnter:l,onMouseLeave:u,onTouchStart:d}=t,f=x.useRef(null);x.useEffect(()=>{if(e===`render`&&o(!0),e===`viewport`){let e=new IntersectionObserver(e=>{e.forEach(e=>{o(e.isIntersecting)})},{threshold:.5});return f.current&&e.observe(f.current),()=>{e.disconnect()}}},[e]),x.useEffect(()=>{if(r){let e=setTimeout(()=>{o(!0)},100);return()=>{clearTimeout(e)}}},[r]);let p=()=>{i(!0)},m=()=>{i(!1),o(!1)};return n?e===`intent`?[a,f,{onFocus:Cn(s,p),onBlur:Cn(c,m),onMouseEnter:Cn(l,p),onMouseLeave:Cn(u,m),onTouchStart:Cn(d,p)}]:[a,f,{}]:[!1,f,{}]}function Cn(e,t){return n=>{e&&e(n),n.defaultPrevented||t(n)}}function wn({page:e,...t}){let n=$e(),{nonce:r}=xn(),{router:i}=vn(),a=x.useMemo(()=>D(i.routes,e,i.basename),[i.routes,e,i.basename]);return a?(t.nonce==null&&r&&(t={...t,nonce:r}),n?x.createElement(En,{page:e,matches:a,...t}):x.createElement(Dn,{page:e,matches:a,...t})):null}function Tn(e){let{manifest:t,routeModules:n}=xn(),[r,i]=x.useState([]);return x.useEffect(()=>{let r=!1;return fn(e,t,n).then(e=>{r||i(e)}),()=>{r=!0}},[e,t,n]),r}function En({page:e,matches:t,...n}){let r=mt(),{future:i}=xn(),{basename:a}=vn(),o=x.useMemo(()=>{if(e===r.pathname+r.search+r.hash)return[];let n=cn(e,a,i.v8_trailingSlashAwareDataRequests,`rsc`),o=!1,s=[];for(let e of t)typeof e.route.shouldRevalidate==`function`?o=!0:s.push(e.route.id);return o&&s.length>0&&n.searchParams.set(`_routes`,s.join(`,`)),[n.pathname+n.search]},[a,i.v8_trailingSlashAwareDataRequests,e,r,t]);return x.createElement(x.Fragment,null,o.map(e=>x.createElement(`link`,{key:e,rel:`prefetch`,as:`fetch`,href:e,...n})))}function Dn({page:e,matches:t,...n}){let r=mt(),{future:i,manifest:a,routeModules:o}=xn(),{basename:s}=vn(),{loaderData:c,matches:l}=yn(),u=x.useMemo(()=>pn(e,t,l,a,r,`data`),[e,t,l,a,r]),d=x.useMemo(()=>pn(e,t,l,a,r,`assets`),[e,t,l,a,r]),f=x.useMemo(()=>{if(e===r.pathname+r.search+r.hash)return[];let n=new Set,l=!1;if(t.forEach(e=>{let t=a.routes[e.route.id];!t||!t.hasLoader||(!u.some(t=>t.route.id===e.route.id)&&e.route.id in c&&o[e.route.id]?.shouldRevalidate||t.hasClientLoader?l=!0:n.add(e.route.id))}),n.size===0)return[];let d=cn(e,s,i.v8_trailingSlashAwareDataRequests,`data`);return l&&n.size>0&&d.searchParams.set(`_routes`,t.filter(e=>n.has(e.route.id)).map(e=>e.route.id).join(`,`)),[d.pathname+d.search]},[s,i.v8_trailingSlashAwareDataRequests,c,r,a,u,t,e,o]),p=x.useMemo(()=>mn(d,a),[d,a]),m=Tn(d);return x.createElement(x.Fragment,null,f.map(e=>x.createElement(`link`,{key:e,rel:`prefetch`,as:`fetch`,href:e,...n})),p.map(e=>x.createElement(`link`,{key:e,rel:`modulepreload`,href:e,...n})),m.map(({key:e,link:t})=>x.createElement(`link`,{key:e,nonce:n.nonce,...t,crossOrigin:t.crossOrigin??n.crossOrigin})))}function On(...e){return t=>{e.forEach(e=>{typeof e==`function`?e(t):e!=null&&(e.current=t)})}}x.Component;var kn=typeof window<`u`&&window.document!==void 0&&window.document.createElement!==void 0;try{kn&&(window.__reactRouterVersion=`7.18.2`)}catch{}function An({basename:e,children:t,useTransitions:n,window:r}){let i=x.useRef();i.current??=ne({window:r,v5Compat:!0});let a=i.current,[o,s]=x.useState({action:a.action,location:a.location}),c=x.useCallback(e=>{n===!1?s(e):x.startTransition(()=>s(e))},[n]);return x.useLayoutEffect(()=>a.listen(c),[a,c]),x.createElement(Ht,{basename:e,children:t,location:o.location,navigationType:o.action,navigator:a,useTransitions:n})}var jn=x.forwardRef(function({onClick:e,discover:t=`render`,prefetch:n=`none`,relative:r,reloadDocument:i,replace:a,mask:o,state:s,target:c,to:l,preventScrollReset:u,viewTransition:d,defaultShouldRevalidate:f,...p},m){let{basename:h,navigator:g,useTransitions:_}=x.useContext(rt),v=typeof l==`string`&&S.test(l),y=Ge(l,h);l=y.to;let b=ft(l,{relative:r}),C=mt(),w=null;if(o){let e=Pe(o,[],C.mask?C.mask.pathname:`/`,!0);h!==`/`&&(e.pathname=e.pathname===`/`?h:Ie([h,e.pathname])),w=g.createHref(e)}let[ee,te,ne]=Sn(n,p),T=In(l,{replace:a,mask:o,state:s,target:c,preventScrollReset:u,relative:r,viewTransition:d,defaultShouldRevalidate:f,useTransitions:_});function re(t){e&&e(t),t.defaultPrevented||T(t)}let ie=!(y.isExternal||i),ae=x.createElement(`a`,{...p,...ne,href:(ie?w:void 0)||y.absoluteURL||b,onClick:ie?re:e,ref:On(m,te),target:c,"data-discover":!v&&t===`render`?`true`:void 0});return ee&&!v?x.createElement(x.Fragment,null,ae,x.createElement(wn,{page:b})):ae});jn.displayName=`Link`;var Mn=x.forwardRef(function({"aria-current":e=`page`,caseSensitive:t=!1,className:n=``,end:r=!1,style:i,to:a,viewTransition:o,children:s,...c},l){let u=bt(a,{relative:c.relative}),d=mt(),f=x.useContext(Ze),{navigator:p,basename:m}=x.useContext(rt),h=f!=null&&Hn(u)&&o===!0,g=p.encodeLocation?p.encodeLocation(u).pathname:u.pathname,_=d.pathname,v=f&&f.navigation&&f.navigation.location?f.navigation.location.pathname:null;t||(_=_.toLowerCase(),v=v?v.toLowerCase():null,g=g.toLowerCase()),v&&m&&(v=Oe(v,m)||v);let y=g!==`/`&&g.endsWith(`/`)?g.length-1:g.length,b=_===g||!r&&_.startsWith(g)&&_.charAt(y)===`/`,S=v!=null&&(v===g||!r&&v.startsWith(g)&&v.charAt(g.length)===`/`),C={isActive:b,isPending:S,isTransitioning:h},w=b?e:void 0,ee;ee=typeof n==`function`?n(C):[n,b?`active`:null,S?`pending`:null,h?`transitioning`:null].filter(Boolean).join(` `);let te=typeof i==`function`?i(C):i;return x.createElement(jn,{...c,"aria-current":w,className:ee,ref:l,style:te,to:a,viewTransition:o},typeof s==`function`?s(C):s)});Mn.displayName=`NavLink`;var Nn=x.forwardRef(({discover:e=`render`,fetcherKey:t,navigate:n,reloadDocument:r,replace:i,state:a,method:o=Gt,action:s,onSubmit:c,relative:l,preventScrollReset:u,viewTransition:d,defaultShouldRevalidate:f,...p},m)=>{let{useTransitions:h}=x.useContext(rt),g=Bn(),_=Vn(s,{relative:l}),v=o.toLowerCase()===`get`?`get`:`post`,y=typeof s==`string`&&S.test(s);return x.createElement(`form`,{ref:m,method:v,action:_,onSubmit:r?c:e=>{if(c&&c(e),e.defaultPrevented)return;e.preventDefault();let r=e.nativeEvent.submitter,s=r?.getAttribute(`formmethod`)||o,p=()=>g(r||e.currentTarget,{fetcherKey:t,method:s,navigate:n,replace:i,state:a,relative:l,preventScrollReset:u,viewTransition:d,defaultShouldRevalidate:f});h&&n!==!1?x.startTransition(()=>p()):p()},...p,"data-discover":!y&&e===`render`?`true`:void 0})});Nn.displayName=`Form`;function Pn(e){return`${e} must be used within a data router.  See https://reactrouter.com/en/main/routers/picking-a-router.`}function Fn(e){let t=x.useContext(Xe);return T(t,Pn(e)),t}function In(e,{target:t,replace:n,mask:r,state:i,preventScrollReset:a,relative:o,viewTransition:s,defaultShouldRevalidate:c,useTransitions:l}={}){let u=_t(),d=mt(),f=bt(e,{relative:o});return x.useCallback(p=>{if(Qt(p,t)){p.preventDefault();let t=n===void 0?se(d)===se(f):n,m=()=>u(e,{replace:t,mask:r,state:i,preventScrollReset:a,relative:o,viewTransition:s,defaultShouldRevalidate:c});l?x.startTransition(()=>m()):m()}},[d,u,f,n,r,i,t,e,a,o,s,c,l])}function Ln(e){re(typeof URLSearchParams<`u`,"You cannot use the `useSearchParams` hook in a browser that does not support the URLSearchParams API. If you need to support Internet Explorer 11, we recommend you load a polyfill such as https://github.com/ungap/url-search-params.");let t=x.useRef($t(e)),n=x.useRef(!1),r=mt(),i=x.useMemo(()=>en(r.search,n.current?null:t.current),[r.search]),a=_t();return[i,x.useCallback((e,t)=>{let r=$t(typeof e==`function`?e(new URLSearchParams(i)):e);n.current=!0,a(`?`+r,t)},[a,i])]}var Rn=0,zn=()=>`__${String(++Rn)}__`;function Bn(){let{router:e}=Fn(`useSubmit`),{basename:t}=x.useContext(rt),n=Ft(),r=e.fetch,i=e.navigate;return x.useCallback(async(e,a={})=>{let{action:o,method:s,encType:c,formData:l,body:u}=on(e,t);if(a.navigate===!1){let e=a.fetcherKey||zn();await r(e,n,a.action||o,{defaultShouldRevalidate:a.defaultShouldRevalidate,preventScrollReset:a.preventScrollReset,formData:l,body:u,formMethod:a.method||s,formEncType:a.encType||c,flushSync:a.flushSync})}else await i(a.action||o,{defaultShouldRevalidate:a.defaultShouldRevalidate,preventScrollReset:a.preventScrollReset,formData:l,body:u,formMethod:a.method||s,formEncType:a.encType||c,replace:a.replace,state:a.state,fromRouteId:n,flushSync:a.flushSync,viewTransition:a.viewTransition})},[r,i,t,n])}function Vn(e,{relative:t}={}){let{basename:n}=x.useContext(rt),r=x.useContext(at);T(r,`useFormAction must be used inside a RouteContext`);let[i]=r.matches.slice(-1),a={...bt(e||`.`,{relative:t})},o=mt();if(e==null){a.search=o.search;let e=new URLSearchParams(a.search),t=e.getAll(`index`);if(t.some(e=>e===``)){e.delete(`index`),t.filter(e=>e).forEach(t=>e.append(`index`,t));let n=e.toString();a.search=n?`?${n}`:``}}return(!e||e===`.`)&&i.route.index&&(a.search=a.search?a.search.replace(/^\?/,`?index&`):`?index`),n!==`/`&&(a.pathname=a.pathname===`/`?n:Ie([n,a.pathname])),se(a)}function Hn(e,{relative:t}={}){let n=x.useContext(et);T(n!=null,"`useViewTransitionState` must be used within `react-router-dom`'s `RouterProvider`.  Did you accidentally import `RouterProvider` from `react-router`?");let{basename:r}=Fn(`useViewTransitionState`),i=bt(e,{relative:t});if(!n.isTransitioning)return!1;let a=Oe(n.currentLocation.pathname,r)||n.currentLocation.pathname,o=Oe(n.nextLocation.pathname,r)||n.nextLocation.pathname;return we(i.pathname,o)!=null||we(i.pathname,a)!=null}var Un=(...e)=>e.filter((e,t,n)=>!!e&&e.trim()!==``&&n.indexOf(e)===t).join(` `).trim(),Wn=e=>e.replace(/([a-z0-9])([A-Z])/g,`$1-$2`).toLowerCase(),Gn=e=>e.replace(/^([A-Z])|[\s-_]+(\w)/g,(e,t,n)=>n?n.toUpperCase():t.toLowerCase()),Kn=e=>{let t=Gn(e);return t.charAt(0).toUpperCase()+t.slice(1)},qn={xmlns:`http://www.w3.org/2000/svg`,width:24,height:24,viewBox:`0 0 24 24`,fill:`none`,stroke:`currentColor`,strokeWidth:2,strokeLinecap:`round`,strokeLinejoin:`round`},Jn=e=>{for(let t in e)if(t.startsWith(`aria-`)||t===`role`||t===`title`)return!0;return!1},Yn=(0,x.createContext)({}),Xn=()=>(0,x.useContext)(Yn),Zn=(0,x.forwardRef)(({color:e,size:t,strokeWidth:n,absoluteStrokeWidth:r,className:i=``,children:a,iconNode:o,...s},c)=>{let{size:l=24,strokeWidth:u=2,absoluteStrokeWidth:d=!1,color:f=`currentColor`,className:p=``}=Xn()??{},m=r??d?Number(n??u)*24/Number(t??l):n??u;return(0,x.createElement)(`svg`,{ref:c,...qn,width:t??l??qn.width,height:t??l??qn.height,stroke:e??f,strokeWidth:m,className:Un(`lucide`,p,i),...!a&&!Jn(s)&&{"aria-hidden":`true`},...s},[...o.map(([e,t])=>(0,x.createElement)(e,t)),...Array.isArray(a)?a:[a]])}),k=(e,t)=>{let n=(0,x.forwardRef)(({className:n,...r},i)=>(0,x.createElement)(Zn,{ref:i,iconNode:t,className:Un(`lucide-${Wn(Kn(e))}`,`lucide-${e}`,n),...r}));return n.displayName=Kn(e),n},Qn=k(`arrow-left`,[[`path`,{d:`m12 19-7-7 7-7`,key:`1l729n`}],[`path`,{d:`M19 12H5`,key:`x3x0zl`}]]),$n=k(`arrow-right`,[[`path`,{d:`M5 12h14`,key:`1ays0h`}],[`path`,{d:`m12 5 7 7-7 7`,key:`xquz4c`}]]),er=k(`arrow-up-right`,[[`path`,{d:`M7 7h10v10`,key:`1tivn9`}],[`path`,{d:`M7 17 17 7`,key:`1vkiza`}]]),tr=k(`book-open`,[[`path`,{d:`M12 5v16`,key:`1f6ucr`}],[`path`,{d:`M20.001 19A2 2 0 0022 17V5a2 2 0 00-1.999-2L16 3.002A5 5 0 0012 5a5 5 0 00-4-2H4a2 2 0 00-2 2v12a2 2 0 001.999 2H8a5 5 0 014 2 5 5 0 014-2z`,key:`1fyvmf`}]]),nr=k(`briefcase`,[[`path`,{d:`M16 20V4a2 2 0 0 0-2-2h-4a2 2 0 0 0-2 2v16`,key:`jecpp`}],[`rect`,{width:`20`,height:`14`,x:`2`,y:`6`,rx:`2`,key:`i6l2r4`}]]),rr=k(`building-2`,[[`path`,{d:`M10 12h4`,key:`a56b0p`}],[`path`,{d:`M10 8h4`,key:`1sr2af`}],[`path`,{d:`M14 21v-3a2 2 0 0 0-4 0v3`,key:`1rgiei`}],[`path`,{d:`M6 10H4a2 2 0 0 0-2 2v7a2 2 0 0 0 2 2h16a2 2 0 0 0 2-2V9a2 2 0 0 0-2-2h-2`,key:`secmi2`}],[`path`,{d:`M6 21V5a2 2 0 0 1 2-2h8a2 2 0 0 1 2 2v16`,key:`16ra0t`}]]),ir=k(`calendar-days`,[[`path`,{d:`M8 2v3`,key:`1ioesn`}],[`path`,{d:`M16 2v3`,key:`otl347`}],[`rect`,{x:`3`,y:`3`,width:`18`,height:`18`,rx:`2`,key:`h1oib`}],[`path`,{d:`M3 9h18`,key:`1pudct`}],[`path`,{d:`M8 13h.01`,key:`1sbv64`}],[`path`,{d:`M12 13h.01`,key:`y0uutt`}],[`path`,{d:`M16 13h.01`,key:`wip0gl`}],[`path`,{d:`M8 17h.01`,key:`p3bg7i`}],[`path`,{d:`M12 17h.01`,key:`p32p05`}],[`path`,{d:`M16 17h.01`,key:`ql8jdd`}]]),ar=k(`check`,[[`path`,{d:`M20 6 9 17l-5-5`,key:`1gmf2c`}]]),or=k(`chevron-down`,[[`path`,{d:`m6 9 6 6 6-6`,key:`qrunsl`}]]),sr=k(`chevron-left`,[[`path`,{d:`m15 18-6-6 6-6`,key:`1wnfg3`}]]),cr=k(`chevron-right`,[[`path`,{d:`m9 18 6-6-6-6`,key:`mthhwq`}]]),lr=k(`circle-check`,[[`circle`,{cx:`12`,cy:`12`,r:`10`,key:`1mglay`}],[`path`,{d:`m9 12 2 2 4-4`,key:`dzmm74`}]]),ur=k(`clipboard-check`,[[`rect`,{width:`8`,height:`4`,x:`8`,y:`2`,rx:`1`,ry:`1`,key:`tgr4d6`}],[`path`,{d:`M16 4h2a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2H6a2 2 0 0 1-2-2V6a2 2 0 0 1 2-2h2`,key:`116196`}],[`path`,{d:`m9 14 2 2 4-4`,key:`df797q`}]]),dr=k(`clipboard-list`,[[`rect`,{width:`8`,height:`4`,x:`8`,y:`2`,rx:`1`,ry:`1`,key:`tgr4d6`}],[`path`,{d:`M16 4h2a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2H6a2 2 0 0 1-2-2V6a2 2 0 0 1 2-2h2`,key:`116196`}],[`path`,{d:`M12 11h4`,key:`1jrz19`}],[`path`,{d:`M12 16h4`,key:`n85exb`}],[`path`,{d:`M8 11h.01`,key:`1dfujw`}],[`path`,{d:`M8 16h.01`,key:`18s6g9`}]]),fr=k(`clock-3`,[[`circle`,{cx:`12`,cy:`12`,r:`10`,key:`1mglay`}],[`path`,{d:`M12 6v6h4`,key:`135r8i`}]]),pr=k(`clock`,[[`circle`,{cx:`12`,cy:`12`,r:`10`,key:`1mglay`}],[`path`,{d:`M12 6v6l4 2`,key:`mmk7yg`}]]),mr=k(`earth`,[[`path`,{d:`M21.54 15H17a2 2 0 0 0-2 2v4.54`,key:`1djwo0`}],[`path`,{d:`M7 3.34V5a3 3 0 0 0 3 3a2 2 0 0 1 2 2c0 1.1.9 2 2 2a2 2 0 0 0 2-2c0-1.1.9-2 2-2h3.17`,key:`1tzkfa`}],[`path`,{d:`M11 21.95V18a2 2 0 0 0-2-2a2 2 0 0 1-2-2v-1a2 2 0 0 0-2-2H2.05`,key:`14pb5j`}],[`circle`,{cx:`12`,cy:`12`,r:`10`,key:`1mglay`}]]),hr=k(`external-link`,[[`path`,{d:`M15 3h6v6`,key:`1q9fwt`}],[`path`,{d:`M10 14 21 3`,key:`gplh6r`}],[`path`,{d:`M18 13v6a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h6`,key:`a6xqqp`}]]),gr=k(`eye`,[[`path`,{d:`M2.062 12.348a1 1 0 0 1 0-.696 10.75 10.75 0 0 1 19.876 0 1 1 0 0 1 0 .696 10.75 10.75 0 0 1-19.876 0`,key:`1nclc0`}],[`circle`,{cx:`12`,cy:`12`,r:`3`,key:`1v7zrd`}]]),_r=k(`file-check`,[[`path`,{d:`M6 22a2 2 0 0 1-2-2V4a2 2 0 0 1 2-2h8a2.4 2.4 0 0 1 1.704.706l3.588 3.588A2.4 2.4 0 0 1 20 8v12a2 2 0 0 1-2 2z`,key:`1oefj6`}],[`path`,{d:`M14 2v5a1 1 0 0 0 1 1h5`,key:`wfsgrz`}],[`path`,{d:`m9 15 2 2 4-4`,key:`1grp1n`}]]),vr=k(`file-text`,[[`path`,{d:`M6 22a2 2 0 0 1-2-2V4a2 2 0 0 1 2-2h8a2.4 2.4 0 0 1 1.704.706l3.588 3.588A2.4 2.4 0 0 1 20 8v12a2 2 0 0 1-2 2z`,key:`1oefj6`}],[`path`,{d:`M14 2v5a1 1 0 0 0 1 1h5`,key:`wfsgrz`}],[`path`,{d:`M10 9H8`,key:`b1mrlr`}],[`path`,{d:`M16 13H8`,key:`t4e002`}],[`path`,{d:`M16 17H8`,key:`z1uh3a`}]]),yr=k(`graduation-cap`,[[`path`,{d:`M21.42 10.922a1 1 0 0 0-.019-1.838L12.83 5.18a2 2 0 0 0-1.66 0L2.6 9.08a1 1 0 0 0 0 1.832l8.57 3.908a2 2 0 0 0 1.66 0z`,key:`j76jl0`}],[`path`,{d:`M22 10v6`,key:`1lu8f3`}],[`path`,{d:`M6 12.5V16a6 3 0 0 0 12 0v-3.5`,key:`1r8lef`}]]),br=k(`headphones`,[[`path`,{d:`M3 14h3a2 2 0 0 1 2 2v3a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-7a9 9 0 0 1 18 0v7a2 2 0 0 1-2 2h-1a2 2 0 0 1-2-2v-3a2 2 0 0 1 2-2h3`,key:`1xhozi`}]]),xr=k(`heart-handshake`,[[`path`,{d:`M19.414 14.414C21 12.828 22 11.5 22 9.5a5.5 5.5 0 0 0-9.591-3.676.6.6 0 0 1-.818.001A5.5 5.5 0 0 0 2 9.5c0 2.3 1.5 4 3 5.5l5.535 5.362a2 2 0 0 0 2.879.052 2.12 2.12 0 0 0-.004-3 2.124 2.124 0 1 0 3-3 2.124 2.124 0 0 0 3.004 0 2 2 0 0 0 0-2.828l-1.881-1.882a2.41 2.41 0 0 0-3.409 0l-1.71 1.71a2 2 0 0 1-2.828 0 2 2 0 0 1 0-2.828l2.823-2.762`,key:`17lmqv`}]]),Sr=k(`images`,[[`path`,{d:`m22 11-1.296-1.296a2.4 2.4 0 0 0-3.408 0L11 16`,key:`9kzy35`}],[`path`,{d:`M4 8a2 2 0 0 0-2 2v10a2 2 0 0 0 2 2h10a2 2 0 0 0 2-2`,key:`1t0f0t`}],[`circle`,{cx:`13`,cy:`7`,r:`1`,fill:`currentColor`,key:`1obus6`}],[`rect`,{x:`8`,y:`2`,width:`14`,height:`14`,rx:`2`,key:`1gvhby`}]]),Cr=k(`lightbulb`,[[`path`,{d:`M15 14c.2-1 .7-1.7 1.5-2.5 1-.9 1.5-2.2 1.5-3.5A6 6 0 0 0 6 8c0 1 .2 2.2 1.5 3.5.7.7 1.3 1.5 1.5 2.5`,key:`1gvzjb`}],[`path`,{d:`M9 18h6`,key:`x1upvd`}],[`path`,{d:`M10 22h4`,key:`ceow96`}]]),wr=k(`list-checks`,[[`path`,{d:`M13 5h8`,key:`a7qcls`}],[`path`,{d:`M13 12h8`,key:`h98zly`}],[`path`,{d:`M13 19h8`,key:`c3s6r1`}],[`path`,{d:`m3 17 2 2 4-4`,key:`1jhpwq`}],[`path`,{d:`m3 7 2 2 4-4`,key:`1obspn`}]]),Tr=k(`mail`,[[`path`,{d:`m22 7-8.991 5.727a2 2 0 0 1-2.009 0L2 7`,key:`132q7q`}],[`rect`,{x:`2`,y:`4`,width:`20`,height:`16`,rx:`2`,key:`izxlao`}]]),Er=k(`map-pin`,[[`path`,{d:`M20 10c0 4.993-5.539 10.193-7.399 11.799a1 1 0 0 1-1.202 0C9.539 20.193 4 14.993 4 10a8 8 0 0 1 16 0`,key:`1r0f0z`}],[`circle`,{cx:`12`,cy:`10`,r:`3`,key:`ilqhr7`}]]),Dr=k(`maximize-2`,[[`path`,{d:`M15 3h6v6`,key:`1q9fwt`}],[`path`,{d:`m21 3-7 7`,key:`1l2asr`}],[`path`,{d:`m3 21 7-7`,key:`tjx5ai`}],[`path`,{d:`M9 21H3v-6`,key:`wtvkvv`}]]),Or=k(`menu`,[[`path`,{d:`M4 5h16`,key:`1tepv9`}],[`path`,{d:`M4 12h16`,key:`1lakjw`}],[`path`,{d:`M4 19h16`,key:`1djgab`}]]),kr=k(`message-circle`,[[`path`,{d:`M2.992 16.342a2 2 0 0 1 .094 1.167l-1.065 3.29a1 1 0 0 0 1.236 1.168l3.413-.998a2 2 0 0 1 1.099.092 10 10 0 1 0-4.777-4.719`,key:`1sd12s`}]]),Ar=k(`navigation`,[[`polygon`,{points:`3 11 22 2 13 21 11 13 3 11`,key:`1ltx0t`}]]),jr=k(`phone`,[[`path`,{d:`M13.832 16.568a1 1 0 0 0 1.213-.303l.355-.465A2 2 0 0 1 17 15h3a2 2 0 0 1 2 2v3a2 2 0 0 1-2 2A18 18 0 0 1 2 4a2 2 0 0 1 2-2h3a2 2 0 0 1 2 2v3a2 2 0 0 1-.8 1.6l-.468.351a1 1 0 0 0-.292 1.233 14 14 0 0 0 6.392 6.384`,key:`9njp5v`}]]),Mr=k(`plane`,[[`path`,{d:`M17.8 19.2 16 11l3.5-3.5C21 6 21.5 4 21 3c-1-.5-3 0-4.5 1.5L13 8 4.8 6.2c-.5-.1-.9.1-1.1.5l-.3.5c-.2.5-.1 1 .3 1.3L9 12l-2 3H4l-1 1 3 2 2 3 1-1v-3l3-2 3.5 5.3c.3.4.8.5 1.3.3l.5-.2c.4-.3.6-.7.5-1.2z`,key:`1v9wt8`}]]),Nr=k(`send`,[[`path`,{d:`M14.536 21.686a.5.5 0 0 0 .937-.024l6.5-19a.496.496 0 0 0-.635-.635l-19 6.5a.5.5 0 0 0-.024.937l7.93 3.18a2 2 0 0 1 1.112 1.11z`,key:`1ffxy3`}],[`path`,{d:`m21.854 2.147-10.94 10.939`,key:`12cjpa`}]]),Pr=k(`shield-check`,[[`path`,{d:`M20 13c0 5-3.5 7.5-7.66 8.95a1 1 0 0 1-.67-.01C7.5 20.5 4 18 4 13V6a1 1 0 0 1 1-1c2 0 4.5-1.2 6.24-2.72a1.17 1.17 0 0 1 1.52 0C14.51 3.81 17 5 19 5a1 1 0 0 1 1 1z`,key:`oel41y`}],[`path`,{d:`m9 12 2 2 4-4`,key:`dzmm74`}]]),Fr=k(`shield`,[[`path`,{d:`M20 13c0 5-3.5 7.5-7.66 8.95a1 1 0 0 1-.67-.01C7.5 20.5 4 18 4 13V6a1 1 0 0 1 1-1c2 0 4.5-1.2 6.24-2.72a1.17 1.17 0 0 1 1.52 0C14.51 3.81 17 5 19 5a1 1 0 0 1 1 1z`,key:`oel41y`}]]),Ir=k(`sparkles`,[[`path`,{d:`M11.017 2.814a1 1 0 0 1 1.966 0l1.051 5.558a2 2 0 0 0 1.594 1.594l5.558 1.051a1 1 0 0 1 0 1.966l-5.558 1.051a2 2 0 0 0-1.594 1.594l-1.051 5.558a1 1 0 0 1-1.966 0l-1.051-5.558a2 2 0 0 0-1.594-1.594l-5.558-1.051a1 1 0 0 1 0-1.966l5.558-1.051a2 2 0 0 0 1.594-1.594z`,key:`1s2grr`}],[`path`,{d:`M20 2v4`,key:`1rf3ol`}],[`path`,{d:`M22 4h-4`,key:`gwowj6`}],[`circle`,{cx:`4`,cy:`20`,r:`2`,key:`6kqj1y`}]]),Lr=k(`star`,[[`path`,{d:`M11.525 2.295a.53.53 0 0 1 .95 0l2.31 4.679a2.123 2.123 0 0 0 1.595 1.16l5.166.756a.53.53 0 0 1 .294.904l-3.736 3.638a2.123 2.123 0 0 0-.611 1.878l.882 5.14a.53.53 0 0 1-.771.56l-4.618-2.428a2.122 2.122 0 0 0-1.973 0L6.396 21.01a.53.53 0 0 1-.77-.56l.881-5.139a2.122 2.122 0 0 0-.611-1.879L2.16 9.795a.53.53 0 0 1 .294-.906l5.165-.755a2.122 2.122 0 0 0 1.597-1.16z`,key:`r04s7s`}]]),Rr=k(`user-round`,[[`circle`,{cx:`12`,cy:`8`,r:`5`,key:`1hypcn`}],[`path`,{d:`M20 21a8 8 0 0 0-16 0`,key:`rfgkzh`}]]),zr=k(`users`,[[`path`,{d:`M16 21v-2a4 4 0 0 0-4-4H6a4 4 0 0 0-4 4v2`,key:`1yyitq`}],[`path`,{d:`M16 3.128a4 4 0 0 1 0 7.744`,key:`16gr8j`}],[`path`,{d:`M22 21v-2a4 4 0 0 0-3-3.87`,key:`kshegd`}],[`circle`,{cx:`9`,cy:`7`,r:`4`,key:`nufk8`}]]),Br=k(`wallet-cards`,[[`path`,{d:`M3 11h3.75a2 2 0 0 1 1.6.8l.45.6a4 4 0 0 0 6.4 0l.45-.6a2 2 0 0 1 1.6-.8H21`,key:`1vwh6y`}],[`path`,{d:`M3 7h18`,key:`1uiuf2`}],[`rect`,{x:`3`,y:`3`,width:`18`,height:`18`,rx:`2`,key:`h1oib`}]]),Vr=k(`x`,[[`path`,{d:`M18 6 6 18`,key:`1bl5f8`}],[`path`,{d:`m6 6 12 12`,key:`d8bk6v`}]]),Hr=o((e=>{var t=Symbol.for(`react.transitional.element`),n=Symbol.for(`react.fragment`);function r(e,n,r){var i=null;if(r!==void 0&&(i=``+r),n.key!==void 0&&(i=``+n.key),`key`in n)for(var a in r={},n)a!==`key`&&(r[a]=n[a]);else r=n;return n=r.ref,{$$typeof:t,type:e,key:i,ref:n===void 0?null:n,props:r}}e.Fragment=n,e.jsx=r,e.jsxs=r})),Ur=o(((e,t)=>{t.exports=Hr()})),Wr=c(g(),1),A=Ur();function Gr(){return(0,A.jsxs)(`div`,{className:`relative z-50 w-full overflow-hidden border-b border-white/5 bg-[#040814] text-white`,children:[(0,A.jsxs)(`div`,{className:`pointer-events-none absolute inset-0 opacity-40`,children:[(0,A.jsx)(`div`,{className:`absolute -left-20 top-0 h-full w-1/3 bg-gradient-to-r from-cyan-500/10 to-transparent blur-2xl`}),(0,A.jsx)(`div`,{className:`absolute -right-20 top-0 h-full w-1/3 bg-gradient-to-l from-blue-500/10 to-transparent blur-2xl`})]}),(0,A.jsxs)(`div`,{className:`relative mx-auto flex max-w-[1440px] items-center justify-between gap-4 px-4 py-2.5 sm:px-6 lg:px-8`,children:[(0,A.jsxs)(`div`,{className:`flex items-center gap-2.5`,children:[(0,A.jsxs)(`span`,{className:`relative flex h-2 w-2`,children:[(0,A.jsx)(`span`,{className:`absolute inline-flex h-full w-full animate-ping rounded-full bg-cyan-400 opacity-75`}),(0,A.jsx)(`span`,{className:`relative inline-flex h-2 w-2 rounded-full bg-cyan-500`})]}),(0,A.jsxs)(`span`,{className:`text-[11px] font-medium tracking-wide text-white/80 sm:text-[12.5px]`,children:[(0,A.jsx)(`span`,{className:`sm:hidden`,children:`Trusted Medical Career Guidance`}),(0,A.jsx)(`span`,{className:`hidden sm:inline`,children:`Your Trusted Partner for Medical Education & Career Guidance`})]})]}),(0,A.jsxs)(`div`,{className:`flex items-center gap-2 sm:gap-3`,children:[(0,A.jsxs)(`a`,{href:`tel:+918830451660`,className:`group flex items-center gap-2 rounded-full py-1 pl-1 pr-2 sm:pr-3 transition-all hover:bg-white/5`,"aria-label":`Call us at 8830451660`,children:[(0,A.jsx)(`span`,{className:`flex h-7 w-7 items-center justify-center rounded-full bg-cyan-500/10 text-cyan-400 ring-1 ring-inset ring-cyan-500/20 transition-all group-hover:bg-cyan-500/20 group-hover:text-cyan-300`,children:(0,A.jsx)(jr,{size:13,strokeWidth:2.5})}),(0,A.jsx)(`span`,{className:`hidden text-[12.5px] font-medium text-white/90 transition-colors group-hover:text-cyan-300 md:inline`,children:`8830451660`})]}),(0,A.jsxs)(`a`,{href:`tel:+918237794917`,className:`group hidden items-center gap-2 rounded-full py-1 pl-1 pr-3 transition-all hover:bg-white/5 md:flex`,"aria-label":`Call us at 8237794917`,children:[(0,A.jsx)(`span`,{className:`flex h-7 w-7 items-center justify-center rounded-full bg-cyan-500/10 text-cyan-400 ring-1 ring-inset ring-cyan-500/20 transition-all group-hover:bg-cyan-500/20 group-hover:text-cyan-300`,children:(0,A.jsx)(jr,{size:13,strokeWidth:2.5})}),(0,A.jsx)(`span`,{className:`text-[12.5px] font-medium text-white/90 transition-colors group-hover:text-cyan-300`,children:`8237794917`})]}),(0,A.jsx)(`span`,{className:`hidden h-6 w-px bg-white/10 md:block`}),(0,A.jsxs)(`a`,{href:`https://wa.me/918830451660`,target:`_blank`,rel:`noopener noreferrer`,className:`group flex items-center gap-2 rounded-full bg-gradient-to-r from-emerald-500 to-green-600 py-1 pl-1 pr-3 shadow-[0_0_15px_-3px_rgba(16,185,129,0.5)] transition-all hover:shadow-[0_0_20px_-2px_rgba(16,185,129,0.8)] hover:from-emerald-400 hover:to-green-500`,"aria-label":`Chat with us on WhatsApp`,children:[(0,A.jsx)(`span`,{className:`flex h-7 w-7 items-center justify-center rounded-full bg-black/10 backdrop-blur-sm`,children:(0,A.jsx)(kr,{size:14,strokeWidth:2.5,className:`text-white`})}),(0,A.jsx)(`span`,{className:`text-[12.5px] font-semibold text-white`,children:`WhatsApp Us`})]})]})]}),(0,A.jsx)(`div`,{className:`absolute inset-x-0 bottom-0 h-[1.5px] bg-gradient-to-r from-transparent via-cyan-500/50 to-transparent`})]})}var Kr=(0,x.createContext)({});function qr(e){let t=(0,x.useRef)(null);return t.current===null&&(t.current=e()),t.current}var Jr=typeof window<`u`?x.useLayoutEffect:x.useEffect,Yr=(0,x.createContext)(null);function Xr(e,t){e.indexOf(t)===-1&&e.push(t)}function Zr(e,t){let n=e.indexOf(t);n>-1&&e.splice(n,1)}var Qr=(e,t,n)=>n>t?t:n<e?e:n,$r={},ei=e=>/^-?(?:\d+(?:\.\d+)?|\.\d+)$/u.test(e),ti=e=>typeof e==`object`&&!!e,ni=e=>/^0[^.\s]+$/u.test(e);function ri(e){let t;return()=>(t===void 0&&(t=e()),t)}var ii=e=>e,ai=(...e)=>e.reduce((e,t)=>n=>t(e(n))),oi=(e,t,n)=>{let r=t-e;return r?(n-e)/r:1},si=class{constructor(){this.subscriptions=[]}add(e){return Xr(this.subscriptions,e),()=>Zr(this.subscriptions,e)}notify(e,t,n){let r=this.subscriptions.length;if(r){if(r===1)this.subscriptions[0](e,t,n);else for(let i=0;i<r;i++){let r=this.subscriptions[i];r&&r(e,t,n)}}}getSize(){return this.subscriptions.length}clear(){this.subscriptions.length=0}},ci=e=>e*1e3,li=e=>e/1e3,ui=(e,t)=>t?1e3/t*e:0,di=(e,t,n)=>(((1-3*n+3*t)*e+(3*n-6*t))*e+3*t)*e,fi=1e-7,pi=12;function mi(e,t,n,r,i){let a,o,s=0;do o=t+(n-t)/2,a=di(o,r,i)-e,a>0?n=o:t=o;while(Math.abs(a)>fi&&++s<pi);return o}function hi(e,t,n,r){if(e===t&&n===r)return ii;let i=t=>mi(t,0,1,e,n);return e=>e===0||e===1?e:di(i(e),t,r)}var gi=e=>t=>t<=.5?e(2*t)/2:(2-e(2*(1-t)))/2,_i=e=>t=>1-e(1-t),vi=hi(.33,1.53,.69,.99),yi=_i(vi),bi=gi(yi),xi=e=>e>=1?1:(e*=2)<1?.5*yi(e):.5*(2-2**(-10*(e-1))),Si=e=>1-Math.sin(Math.acos(e)),Ci=_i(Si),wi=gi(Si),Ti=hi(.42,0,1,1),Ei=hi(0,0,.58,1),Di=hi(.42,0,.58,1),Oi=e=>Array.isArray(e)&&typeof e[0]!=`number`,ki=e=>Array.isArray(e)&&typeof e[0]==`number`,Ai={linear:ii,easeIn:Ti,easeInOut:Di,easeOut:Ei,circIn:Si,circInOut:wi,circOut:Ci,backIn:yi,backInOut:bi,backOut:vi,anticipate:xi},ji=e=>typeof e==`string`,Mi=e=>{if(ki(e)){e.length;let[t,n,r,i]=e;return hi(t,n,r,i)}return ji(e)?(Ai[e],`${e}`,Ai[e]):e},Ni=[`setup`,`read`,`resolveKeyframes`,`preUpdate`,`update`,`preRender`,`render`,`postRender`];function Pi(e){let t=new Set,n=new Set,r=!1,i=!1,a=new WeakSet,o={delta:0,timestamp:0,isProcessing:!1};function s(t){a.has(t)&&(c.schedule(t),e()),t(o)}let c={schedule:(e,i=!1,o=!1)=>{let s=o&&r?t:n;return i&&a.add(e),s.add(e),e},cancel:e=>{n.delete(e),a.delete(e)},process:e=>{if(o=e,r){i=!0;return}r=!0;let a=t;t=n,n=a,t.forEach(s),t.clear(),r=!1,i&&(i=!1,c.process(e))}};return c}var Fi=40;function Ii(e,t){let n=!1,r=!0,i={delta:0,timestamp:0,isProcessing:!1},a=()=>n=!0,o=Ni.reduce((e,t)=>(e[t]=Pi(a),e),{}),{setup:s,read:c,resolveKeyframes:l,preUpdate:u,update:d,preRender:f,render:p,postRender:m}=o,h=()=>{let a=$r.useManualTiming,o=a?i.timestamp:performance.now();n=!1,a||(i.delta=r?1e3/60:Math.max(Math.min(o-i.timestamp,Fi),1)),i.timestamp=o,i.isProcessing=!0,s.process(i),c.process(i),l.process(i),u.process(i),d.process(i),f.process(i),p.process(i),m.process(i),i.isProcessing=!1,n&&t&&(r=!1,e(h))},g=()=>{n=!0,r=!0,i.isProcessing||e(h)};return{schedule:Ni.reduce((e,t)=>{let r=o[t];return e[t]=(e,t=!1,i=!1)=>(n||g(),r.schedule(e,t,i)),e},{}),cancel:e=>{for(let t=0;t<Ni.length;t++)o[Ni[t]].cancel(e)},state:i,steps:o}}var{schedule:j,cancel:Li,state:Ri,steps:zi}=Ii(typeof requestAnimationFrame<`u`?requestAnimationFrame:ii,!0),Bi;function M(){Bi=void 0}var N={now:()=>(Bi===void 0&&N.set(Ri.isProcessing||$r.useManualTiming?Ri.timestamp:performance.now()),Bi),set:e=>{Bi=e,queueMicrotask(M)}},Vi=e=>t=>typeof t==`string`&&t.startsWith(e),Hi=Vi(`--`),Ui=Vi(`var(--`),Wi=e=>Ui(e)?Gi.test(e.split(`/*`)[0].trim()):!1,Gi=/var\(--(?:[\w-]+\s*|[\w-]+\s*,(?:\s*[^)(\s]|\s*\((?:[^)(]|\([^)(]*\))*\))+\s*)\)$/iu;function Ki(e){return typeof e==`string`&&e.split(`/*`)[0].includes(`var(--`)}var qi={test:e=>typeof e==`number`,parse:parseFloat,transform:e=>e},Ji={...qi,transform:e=>Qr(0,1,e)},Yi={...qi,default:1},Xi=e=>Math.round(e*1e5)/1e5,Zi=/-?(?:\d+(?:\.\d+)?|\.\d+)/gu;function Qi(e){return e==null}var $i=/^(?:#[\da-f]{3,8}|(?:rgb|hsl)a?\((?:-?[\d.]+%?[,\s]+){2}-?[\d.]+%?\s*(?:[,/]\s*)?(?:\b\d+(?:\.\d+)?|\.\d+)?%?\))$/iu,ea=(e,t)=>n=>!!(typeof n==`string`&&$i.test(n)&&n.startsWith(e)||t&&!Qi(n)&&Object.prototype.hasOwnProperty.call(n,t)),ta=(e,t,n)=>r=>{if(typeof r!=`string`)return r;let[i,a,o,s]=r.match(Zi);return{[e]:parseFloat(i),[t]:parseFloat(a),[n]:parseFloat(o),alpha:s===void 0?1:parseFloat(s)}},na=e=>Qr(0,255,e),ra={...qi,transform:e=>Math.round(na(e))},ia={test:ea(`rgb`,`red`),parse:ta(`red`,`green`,`blue`),transform:({red:e,green:t,blue:n,alpha:r=1})=>`rgba(`+ra.transform(e)+`, `+ra.transform(t)+`, `+ra.transform(n)+`, `+Xi(Ji.transform(r))+`)`};function aa(e){let t=``,n=``,r=``,i=``;return e.length>5?(t=e.substring(1,3),n=e.substring(3,5),r=e.substring(5,7),i=e.substring(7,9)):(t=e.substring(1,2),n=e.substring(2,3),r=e.substring(3,4),i=e.substring(4,5),t+=t,n+=n,r+=r,i+=i),{red:parseInt(t,16),green:parseInt(n,16),blue:parseInt(r,16),alpha:i?parseInt(i,16)/255:1}}var oa={test:ea(`#`),parse:aa,transform:ia.transform},sa=e=>({test:t=>typeof t==`string`&&t.endsWith(e)&&t.split(` `).length===1,parse:parseFloat,transform:t=>`${t}${e}`}),ca=sa(`deg`),la=sa(`%`),P=sa(`px`),ua=sa(`vh`),da=sa(`vw`),fa={...la,parse:e=>la.parse(e)/100,transform:e=>la.transform(e*100)},pa={test:ea(`hsl`,`hue`),parse:ta(`hue`,`saturation`,`lightness`),transform:({hue:e,saturation:t,lightness:n,alpha:r=1})=>`hsla(`+Math.round(e)+`, `+la.transform(Xi(t))+`, `+la.transform(Xi(n))+`, `+Xi(Ji.transform(r))+`)`},F={test:e=>ia.test(e)||oa.test(e)||pa.test(e),parse:e=>ia.test(e)?ia.parse(e):pa.test(e)?pa.parse(e):oa.parse(e),transform:e=>typeof e==`string`?e:e.hasOwnProperty(`red`)?ia.transform(e):pa.transform(e),getAnimatableNone:e=>{let t=F.parse(e);return t.alpha=0,F.transform(t)}},ma=/(?:#[\da-f]{3,8}|(?:rgb|hsl)a?\((?:-?[\d.]+%?[,\s]+){2}-?[\d.]+%?\s*(?:[,/]\s*)?(?:\b\d+(?:\.\d+)?|\.\d+)?%?\))/giu;function ha(e){return isNaN(e)&&typeof e==`string`&&(e.match(Zi)?.length||0)+(e.match(ma)?.length||0)>0}var ga=`number`,_a=`color`,va=`var`,ya=`var(`,ba="${}",xa=/var\s*\(\s*--(?:[\w-]+\s*|[\w-]+\s*,(?:\s*[^)(\s]|\s*\((?:[^)(]|\([^)(]*\))*\))+\s*)\)|#[\da-f]{3,8}|(?:rgb|hsl)a?\((?:-?[\d.]+%?[,\s]+){2}-?[\d.]+%?\s*(?:[,/]\s*)?(?:\b\d+(?:\.\d+)?|\.\d+)?%?\)|-?(?:\d+(?:\.\d+)?|\.\d+)/giu;function Sa(e){let t=e.toString(),n=[],r={color:[],number:[],var:[]},i=[],a=0;return{values:n,split:t.replace(xa,e=>(F.test(e)?(r.color.push(a),i.push(_a),n.push(F.parse(e))):e.startsWith(ya)?(r.var.push(a),i.push(va),n.push(e)):(r.number.push(a),i.push(ga),n.push(parseFloat(e))),++a,ba)).split(ba),indexes:r,types:i}}function Ca(e){return Sa(e).values}function wa({split:e,types:t}){let n=e.length;return r=>{let i=``;for(let a=0;a<n;a++)if(i+=e[a],r[a]!==void 0){let e=t[a];i+=e===ga?Xi(r[a]):e===_a?F.transform(r[a]):r[a]}return i}}function Ta(e){return wa(Sa(e))}var Ea=e=>typeof e==`number`?0:F.test(e)?F.getAnimatableNone(e):e,Da=(e,t)=>typeof e==`number`?t?.trim().endsWith(`/`)?e:0:Ea(e);function Oa(e){let t=Sa(e);return wa(t)(t.values.map((e,n)=>Da(e,t.split[n])))}var ka={test:ha,parse:Ca,createTransformer:Ta,getAnimatableNone:Oa};function Aa(e,t,n){return n<0&&(n+=1),n>1&&--n,n<1/6?e+(t-e)*6*n:n<1/2?t:n<2/3?e+(t-e)*(2/3-n)*6:e}function ja({hue:e,saturation:t,lightness:n,alpha:r}){e/=360,t/=100,n/=100;let i=0,a=0,o=0;if(!t)i=a=o=n;else{let r=n<.5?n*(1+t):n+t-n*t,s=2*n-r;i=Aa(s,r,e+1/3),a=Aa(s,r,e),o=Aa(s,r,e-1/3)}return{red:Math.round(i*255),green:Math.round(a*255),blue:Math.round(o*255),alpha:r}}function Ma(e,t){return n=>n>0?t:e}var I=(e,t,n)=>e+(t-e)*n,Na=(e,t,n)=>{let r=e*e,i=n*(t*t-r)+r;return i<0?0:Math.sqrt(i)},Pa=[oa,ia,pa],Fa=e=>Pa.find(t=>t.test(e));function Ia(e){let t=Fa(e);if(`${e}`,!t)return!1;let n=t.parse(e);return t===pa&&(n=ja(n)),n}var La=(e,t)=>{let n=Ia(e),r=Ia(t);if(!n||!r)return Ma(e,t);let i={...n};return e=>(i.red=Na(n.red,r.red,e),i.green=Na(n.green,r.green,e),i.blue=Na(n.blue,r.blue,e),i.alpha=I(n.alpha,r.alpha,e),ia.transform(i))},Ra=new Set([`none`,`hidden`]);function za(e,t){return Ra.has(e)?n=>n<=0?e:t:n=>n>=1?t:e}function Ba(e,t){return n=>I(e,t,n)}function Va(e){return typeof e==`number`?Ba:typeof e==`string`?Wi(e)?Ma:F.test(e)?La:Ga:Array.isArray(e)?Ha:typeof e==`object`?F.test(e)?La:Ua:Ma}function Ha(e,t){let n=[...e],r=n.length,i=e.map((e,n)=>Va(e)(e,t[n]));return e=>{for(let t=0;t<r;t++)n[t]=i[t](e);return n}}function Ua(e,t){let n={...e,...t},r={};for(let i in n)e[i]!==void 0&&t[i]!==void 0&&(r[i]=Va(e[i])(e[i],t[i]));return e=>{for(let t in r)n[t]=r[t](e);return n}}function Wa(e,t){let n=[],r={color:0,var:0,number:0};for(let i=0;i<t.values.length;i++){let a=t.types[i],o=e.indexes[a][r[a]],s=e.values[o]??0;n[i]=s,r[a]++}return n}var Ga=(e,t)=>{let n=ka.createTransformer(t),r=Sa(e),i=Sa(t);return r.indexes.var.length===i.indexes.var.length&&r.indexes.color.length===i.indexes.color.length&&r.indexes.number.length>=i.indexes.number.length?Ra.has(e)&&!i.values.length||Ra.has(t)&&!r.values.length?za(e,t):ai(Ha(Wa(r,i),i.values),n):(`${e}${t}`,Ma(e,t))};function Ka(e,t,n){return typeof e==`number`&&typeof t==`number`&&typeof n==`number`?I(e,t,n):Va(e)(e,t)}var qa=e=>{let t=({timestamp:t})=>e(t);return{start:(e=!0)=>j.update(t,e),stop:()=>Li(t),now:()=>Ri.isProcessing?Ri.timestamp:N.now()}},Ja=(e,t,n=10)=>{let r=``,i=Math.max(Math.round(t/n),2);for(let t=0;t<i;t++)r+=Math.round(e(t/(i-1))*1e4)/1e4+`, `;return`linear(${r.substring(0,r.length-2)})`},Ya=2e4;function Xa(e){let t=0,n=e.next(t);for(;!n.done&&t<2e4;)t+=50,n=e.next(t);return t>=2e4?1/0:t}function Za(e,t=100,n){let r=n({...e,keyframes:[0,t]}),i=Math.min(Xa(r),Ya);return{type:`keyframes`,ease:e=>r.next(i*e).value/t,duration:li(i)}}var L={stiffness:100,damping:10,mass:1,velocity:0,duration:800,bounce:.3,visualDuration:.3,restSpeed:{granular:.01,default:2},restDelta:{granular:.005,default:.5},minDuration:.01,maxDuration:10,minDamping:.05,maxDamping:1};function Qa(e,t){return e*Math.sqrt(1-t*t)}var $a=12;function eo(e,t,n){let r=n;for(let n=1;n<$a;n++)r-=e(r)/t(r);return r}var to=.001;function no({duration:e=L.duration,bounce:t=L.bounce,velocity:n=L.velocity,mass:r=L.mass}){let i,a;L.maxDuration;let o=1-t;o=Qr(L.minDamping,L.maxDamping,o),e=Qr(L.minDuration,L.maxDuration,li(e)),o<1?(i=t=>{let r=t*o,i=r*e,a=r-n,s=Qa(t,o),c=Math.exp(-i);return to-a/s*c},a=t=>{let r=t*o*e,a=r*n+n,s=o**2*t**2*e,c=Math.exp(-r),l=Qa(t**2,o);return(-i(t)+to>0?-1:1)*((a-s)*c)/l}):(i=t=>-.001+Math.exp(-t*e)*((t-n)*e+1),a=t=>Math.exp(-t*e)*((n-t)*(e*e)));let s=5/e,c=eo(i,a,s);if(e=ci(e),isNaN(c))return{stiffness:L.stiffness,damping:L.damping,duration:e};{let t=c**2*r;return{stiffness:t,damping:o*2*Math.sqrt(r*t),duration:e}}}var ro=[`duration`,`bounce`],io=[`stiffness`,`damping`,`mass`];function ao(e,t){return t.some(t=>e[t]!==void 0)}function oo(e){let t={velocity:L.velocity,stiffness:L.stiffness,damping:L.damping,mass:L.mass,isResolvedFromDuration:!1,...e};if(!ao(e,io)&&ao(e,ro)){if(t.velocity=0,e.visualDuration){let n=e.visualDuration,r=2*Math.PI/(n*1.2),i=r*r,a=2*Qr(.05,1,1-(e.bounce||0))*Math.sqrt(i);t={...t,mass:L.mass,stiffness:i,damping:a}}else{let n=no({...e,velocity:0});t={...t,...n,mass:L.mass},t.isResolvedFromDuration=!0}}return t}function so(e=L.visualDuration,t=L.bounce){let n=typeof e==`object`?e:{visualDuration:e,keyframes:[0,1],bounce:t},{restSpeed:r,restDelta:i}=n,a=n.keyframes[0],o=n.keyframes[n.keyframes.length-1],s={done:!1,value:a},{stiffness:c,damping:l,mass:u,duration:d,velocity:f,isResolvedFromDuration:p}=oo({...n,velocity:-li(n.velocity||0)}),m=f||0,h=l/(2*Math.sqrt(c*u)),g=o-a,_=li(Math.sqrt(c/u)),v=Math.abs(g)<5;r||=v?L.restSpeed.granular:L.restSpeed.default,i||=v?L.restDelta.granular:L.restDelta.default;let y,b,x,S,C,w;if(h<1)x=Qa(_,h),S=(m+h*_*g)/x,y=e=>{let t=Math.exp(-h*_*e);return o-t*(S*Math.sin(x*e)+g*Math.cos(x*e))},C=h*_*S+g*x,w=h*_*g-S*x,b=e=>Math.exp(-h*_*e)*(C*Math.sin(x*e)+w*Math.cos(x*e));else if(h===1){y=e=>o-Math.exp(-_*e)*(g+(m+_*g)*e);let e=m+_*g;b=t=>Math.exp(-_*t)*(_*e*t-m)}else{let e=_*Math.sqrt(h*h-1);y=t=>{let n=Math.exp(-h*_*t),r=Math.min(e*t,300);return o-n*((m+h*_*g)*Math.sinh(r)+e*g*Math.cosh(r))/e};let t=(m+h*_*g)/e,n=h*_*t-g*e,r=h*_*g-t*e;b=t=>{let i=Math.exp(-h*_*t),a=Math.min(e*t,300);return i*(n*Math.sinh(a)+r*Math.cosh(a))}}let ee={calculatedDuration:p&&d||null,velocity:e=>ci(b(e)),next:e=>{if(!p&&h<1){let t=Math.exp(-h*_*e),n=Math.sin(x*e),a=Math.cos(x*e),c=o-t*(S*n+g*a),l=ci(t*(C*n+w*a));return s.done=Math.abs(l)<=r&&Math.abs(o-c)<=i,s.value=s.done?o:c,s}let t=y(e);if(p)s.done=e>=d;else{let n=ci(b(e));s.done=Math.abs(n)<=r&&Math.abs(o-t)<=i}return s.value=s.done?o:t,s},toString:()=>{let e=Math.min(Xa(ee),Ya),t=Ja(t=>ee.next(e*t).value,e,30);return e+`ms `+t},toTransition:()=>{}};return ee}so.applyToOptions=e=>{let t=Za(e,100,so);return e.ease=t.ease,e.duration=ci(t.duration),e.type=`keyframes`,e};var co=5;function lo(e,t,n){let r=Math.max(t-co,0);return ui(n-e(r),t-r)}function uo({keyframes:e,velocity:t=0,power:n=.8,timeConstant:r=325,bounceDamping:i=10,bounceStiffness:a=500,modifyTarget:o,min:s,max:c,restDelta:l=.5,restSpeed:u}){let d=e[0],f={done:!1,value:d},p=e=>s!==void 0&&e<s||c!==void 0&&e>c,m=e=>s===void 0?c:c===void 0||Math.abs(s-e)<Math.abs(c-e)?s:c,h=n*t,g=d+h,_=o===void 0?g:o(g);_!==g&&(h=_-d);let v=e=>-h*Math.exp(-e/r),y=e=>_+v(e),b=e=>{let t=v(e),n=y(e);f.done=Math.abs(t)<=l,f.value=f.done?_:n},x,S,C=e=>{p(f.value)&&(x=e,S=so({keyframes:[f.value,m(f.value)],velocity:lo(y,e,f.value),damping:i,stiffness:a,restDelta:l,restSpeed:u}))};return C(0),{calculatedDuration:null,next:e=>{let t=!1;return!S&&x===void 0&&(t=!0,b(e),C(e)),x!==void 0&&e>=x?S.next(e-x):(!t&&b(e),f)}}}function fo(e,t,n){let r=[],i=n||$r.mix||Ka,a=e.length-1;for(let n=0;n<a;n++){let a=i(e[n],e[n+1]);t&&(a=ai(Array.isArray(t)?t[n]||ii:t,a)),r.push(a)}return r}function po(e,t,{clamp:n=!0,ease:r,mixer:i}={}){let a=e.length;if(t.length,a===1)return()=>t[0];if(a===2&&t[0]===t[1])return()=>t[1];let o=e[0]===e[1];e[0]>e[a-1]&&(e=[...e].reverse(),t=[...t].reverse());let s=fo(t,r,i),c=s.length,l=n=>{if(o&&n<e[0])return t[0];let r=0;if(c>1)for(;r<e.length-2&&!(n<e[r+1]);r++);let i=oi(e[r],e[r+1],n);return s[r](i)};return n?t=>l(Qr(e[0],e[a-1],t)):l}function mo(e,t){let n=e[e.length-1];for(let r=1;r<=t;r++){let i=oi(0,t,r);e.push(I(n,1,i))}}function ho(e){let t=[0];return mo(t,e.length-1),t}function R(e,t){return e.map(e=>e*t)}function z(e,t){return e.map(()=>t||Di).splice(0,e.length-1)}function B({duration:e=300,keyframes:t,times:n,ease:r=`easeInOut`}){let i=Oi(r)?r.map(Mi):Mi(r),a={done:!1,value:t[0]},o=po(R(n&&n.length===t.length?n:ho(t),e),t,{ease:Array.isArray(i)?i:z(t,i)});return{calculatedDuration:e,next:t=>(a.value=o(t),a.done=t>=e,a)}}var go=e=>e!==null;function _o(e,{repeat:t,repeatType:n=`loop`},r,i=1){let a=e.filter(go),o=i<0||t&&n!==`loop`&&t%2==1?0:a.length-1;return!o||r===void 0?a[o]:r}var vo={decay:uo,inertia:uo,tween:B,keyframes:B,spring:so};function yo(e){typeof e.type==`string`&&(e.type=vo[e.type])}var bo=class{constructor(){this.updateFinished()}get finished(){return this._finished}updateFinished(){this._finished=new Promise(e=>{this.resolve=e})}notifyFinished(){this.resolve()}then(e,t){return this.finished.then(e,t)}},xo=e=>e/100,So=class extends bo{constructor(e){super(),this.state=`idle`,this.startTime=null,this.isStopped=!1,this.currentTime=0,this.holdTime=null,this.playbackSpeed=1,this.delayState={done:!1,value:void 0},this.stop=()=>{let{motionValue:e}=this.options;e&&e.updatedAt!==N.now()&&this.tick(N.now()),this.isStopped=!0,this.state!==`idle`&&(this.teardown(),this.options.onStop?.())},this.options=e,this.initAnimation(),this.play(),e.autoplay===!1&&this.pause()}initAnimation(){let{options:e}=this;yo(e);let{type:t=B,repeat:n=0,repeatDelay:r=0,repeatType:i,velocity:a=0}=e,{keyframes:o}=e,s=t||B;s!==B&&typeof o[0]!=`number`&&(this.mixKeyframes=ai(xo,Ka(o[0],o[1])),o=[0,100]);let c=s({...e,keyframes:o});i===`mirror`&&(this.mirroredGenerator=s({...e,keyframes:[...o].reverse(),velocity:-a})),c.calculatedDuration===null&&(c.calculatedDuration=Xa(c));let{calculatedDuration:l}=c;this.calculatedDuration=l,this.resolvedDuration=l+r,this.totalDuration=this.resolvedDuration*(n+1)-r,this.generator=c}updateTime(e){let t=Math.round(e-this.startTime)*this.playbackSpeed;this.currentTime=this.holdTime===null?t:this.holdTime}tick(e,t=!1){let{generator:n,totalDuration:r,mixKeyframes:i,mirroredGenerator:a,resolvedDuration:o,calculatedDuration:s}=this;if(this.startTime===null)return n.next(0);let{delay:c=0,keyframes:l,repeat:u,repeatType:d,repeatDelay:f,type:p,onUpdate:m,finalKeyframe:h}=this.options;this.speed>0?this.startTime=Math.min(this.startTime,e):this.speed<0&&(this.startTime=Math.min(e-r/this.speed,this.startTime)),t?this.currentTime=e:this.updateTime(e);let g=this.currentTime-c*(this.playbackSpeed>=0?1:-1),_=this.playbackSpeed>=0?g<0:g>r;this.currentTime=Math.max(g,0),this.state===`finished`&&this.holdTime===null&&(this.currentTime=r);let v=this.currentTime,y=n;if(u){let e=Math.min(this.currentTime,r)/o,t=Math.floor(e),n=e%1;!n&&e>=1&&(n=1),n===1&&t--,t=Math.min(t,u+1),t%2&&(d===`reverse`?(n=1-n,f&&(n-=f/o)):d===`mirror`&&(y=a)),v=Qr(0,1,n)*o}let b;_?(this.delayState.value=l[0],b=this.delayState):b=y.next(v),i&&!_&&(b.value=i(b.value));let{done:x}=b;!_&&s!==null&&(x=this.playbackSpeed>=0?this.currentTime>=r:this.currentTime<=0);let S=this.holdTime===null&&(this.state===`finished`||this.state===`running`&&x);return S&&p!==uo&&(b.value=_o(l,this.options,h,this.speed)),m&&m(b.value),S&&this.finish(),b}then(e,t){return this.finished.then(e,t)}get duration(){return li(this.calculatedDuration)}get iterationDuration(){let{delay:e=0}=this.options||{};return this.duration+li(e)}get time(){return li(this.currentTime)}set time(e){e=ci(e),this.currentTime=e,this.startTime===null||this.holdTime!==null||this.playbackSpeed===0?this.holdTime=e:this.driver&&(this.startTime=this.driver.now()-e/this.playbackSpeed),this.driver?this.driver.start(!1):(this.startTime=0,this.state=`paused`,this.holdTime=e,this.tick(e))}getGeneratorVelocity(){let e=this.currentTime;if(e<=0)return this.options.velocity||0;if(this.generator.velocity)return this.generator.velocity(e);let t=this.generator.next(e).value;return lo(e=>this.generator.next(e).value,e,t)}get speed(){return this.playbackSpeed}set speed(e){let t=this.playbackSpeed!==e;t&&this.driver&&this.updateTime(N.now()),this.playbackSpeed=e,t&&this.driver&&(this.time=li(this.currentTime))}play(){if(this.isStopped)return;let{driver:e=qa,startTime:t}=this.options;this.driver||=e(e=>this.tick(e)),this.options.onPlay?.();let n=this.driver.now();this.state===`finished`?(this.updateFinished(),this.startTime=n):this.holdTime===null?this.startTime||=t??n:this.startTime=n-this.holdTime,this.state===`finished`&&this.speed<0&&(this.startTime+=this.calculatedDuration),this.holdTime=null,this.state=`running`,this.driver.start()}pause(){this.state=`paused`,this.updateTime(N.now()),this.holdTime=this.currentTime}complete(){this.state!==`running`&&this.play(),this.state=`finished`,this.holdTime=null}finish(){this.notifyFinished(),this.teardown(),this.state=`finished`,this.options.onComplete?.()}cancel(){this.holdTime=null,this.startTime=0,this.tick(0),this.teardown(),this.options.onCancel?.()}teardown(){this.state=`idle`,this.stopDriver(),this.startTime=this.holdTime=null}stopDriver(){this.driver&&=(this.driver.stop(),void 0)}sample(e){return this.startTime=0,this.tick(e,!0)}attachTimeline(e){return this.options.allowFlatten&&(this.options.type=`keyframes`,this.options.ease=`linear`,this.initAnimation()),this.driver?.stop(),e.observe(this)}};function Co(e){for(let t=1;t<e.length;t++)e[t]??(e[t]=e[t-1])}var wo=e=>e*180/Math.PI,To=e=>Do(wo(Math.atan2(e[1],e[0]))),Eo={x:4,y:5,translateX:4,translateY:5,scaleX:0,scaleY:3,scale:e=>(Math.abs(e[0])+Math.abs(e[3]))/2,rotate:To,rotateZ:To,skewX:e=>wo(Math.atan(e[1])),skewY:e=>wo(Math.atan(e[2])),skew:e=>(Math.abs(e[1])+Math.abs(e[2]))/2},Do=e=>(e%=360,e<0&&(e+=360),e),Oo=To,ko=e=>Math.sqrt(e[0]*e[0]+e[1]*e[1]),Ao=e=>Math.sqrt(e[4]*e[4]+e[5]*e[5]),jo={x:12,y:13,z:14,translateX:12,translateY:13,translateZ:14,scaleX:ko,scaleY:Ao,scale:e=>(ko(e)+Ao(e))/2,rotateX:e=>Do(wo(Math.atan2(e[6],e[5]))),rotateY:e=>Do(wo(Math.atan2(-e[2],e[0]))),rotateZ:Oo,rotate:Oo,skewX:e=>wo(Math.atan(e[4])),skewY:e=>wo(Math.atan(e[1])),skew:e=>(Math.abs(e[1])+Math.abs(e[4]))/2};function Mo(e){return+!!e.includes(`scale`)}function No(e,t){if(!e||e===`none`)return Mo(t);let n=e.match(/^matrix3d\(([-\d.e\s,]+)\)$/u),r,i;if(n)r=jo,i=n;else{let t=e.match(/^matrix\(([-\d.e\s,]+)\)$/u);r=Eo,i=t}if(!i)return Mo(t);let a=r[t],o=i[1].split(`,`).map(Fo);return typeof a==`function`?a(o):o[a]}var Po=(e,t)=>{let{transform:n=`none`}=getComputedStyle(e);return No(n,t)};function Fo(e){return parseFloat(e.trim())}var Io=[`transformPerspective`,`x`,`y`,`z`,`translateX`,`translateY`,`translateZ`,`scale`,`scaleX`,`scaleY`,`rotate`,`rotateX`,`rotateY`,`rotateZ`,`skew`,`skewX`,`skewY`],Lo=new Set([...Io,`pathRotation`]),Ro=e=>e===qi||e===P,zo=new Set([`x`,`y`,`z`]),Bo=Io.filter(e=>!zo.has(e));function Vo(e){let t=[];return Bo.forEach(n=>{let r=e.getValue(n);r!==void 0&&(t.push([n,r.get()]),r.set(+!!n.startsWith(`scale`)))}),t}var Ho={width:({x:e},{paddingLeft:t=`0`,paddingRight:n=`0`,boxSizing:r})=>{let i=e.max-e.min;return r===`border-box`?i:i-parseFloat(t)-parseFloat(n)},height:({y:e},{paddingTop:t=`0`,paddingBottom:n=`0`,boxSizing:r})=>{let i=e.max-e.min;return r===`border-box`?i:i-parseFloat(t)-parseFloat(n)},top:(e,{top:t})=>parseFloat(t),left:(e,{left:t})=>parseFloat(t),bottom:({y:e},{top:t})=>parseFloat(t)+(e.max-e.min),right:({x:e},{left:t})=>parseFloat(t)+(e.max-e.min),x:(e,{transform:t})=>No(t,`x`),y:(e,{transform:t})=>No(t,`y`)};Ho.translateX=Ho.x,Ho.translateY=Ho.y;var Uo=new Set,Wo=!1,Go=!1,Ko=!1;function qo(){if(Go){let e=Array.from(Uo).filter(e=>e.needsMeasurement),t=new Set(e.map(e=>e.element)),n=new Map;t.forEach(e=>{let t=Vo(e);t.length&&(n.set(e,t),e.render())}),e.forEach(e=>e.measureInitialState()),t.forEach(e=>{e.render();let t=n.get(e);t&&t.forEach(([t,n])=>{e.getValue(t)?.set(n)})}),e.forEach(e=>e.measureEndState()),e.forEach(e=>{e.suspendedScrollY!==void 0&&window.scrollTo(0,e.suspendedScrollY)})}Go=!1,Wo=!1,Uo.forEach(e=>e.complete(Ko)),Uo.clear()}function Jo(){Uo.forEach(e=>{e.readKeyframes(),e.needsMeasurement&&(Go=!0)})}function Yo(){Ko=!0,Jo(),qo(),Ko=!1}var Xo=class{constructor(e,t,n,r,i,a=!1){this.state=`pending`,this.isAsync=!1,this.needsMeasurement=!1,this.unresolvedKeyframes=[...e],this.onComplete=t,this.name=n,this.motionValue=r,this.element=i,this.isAsync=a}scheduleResolve(){this.state=`scheduled`,this.isAsync?(Uo.add(this),Wo||(Wo=!0,j.read(Jo),j.resolveKeyframes(qo))):(this.readKeyframes(),this.complete())}readKeyframes(){let{unresolvedKeyframes:e,name:t,element:n,motionValue:r}=this;if(e[0]===null){let i=r?.get(),a=e[e.length-1];if(i!==void 0)e[0]=i;else if(n&&t){let r=n.readValue(t,a);r!=null&&(e[0]=r)}e[0]===void 0&&(e[0]=a),r&&i===void 0&&r.set(e[0])}Co(e)}setFinalKeyframe(){}measureInitialState(){}renderEndStyles(){}measureEndState(){}complete(e=!1){this.state=`complete`,this.onComplete(this.unresolvedKeyframes,this.finalKeyframe,e),Uo.delete(this)}cancel(){this.state===`scheduled`&&(Uo.delete(this),this.state=`pending`)}resume(){this.state===`pending`&&this.scheduleResolve()}},Zo=e=>e.startsWith(`--`);function Qo(e,t,n){Zo(t)?e.style.setProperty(t,n):e.style[t]=n}var $o={};function es(e,t){let n=ri(e);return()=>$o[t]??n()}var ts=es(()=>window.ScrollTimeline!==void 0,`scrollTimeline`),ns=es(()=>{try{document.createElement(`div`).animate({opacity:0},{easing:`linear(0, 1)`})}catch{return!1}return!0},`linearEasing`),rs=([e,t,n,r])=>`cubic-bezier(${e}, ${t}, ${n}, ${r})`,is={linear:`linear`,ease:`ease`,easeIn:`ease-in`,easeOut:`ease-out`,easeInOut:`ease-in-out`,circIn:rs([0,.65,.55,1]),circOut:rs([.55,0,1,.45]),backIn:rs([.31,.01,.66,-.59]),backOut:rs([.33,1.53,.69,.99])};function as(e,t){if(e)return typeof e==`function`?ns()?Ja(e,t):`ease-out`:ki(e)?rs(e):Array.isArray(e)?e.map(e=>as(e,t)||is.easeOut):is[e]}function os(e,t,n,{delay:r=0,duration:i=300,repeat:a=0,repeatType:o=`loop`,ease:s=`easeOut`,times:c}={},l=void 0){let u={[t]:n};c&&(u.offset=c);let d=as(s,i);Array.isArray(d)&&(u.easing=d);let f={delay:r,duration:i,easing:Array.isArray(d)?`linear`:d,fill:`both`,iterations:a+1,direction:o===`reverse`?`alternate`:`normal`};return l&&(f.pseudoElement=l),e.animate(u,f)}function ss(e){return typeof e==`function`&&`applyToOptions`in e}function cs({type:e,...t}){return ss(e)&&ns()?e.applyToOptions(t):(t.duration??=300,t.ease??=`easeOut`,t)}var ls=class extends bo{constructor(e){if(super(),this.finishedTime=null,this.isStopped=!1,this.manualStartTime=null,!e)return;let{element:t,name:n,keyframes:r,pseudoElement:i,allowFlatten:a=!1,finalKeyframe:o,onComplete:s}=e;this.isPseudoElement=!!i,this.allowFlatten=a,this.options=e,e.type;let c=cs(e);this.animation=os(t,n,r,c,i),c.autoplay===!1&&this.animation.pause(),this.animation.onfinish=()=>{if(this.finishedTime=this.time,!i){let e=_o(r,this.options,o,this.speed);this.updateMotionValue&&this.updateMotionValue(e),Qo(t,n,e),this.animation.cancel()}s?.(),this.notifyFinished()}}play(){this.isStopped||(this.manualStartTime=null,this.animation.play(),this.state===`finished`&&this.updateFinished())}pause(){this.animation.pause()}complete(){this.animation.finish?.()}cancel(){try{this.animation.cancel()}catch{}}stop(){if(this.isStopped)return;this.isStopped=!0;let{state:e}=this;e!==`idle`&&e!==`finished`&&(this.updateMotionValue?this.updateMotionValue():this.commitStyles(),this.isPseudoElement||this.cancel())}commitStyles(){let e=this.options?.element;!this.isPseudoElement&&e?.isConnected&&this.animation.commitStyles?.()}get duration(){let e=this.animation.effect?.getComputedTiming?.().duration||0;return li(Number(e))}get iterationDuration(){let{delay:e=0}=this.options||{};return this.duration+li(e)}get time(){return li(Number(this.animation.currentTime)||0)}set time(e){let t=this.finishedTime!==null;this.manualStartTime=null,this.finishedTime=null,this.animation.currentTime=ci(e),t&&this.animation.pause()}get speed(){return this.animation.playbackRate}set speed(e){e<0&&(this.finishedTime=null),this.animation.playbackRate=e}get state(){return this.finishedTime===null?this.animation.playState:`finished`}get startTime(){return this.manualStartTime??Number(this.animation.startTime)}set startTime(e){this.manualStartTime=this.animation.startTime=e}attachTimeline({timeline:e,rangeStart:t,rangeEnd:n,observe:r}){return this.allowFlatten&&this.animation.effect?.updateTiming({easing:`linear`}),this.animation.onfinish=null,e&&ts()?(this.animation.timeline=e,t&&(this.animation.rangeStart=t),n&&(this.animation.rangeEnd=n),ii):r(this)}},us={anticipate:xi,backInOut:bi,circInOut:wi};function ds(e){return e in us}function fs(e){typeof e.ease==`string`&&ds(e.ease)&&(e.ease=us[e.ease])}var ps=10,ms=class extends ls{constructor(e){fs(e),yo(e),super(e),e.startTime!==void 0&&e.autoplay!==!1&&(this.startTime=e.startTime),this.options=e}updateMotionValue(e){let{motionValue:t,onUpdate:n,onComplete:r,element:i,...a}=this.options;if(!t)return;if(e!==void 0){t.set(e);return}let o=new So({...a,autoplay:!1}),s=Math.max(ps,N.now()-this.startTime),c=Qr(0,ps,s-ps),l=o.sample(s).value,{name:u}=this.options;i&&u&&Qo(i,u,l),t.setWithVelocity(o.sample(Math.max(0,s-c)).value,l,c),o.stop()}},hs=(e,t)=>t!==`zIndex`&&!!(typeof e==`number`||Array.isArray(e)||typeof e==`string`&&(ka.test(e)||e===`0`)&&!e.startsWith(`url(`));function gs(e){let t=e[0];if(e.length===1)return!0;for(let n=0;n<e.length;n++)if(e[n]!==t)return!0}function _s(e,t,n,r){let i=e[0];if(i===null)return!1;if(t===`display`||t===`visibility`)return!0;let a=e[e.length-1],o=hs(i,t),s=hs(a,t);return`${t}${i}${a}${o?a:i}`,!o||!s?!1:gs(e)||(n===`spring`||ss(n))&&r}function vs(e){e.duration=0,e.type=`keyframes`}var ys=new Set([`opacity`,`clipPath`,`filter`,`transform`,`backgroundColor`]),bs=/^(?:oklch|oklab|lab|lch|color|color-mix|light-dark)\(/;function xs(e){for(let t=0;t<e.length;t++)if(typeof e[t]==`string`&&bs.test(e[t]))return!0;return!1}var Ss=new Set([`color`,`backgroundColor`,`outlineColor`,`fill`,`stroke`,`borderColor`,`borderTopColor`,`borderRightColor`,`borderBottomColor`,`borderLeftColor`]),Cs=ri(()=>Object.hasOwnProperty.call(Element.prototype,`animate`));function ws(e){let{motionValue:t,name:n,repeatDelay:r,repeatType:i,damping:a,type:o,keyframes:s}=e,c=t?.owner?.current;if(!(c instanceof HTMLElement)&&!(c instanceof SVGElement))return!1;let{onUpdate:l,transformTemplate:u}=t.owner.getProps();return Cs()&&n&&(ys.has(n)||Ss.has(n)&&xs(s))&&(n!==`transform`||!u)&&!l&&!r&&i!==`mirror`&&a!==0&&o!==`inertia`}var Ts=40,Es=class extends bo{constructor({autoplay:e=!0,delay:t=0,type:n=`keyframes`,repeat:r=0,repeatDelay:i=0,repeatType:a=`loop`,keyframes:o,name:s,motionValue:c,element:l,...u}){super(),this.stop=()=>{this._animation&&(this._animation.stop(),this.stopTimeline?.()),this.keyframeResolver?.cancel()},this.createdAt=N.now();let d={autoplay:e,delay:t,type:n,repeat:r,repeatDelay:i,repeatType:a,name:s,motionValue:c,element:l,...u},f=l?.KeyframeResolver||Xo;this.keyframeResolver=new f(o,(e,t,n)=>this.onKeyframesResolved(e,t,d,!n),s,c,l),this.keyframeResolver?.scheduleResolve()}onKeyframesResolved(e,t,n,r){this.keyframeResolver=void 0;let{name:i,type:a,velocity:o,delay:s,isHandoff:c,onUpdate:l}=n;this.resolvedAt=N.now();let u=!0;_s(e,i,a,o)||(u=!1,($r.instantAnimations||!s)&&l?.(_o(e,n,t)),e[0]=e[e.length-1],vs(n),n.repeat=0);let d={startTime:r?this.resolvedAt&&this.resolvedAt-this.createdAt>Ts?this.resolvedAt:this.createdAt:void 0,finalKeyframe:t,...n,keyframes:e},f=u&&!c&&ws(d),p=d.motionValue?.owner?.current,m;if(f)try{m=new ms({...d,element:p})}catch{m=new So(d)}else m=new So(d);m.finished.then(()=>{this.notifyFinished()}).catch(ii),this.pendingTimeline&&=(this.stopTimeline=m.attachTimeline(this.pendingTimeline),void 0),this._animation=m}get finished(){return this._animation?this.animation.finished:this._finished}then(e,t){return this.finished.finally(e).then(()=>{})}get animation(){return this._animation||(this.keyframeResolver?.resume(),Yo()),this._animation}get duration(){return this.animation.duration}get iterationDuration(){return this.animation.iterationDuration}get time(){return this.animation.time}set time(e){this.animation.time=e}get speed(){return this.animation.speed}get state(){return this.animation.state}set speed(e){this.animation.speed=e}get startTime(){return this.animation.startTime}attachTimeline(e){return this._animation?this.stopTimeline=this.animation.attachTimeline(e):this.pendingTimeline=e,()=>this.stop()}play(){this.animation.play()}pause(){this.animation.pause()}complete(){this.animation.complete()}cancel(){this._animation&&this.animation.cancel(),this.keyframeResolver?.cancel()}};function Ds(e,t,n,r=0,i=1){let a=Array.from(e).sort((e,t)=>e.sortNodePosition(t)).indexOf(t),o=e.size,s=(o-1)*r;return typeof n==`function`?n(a,o):i===1?a*r:s-a*r}var Os=30,ks=e=>!isNaN(parseFloat(e)),As={current:void 0},js=class{constructor(e,t={}){this.canTrackVelocity=null,this.events={},this.updateAndNotify=e=>{let t=N.now();if(this.updatedAt!==t&&this.setPrevFrameValue(),this.prev=this.current,this.setCurrent(e),this.current!==this.prev&&(this.events.change?.notify(this.current),this.dependents))for(let e of this.dependents)e.dirty()},this.hasAnimated=!1,this.setCurrent(e),this.owner=t.owner}setCurrent(e){this.current=e,this.updatedAt=N.now(),this.canTrackVelocity===null&&e!==void 0&&(this.canTrackVelocity=ks(this.current))}setPrevFrameValue(e=this.current){this.prevFrameValue=e,this.prevUpdatedAt=this.updatedAt}onChange(e){return this.on(`change`,e)}on(e,t){this.events[e]||(this.events[e]=new si);let n=this.events[e].add(t);return e===`change`?()=>{n(),j.read(()=>{this.events.change.getSize()||this.stop()})}:n}clearListeners(){for(let e in this.events)this.events[e].clear()}attach(e,t){this.passiveEffect=e,this.stopPassiveEffect=t}set(e){this.passiveEffect?this.passiveEffect(e,this.updateAndNotify):this.updateAndNotify(e)}setWithVelocity(e,t,n){this.set(t),this.prev=void 0,this.prevFrameValue=e,this.prevUpdatedAt=this.updatedAt-n}jump(e,t=!0){this.updateAndNotify(e),this.prev=e,this.prevUpdatedAt=this.prevFrameValue=void 0,t&&this.stop(),this.stopPassiveEffect&&this.stopPassiveEffect()}dirty(){this.events.change?.notify(this.current)}addDependent(e){this.dependents||=new Set,this.dependents.add(e)}removeDependent(e){this.dependents&&this.dependents.delete(e)}get(){return As.current&&As.current.push(this),this.current}getPrevious(){return this.prev}getVelocity(){let e=N.now();if(!this.canTrackVelocity||this.prevFrameValue===void 0||e-this.updatedAt>Os)return 0;let t=Math.min(this.updatedAt-this.prevUpdatedAt,Os);return ui(parseFloat(this.current)-parseFloat(this.prevFrameValue),t)}start(e){return this.stop(),new Promise(t=>{this.hasAnimated=!0,this.animation=e(t),this.events.animationStart&&this.events.animationStart.notify()}).then(()=>{this.events.animationComplete&&this.events.animationComplete.notify(),this.clearAnimation()})}stop(){this.animation&&(this.animation.stop(),this.events.animationCancel&&this.events.animationCancel.notify()),this.clearAnimation()}isAnimating(){return!!this.animation}clearAnimation(){delete this.animation}destroy(){this.dependents?.clear(),this.events.destroy?.notify(),this.clearListeners(),this.stop(),this.stopPassiveEffect&&this.stopPassiveEffect()}};function Ms(e,t){return new js(e,t)}function Ns(e,t){if(e?.inherit&&t){let{inherit:n,...r}=e;return{...t,...r}}return e}function Ps(e,t){let n=e?.[t]??e?.default??e;return n===e?n:Ns(n,e)}var Fs={type:`spring`,stiffness:500,damping:25,restSpeed:10},Is=e=>({type:`spring`,stiffness:550,damping:e===0?2*Math.sqrt(550):30,restSpeed:10}),Ls={type:`keyframes`,duration:.8},Rs={type:`keyframes`,ease:[.25,.1,.35,1],duration:.3},zs=(e,{keyframes:t})=>t.length>2?Ls:Lo.has(e)?e.startsWith(`scale`)?Is(t[1]):Fs:Rs,Bs=new Set([`when`,`delay`,`delayChildren`,`staggerChildren`,`staggerDirection`,`repeat`,`repeatType`,`repeatDelay`,`from`,`elapsed`]);function Vs(e){for(let t in e)if(!Bs.has(t))return!0;return!1}var Hs=(e,t,n,r={},i,a)=>o=>{let s=Ps(r,e)||{},c=s.delay||r.delay||0,{elapsed:l=0}=r;l-=ci(c);let u={keyframes:Array.isArray(n)?n:[null,n],ease:`easeOut`,velocity:t.getVelocity(),...s,delay:-l,onUpdate:e=>{t.set(e),s.onUpdate&&s.onUpdate(e)},onComplete:()=>{o(),s.onComplete&&s.onComplete()},name:e,motionValue:t,element:a?void 0:i};Vs(s)||Object.assign(u,zs(e,u)),u.duration&&=ci(u.duration),u.repeatDelay&&=ci(u.repeatDelay),u.from!==void 0&&(u.keyframes[0]=u.from);let d=!1;if((u.type===!1||u.duration===0&&!u.repeatDelay)&&(vs(u),u.delay===0&&(d=!0)),($r.instantAnimations||$r.skipAnimations||i?.shouldSkipAnimations||s.skipAnimations)&&(d=!0,vs(u),u.delay=0),u.allowFlatten=!s.type&&!s.ease,d&&!a&&t.get()!==void 0){let e=_o(u.keyframes,s);if(e!==void 0){j.update(()=>{u.onUpdate(e),u.onComplete()});return}}return s.isSync?new So(u):new Es(u)},Us=/^var\(--(?:([\w-]+)|([\w-]+), ?([a-zA-Z\d ()%#.,-]+))\)/u;function Ws(e){let t=Us.exec(e);if(!t)return[,];let[,n,r,i]=t;return[`--${n??r}`,i]}function Gs(e,t,n=1){`${e}`;let[r,i]=Ws(e);if(!r)return;let a=window.getComputedStyle(t).getPropertyValue(r);if(a){let e=a.trim();return ei(e)?parseFloat(e):e}return Wi(i)?Gs(i,t,n+1):i}function Ks(e){let t=[{},{}];return e?.values.forEach((e,n)=>{t[0][n]=e.get(),t[1][n]=e.getVelocity()}),t}function qs(e,t,n,r){if(typeof t==`function`){let[i,a]=Ks(r);t=t(n===void 0?e.custom:n,i,a)}if(typeof t==`string`&&(t=e.variants&&e.variants[t]),typeof t==`function`){let[i,a]=Ks(r);t=t(n===void 0?e.custom:n,i,a)}return t}function Js(e,t,n){let r=e.getProps();return qs(r,t,n===void 0?r.custom:n,e)}var Ys=new Set([`width`,`height`,`top`,`left`,`right`,`bottom`,...Io]),Xs=e=>Array.isArray(e);function Zs(e,t,n){e.hasValue(t)?e.getValue(t).set(n):e.addValue(t,Ms(n))}function Qs(e){return Xs(e)?e[e.length-1]||0:e}function $s(e,t){let{transitionEnd:n={},transition:r={},...i}=Js(e,t)||{};i={...i,...n};for(let t in i)Zs(e,t,Qs(i[t]))}var ec=e=>!!(e&&e.getVelocity);function tc(e){return!!(ec(e)&&e.add)}function nc(e,t){let n=e.getValue(`willChange`);if(tc(n))return n.add(t);if(!n&&$r.WillChange){let n=new $r.WillChange(`auto`);e.addValue(`willChange`,n),n.add(t)}}function rc(e){return e.replace(/([A-Z])/g,e=>`-${e.toLowerCase()}`)}var ic=`data-`+rc(`framerAppearId`);function ac(e){return e.props[ic]}function oc({protectedKeys:e,needsAnimating:t},n){let r=e.hasOwnProperty(n)&&t[n]!==!0;return t[n]=!1,r}function sc(e,t,{delay:n=0,transitionOverride:r,type:i}={}){let{transition:a,transitionEnd:o,...s}=t,c=e.getDefaultTransition();a=a?Ns(a,c):c;let l=a?.reduceMotion,u=a?.skipAnimations;r&&(a=r);let d=[],f=i&&e.animationState&&e.animationState.getState()[i],p=a?.path;p&&p.animateVisualElement(e,s,a,n,d);for(let t in s){let r=e.getValue(t,e.latestValues[t]??null),i=s[t];if(i===void 0||f&&oc(f,t))continue;let o={delay:n,...Ps(a||{},t)};u&&(o.skipAnimations=!0);let c=r.get();if(c!==void 0&&!r.isAnimating()&&!Array.isArray(i)&&i===c&&!o.velocity){j.update(()=>r.set(i));continue}let p=!1;if(window.MotionHandoffAnimation){let n=ac(e);if(n){let e=window.MotionHandoffAnimation(n,t,j);e!==null&&(o.startTime=e,p=!0)}}nc(e,t);let m=l??e.shouldReduceMotion;r.start(Hs(t,r,i,m&&Ys.has(t)?{type:!1}:o,e,p));let h=r.animation;h&&d.push(h)}if(o){let t=()=>j.update(()=>{o&&$s(e,o)});d.length?Promise.all(d).then(t):t()}return d}function cc(e,t,n={}){let r=Js(e,t,n.type===`exit`?e.presenceContext?.custom:void 0),{transition:i=e.getDefaultTransition()||{}}=r||{};n.transitionOverride&&(i=n.transitionOverride);let a=r?()=>Promise.all(sc(e,r,n)):()=>Promise.resolve(),o=e.variantChildren&&e.variantChildren.size?(r=0)=>{let{delayChildren:a=0,staggerChildren:o,staggerDirection:s}=i;return lc(e,t,r,a,o,s,n)}:()=>Promise.resolve(),{when:s}=i;if(s){let[e,t]=s===`beforeChildren`?[a,o]:[o,a];return e().then(()=>t())}return Promise.all([a(),o(n.delay)])}function lc(e,t,n=0,r=0,i=0,a=1,o){let s=[];for(let c of e.variantChildren)c.notify(`AnimationStart`,t),s.push(cc(c,t,{...o,delay:n+(typeof r==`function`?0:r)+Ds(e.variantChildren,c,r,i,a)}).then(()=>c.notify(`AnimationComplete`,t)));return Promise.all(s)}function uc(e,t,n={}){e.notify(`AnimationStart`,t);let r;if(Array.isArray(t)){let i=t.map(t=>cc(e,t,n));r=Promise.all(i)}else if(typeof t==`string`)r=cc(e,t,n);else{let i=typeof t==`function`?Js(e,t,n.custom):t;r=Promise.all(sc(e,i,n))}return r.then(()=>{e.notify(`AnimationComplete`,t)})}var dc={test:e=>e===`auto`,parse:e=>e},fc=e=>t=>t.test(e),pc=[qi,P,la,ca,da,ua,dc],mc=e=>pc.find(fc(e));function hc(e){return typeof e==`number`?e===0:e===null||e===`none`||e===`0`||ni(e)}var gc=new Set([`brightness`,`contrast`,`saturate`,`opacity`]);function _c(e){let[t,n]=e.slice(0,-1).split(`(`);if(t===`drop-shadow`)return e;let[r]=n.match(Zi)||[];if(!r)return e;let i=n.replace(r,``),a=+!!gc.has(t);return r!==n&&(a*=100),t+`(`+a+i+`)`}var vc=/\b([a-z-]*)\(.*?\)/gu,yc={...ka,getAnimatableNone:e=>{let t=e.match(vc);return t?t.map(_c).join(` `):e}},bc={...ka,getAnimatableNone:e=>{let t=ka.parse(e);return ka.createTransformer(e)(t.map(e=>typeof e==`number`?0:typeof e==`object`?{...e,alpha:1}:e))}},xc={...qi,transform:Math.round},Sc={borderWidth:P,borderTopWidth:P,borderRightWidth:P,borderBottomWidth:P,borderLeftWidth:P,borderRadius:P,borderTopLeftRadius:P,borderTopRightRadius:P,borderBottomRightRadius:P,borderBottomLeftRadius:P,width:P,maxWidth:P,height:P,maxHeight:P,top:P,right:P,bottom:P,left:P,inset:P,insetBlock:P,insetBlockStart:P,insetBlockEnd:P,insetInline:P,insetInlineStart:P,insetInlineEnd:P,padding:P,paddingTop:P,paddingRight:P,paddingBottom:P,paddingLeft:P,paddingBlock:P,paddingBlockStart:P,paddingBlockEnd:P,paddingInline:P,paddingInlineStart:P,paddingInlineEnd:P,margin:P,marginTop:P,marginRight:P,marginBottom:P,marginLeft:P,marginBlock:P,marginBlockStart:P,marginBlockEnd:P,marginInline:P,marginInlineStart:P,marginInlineEnd:P,fontSize:P,backgroundPositionX:P,backgroundPositionY:P,rotate:ca,pathRotation:ca,rotateX:ca,rotateY:ca,rotateZ:ca,scale:Yi,scaleX:Yi,scaleY:Yi,scaleZ:Yi,skew:ca,skewX:ca,skewY:ca,distance:P,translateX:P,translateY:P,translateZ:P,x:P,y:P,z:P,perspective:P,transformPerspective:P,opacity:Ji,originX:fa,originY:fa,originZ:P,zIndex:xc,fillOpacity:Ji,strokeOpacity:Ji,numOctaves:xc},Cc={...Sc,color:F,backgroundColor:F,outlineColor:F,fill:F,stroke:F,borderColor:F,borderTopColor:F,borderRightColor:F,borderBottomColor:F,borderLeftColor:F,filter:yc,WebkitFilter:yc,mask:bc,WebkitMask:bc},wc=e=>Cc[e],Tc=new Set([yc,bc]);function Ec(e,t){let n=wc(e);return Tc.has(n)||(n=ka),n.getAnimatableNone?n.getAnimatableNone(t):void 0}var Dc=new Set([`auto`,`none`,`0`]);function Oc(e,t,n){let r=0,i;for(;r<e.length&&!i;){let t=e[r];typeof t==`string`&&!Dc.has(t)&&Sa(t).values.length&&(i=e[r]),r++}if(i&&n)for(let r of t)e[r]=Ec(n,i)}var kc=class extends Xo{constructor(e,t,n,r,i){super(e,t,n,r,i,!0)}readKeyframes(){let{unresolvedKeyframes:e,element:t,name:n}=this;if(!t||!t.current)return;super.readKeyframes();for(let n=0;n<e.length;n++){let r=e[n];if(typeof r==`string`&&(r=r.trim(),Wi(r))){let i=Gs(r,t.current);i!==void 0&&(e[n]=i),n===e.length-1&&(this.finalKeyframe=r)}}if(this.resolveNoneKeyframes(),!Ys.has(n)||e.length!==2)return;let[r,i]=e,a=mc(r),o=mc(i);if(Ki(r)!==Ki(i)&&Ho[n]){this.needsMeasurement=!0;return}if(a!==o){if(Ro(a)&&Ro(o))for(let t=0;t<e.length;t++){let n=e[t];typeof n==`string`&&(e[t]=parseFloat(n))}else Ho[n]&&(this.needsMeasurement=!0)}}resolveNoneKeyframes(){let{unresolvedKeyframes:e,name:t}=this,n=[];for(let t=0;t<e.length;t++)(e[t]===null||hc(e[t]))&&n.push(t);n.length&&Oc(e,n,t)}measureInitialState(){let{element:e,unresolvedKeyframes:t,name:n}=this;if(!e||!e.current)return;n===`height`&&(this.suspendedScrollY=window.pageYOffset),this.measuredOrigin=Ho[n](e.measureViewportBox(),window.getComputedStyle(e.current)),t[0]=this.measuredOrigin;let r=t[t.length-1];r!==void 0&&e.getValue(n,r).jump(r,!1)}measureEndState(){let{element:e,name:t,unresolvedKeyframes:n}=this;if(!e||!e.current)return;let r=e.getValue(t);r&&r.jump(this.measuredOrigin,!1);let i=n.length-1,a=n[i];n[i]=Ho[t](e.measureViewportBox(),window.getComputedStyle(e.current)),a!==null&&this.finalKeyframe===void 0&&(this.finalKeyframe=a),this.removedTransforms?.length&&this.removedTransforms.forEach(([t,n])=>{e.getValue(t).set(n)}),this.resolveNoneKeyframes()}},Ac=[`borderTopLeftRadius`,`borderTopRightRadius`,`borderBottomRightRadius`,`borderBottomLeftRadius`];function jc(e,t,n){if(e==null)return[];if(e instanceof EventTarget)return[e];if(typeof e==`string`){let r=document;t&&(r=t.current);let i=n?.[e]??r.querySelectorAll(e);return i?Array.from(i):[]}return Array.from(e).filter(e=>e!=null)}var Mc=(e,t)=>t&&typeof e==`number`?t.transform(e):e;function Nc(e){return ti(e)&&`offsetHeight`in e&&!(`ownerSVGElement`in e)}var{schedule:Pc,cancel:Fc}=Ii(queueMicrotask,!1),Ic={x:!1,y:!1};function Lc(){return Ic.x||Ic.y}function Rc(e){return e===`x`||e===`y`?Ic[e]?null:(Ic[e]=!0,()=>{Ic[e]=!1}):Ic.x||Ic.y?null:(Ic.x=Ic.y=!0,()=>{Ic.x=Ic.y=!1})}function zc(e,t){let n=jc(e),r=new AbortController;return[n,{passive:!0,...t,signal:r.signal},()=>r.abort()]}function Bc(e){return!(e.pointerType===`touch`||Lc())}function V(e,t,n={}){let[r,i,a]=zc(e,n);return r.forEach(e=>{let n=!1,r=!1,a,o=()=>{e.removeEventListener(`pointerleave`,u)},s=e=>{a&&=(a(e),void 0),o()},c=e=>{n=!1,window.removeEventListener(`pointerup`,c),window.removeEventListener(`pointercancel`,c),r&&(r=!1,s(e))},l=()=>{n=!0,window.addEventListener(`pointerup`,c,i),window.addEventListener(`pointercancel`,c,i)},u=e=>{if(e.pointerType!==`touch`){if(n){r=!0;return}s(e)}};e.addEventListener(`pointerenter`,n=>{if(!Bc(n))return;r=!1;let o=t(e,n);typeof o==`function`&&(a=o,e.addEventListener(`pointerleave`,u,i))},i),e.addEventListener(`pointerdown`,l,i)}),a}var Vc=(e,t)=>t?e===t||Vc(e,t.parentElement):!1,Hc=e=>e.pointerType===`mouse`?typeof e.button!=`number`||e.button<=0:e.isPrimary!==!1,Uc=new Set([`BUTTON`,`INPUT`,`SELECT`,`TEXTAREA`,`A`]);function Wc(e){return Uc.has(e.tagName)||e.isContentEditable===!0}var Gc=new Set([`INPUT`,`SELECT`,`TEXTAREA`]);function Kc(e){return Gc.has(e.tagName)||e.isContentEditable===!0}var qc=new WeakSet;function Jc(e){return t=>{t.key===`Enter`&&e(t)}}function Yc(e,t){e.dispatchEvent(new PointerEvent(`pointer`+t,{isPrimary:!0,bubbles:!0}))}var Xc=(e,t)=>{let n=e.currentTarget;if(!n)return;let r=Jc(()=>{if(qc.has(n))return;Yc(n,`down`);let e=Jc(()=>{Yc(n,`up`)});n.addEventListener(`keyup`,e,t),n.addEventListener(`blur`,()=>Yc(n,`cancel`),t)});n.addEventListener(`keydown`,r,t),n.addEventListener(`blur`,()=>n.removeEventListener(`keydown`,r),t)};function Zc(e){return Hc(e)&&!Lc()}var Qc=new WeakSet;function $c(e,t,n={}){let[r,i,a]=zc(e,n),o=e=>{let r=e.currentTarget;if(!Zc(e)||Qc.has(e))return;qc.add(r),n.stopPropagation&&Qc.add(e);let a=t(r,e),o={...i,capture:!0},s=(e,t)=>{window.removeEventListener(`pointerup`,c,o),window.removeEventListener(`pointercancel`,l,o),qc.has(r)&&qc.delete(r),Zc(e)&&typeof a==`function`&&a(e,{success:t})},c=e=>{s(e,r===window||r===document||n.useGlobalTarget||Vc(r,e.target))},l=e=>{s(e,!1)};window.addEventListener(`pointerup`,c,o),window.addEventListener(`pointercancel`,l,o)};return r.forEach(e=>{(n.useGlobalTarget?window:e).addEventListener(`pointerdown`,o,i),Nc(e)&&(e.addEventListener(`focus`,e=>Xc(e,i)),!Wc(e)&&!e.hasAttribute(`tabindex`)&&(e.tabIndex=0))}),a}function el(e){return ti(e)&&`ownerSVGElement`in e}var tl=new WeakMap,nl,rl=(e,t,n)=>(r,i)=>i&&i[0]?i[0][e+`Size`]:el(r)&&`getBBox`in r?r.getBBox()[t]:r[n],il=rl(`inline`,`width`,`offsetWidth`),al=rl(`block`,`height`,`offsetHeight`);function ol({target:e,borderBoxSize:t}){tl.get(e)?.forEach(n=>{n(e,{get width(){return il(e,t)},get height(){return al(e,t)}})})}function sl(e){e.forEach(ol)}function cl(){typeof ResizeObserver>`u`||(nl=new ResizeObserver(sl))}function ll(e,t){nl||cl();let n=jc(e);return n.forEach(e=>{let n=tl.get(e);n||(n=new Set,tl.set(e,n)),n.add(t),nl?.observe(e)}),()=>{n.forEach(e=>{let n=tl.get(e);n?.delete(t),n?.size||nl?.unobserve(e)})}}var ul=new Set,H;function dl(){H=()=>{let e={get width(){return window.innerWidth},get height(){return window.innerHeight}};ul.forEach(t=>t(e))},window.addEventListener(`resize`,H)}function fl(e){return ul.add(e),H||dl(),()=>{ul.delete(e),!ul.size&&typeof H==`function`&&(window.removeEventListener(`resize`,H),H=void 0)}}function pl(e,t){return typeof e==`function`?fl(e):ll(e,t)}var ml={value:null,addProjectionMetrics:null};function hl(e){return el(e)&&e.tagName===`svg`}var gl=[...pc,F,ka],_l=e=>gl.find(fc(e)),vl=()=>({translate:0,scale:1,origin:0,originPoint:0}),yl=()=>({x:vl(),y:vl()}),bl=()=>({min:0,max:0}),U=()=>({x:bl(),y:bl()}),xl=new WeakMap;function Sl(e){return typeof e==`object`&&!!e&&typeof e.start==`function`}function Cl(e){return typeof e==`string`||Array.isArray(e)}var wl=[`animate`,`whileInView`,`whileFocus`,`whileHover`,`whileTap`,`whileDrag`,`exit`],Tl=[`initial`,...wl];function El(e){return Sl(e.animate)||Tl.some(t=>Cl(e[t]))}function Dl(e){return!!(El(e)||e.variants)}function Ol(e,t,n){for(let r in t){let i=t[r],a=n[r];if(ec(i))e.addValue(r,i);else if(ec(a))e.addValue(r,Ms(i,{owner:e}));else if(a!==i){if(e.hasValue(r)){let t=e.getValue(r);t.liveStyle===!0?t.jump(i):t.hasAnimated||t.set(i)}else{let t=e.getStaticValue(r);e.addValue(r,Ms(t===void 0?i:t,{owner:e}))}}}for(let r in n)t[r]===void 0&&e.removeValue(r);return t}var kl={current:null},Al={current:!1},jl=typeof window<`u`;function Ml(){if(Al.current=!0,jl){if(window.matchMedia){let e=window.matchMedia(`(prefers-reduced-motion)`),t=()=>kl.current=e.matches;e.addEventListener(`change`,t),t()}else kl.current=!1}}var Nl=[`AnimationStart`,`AnimationComplete`,`Update`,`BeforeLayoutMeasure`,`LayoutMeasure`,`LayoutAnimationStart`,`LayoutAnimationComplete`],Pl={};function Fl(e){Pl=e}function Il(){return Pl}var Ll=class{scrapeMotionValuesFromProps(e,t,n){return{}}constructor({parent:e,props:t,presenceContext:n,reducedMotionConfig:r,skipAnimations:i,blockInitialAnimation:a,visualState:o},s={}){this.current=null,this.children=new Set,this.isVariantNode=!1,this.isControllingVariants=!1,this.shouldReduceMotion=null,this.shouldSkipAnimations=!1,this.values=new Map,this.KeyframeResolver=Xo,this.features={},this.valueSubscriptions=new Map,this.prevMotionValues={},this.hasBeenMounted=!1,this.events={},this.propEventSubscriptions={},this.notifyUpdate=()=>this.notify(`Update`,this.latestValues),this.render=()=>{this.current&&(this.triggerBuild(),this.renderInstance(this.current,this.renderState,this.props.style,this.projection))},this.renderScheduledAt=0,this.scheduleRender=()=>{let e=N.now();this.renderScheduledAt<e&&(this.renderScheduledAt=e,j.render(this.render,!1,!0))};let{latestValues:c,renderState:l}=o;this.latestValues=c,this.baseTarget={...c},this.initialValues=t.initial?{...c}:{},this.renderState=l,this.parent=e,this.props=t,this.presenceContext=n,this.depth=e?e.depth+1:0,this.reducedMotionConfig=r,this.skipAnimationsConfig=i,this.options=s,this.blockInitialAnimation=!!a,this.isControllingVariants=El(t),this.isVariantNode=Dl(t),this.isVariantNode&&(this.variantChildren=new Set),this.manuallyAnimateOnMount=!!(e&&e.current);let{willChange:u,...d}=this.scrapeMotionValuesFromProps(t,{},this);for(let e in d){let t=d[e];c[e]!==void 0&&ec(t)&&t.set(c[e])}}mount(e){if(this.hasBeenMounted)for(let e in this.initialValues)this.values.get(e)?.jump(this.initialValues[e]),this.latestValues[e]=this.initialValues[e];this.current=e,xl.set(e,this),this.projection&&!this.projection.instance&&this.projection.mount(e),this.parent&&this.isVariantNode&&!this.isControllingVariants&&(this.removeFromVariantTree=this.parent.addVariantChild(this)),this.values.forEach((e,t)=>this.bindToMotionValue(t,e)),this.reducedMotionConfig===`never`?this.shouldReduceMotion=!1:this.reducedMotionConfig===`always`?this.shouldReduceMotion=!0:(Al.current||Ml(),this.shouldReduceMotion=kl.current),this.shouldSkipAnimations=this.skipAnimationsConfig??!1,this.parent?.addChild(this),this.update(this.props,this.presenceContext),this.hasBeenMounted=!0}unmount(){this.projection&&this.projection.unmount(),Li(this.notifyUpdate),Li(this.render),this.valueSubscriptions.forEach(e=>e()),this.valueSubscriptions.clear(),this.removeFromVariantTree&&this.removeFromVariantTree(),this.parent?.removeChild(this);for(let e in this.events)this.events[e].clear();for(let e in this.features){let t=this.features[e];t&&(t.unmount(),t.isMounted=!1)}this.current=null}addChild(e){this.children.add(e),this.enteringChildren??=new Set,this.enteringChildren.add(e)}removeChild(e){this.children.delete(e),this.enteringChildren&&this.enteringChildren.delete(e)}bindToMotionValue(e,t){if(this.valueSubscriptions.has(e)&&this.valueSubscriptions.get(e)(),t.accelerate&&ys.has(e)&&this.current instanceof HTMLElement){let{factory:n,keyframes:r,times:i,ease:a,duration:o}=t.accelerate,s=new ls({element:this.current,name:e,keyframes:r,times:i,ease:a,duration:ci(o)}),c=n(s);this.valueSubscriptions.set(e,()=>{c(),s.cancel()});return}let n=Lo.has(e);n&&this.onBindTransform&&this.onBindTransform();let r=t.on(`change`,t=>{this.latestValues[e]=t,this.props.onUpdate&&j.preRender(this.notifyUpdate),n&&this.projection&&(this.projection.isTransformDirty=!0),this.scheduleRender()}),i;typeof window<`u`&&window.MotionCheckAppearSync&&(i=window.MotionCheckAppearSync(this,e,t)),this.valueSubscriptions.set(e,()=>{r(),i&&i()})}sortNodePosition(e){return!this.current||!this.sortInstanceNodePosition||this.type!==e.type?0:this.sortInstanceNodePosition(this.current,e.current)}updateFeatures(){let e=`animation`;for(e in Pl){let t=Pl[e];if(!t)continue;let{isEnabled:n,Feature:r}=t;if(!this.features[e]&&r&&n(this.props)&&(this.features[e]=new r(this)),this.features[e]){let t=this.features[e];t.isMounted?t.update():(t.mount(),t.isMounted=!0)}}}triggerBuild(){this.build(this.renderState,this.latestValues,this.props)}measureViewportBox(){return this.current?this.measureInstanceViewportBox(this.current,this.props):U()}getStaticValue(e){return this.latestValues[e]}setStaticValue(e,t){this.latestValues[e]=t}update(e,t){(e.transformTemplate||this.props.transformTemplate)&&this.scheduleRender(),this.prevProps=this.props,this.props=e,this.prevPresenceContext=this.presenceContext,this.presenceContext=t;for(let t=0;t<Nl.length;t++){let n=Nl[t];this.propEventSubscriptions[n]&&(this.propEventSubscriptions[n](),delete this.propEventSubscriptions[n]);let r=e[`on`+n];r&&(this.propEventSubscriptions[n]=this.on(n,r))}this.prevMotionValues=Ol(this,this.scrapeMotionValuesFromProps(e,this.prevProps||{},this),this.prevMotionValues),this.handleChildMotionValue&&this.handleChildMotionValue()}getProps(){return this.props}getVariant(e){return this.props.variants?this.props.variants[e]:void 0}getDefaultTransition(){return this.props.transition}getTransformPagePoint(){return this.props.transformPagePoint}getClosestVariantNode(){return this.isVariantNode?this:this.parent?this.parent.getClosestVariantNode():void 0}addVariantChild(e){let t=this.getClosestVariantNode();if(t)return t.variantChildren&&t.variantChildren.add(e),()=>t.variantChildren.delete(e)}addValue(e,t){let n=this.values.get(e);t!==n&&(n&&this.removeValue(e),this.bindToMotionValue(e,t),this.values.set(e,t),this.latestValues[e]=t.get())}removeValue(e){this.values.delete(e);let t=this.valueSubscriptions.get(e);t&&(t(),this.valueSubscriptions.delete(e)),delete this.latestValues[e],this.removeValueFromRenderState(e,this.renderState)}hasValue(e){return this.values.has(e)}getValue(e,t){if(this.props.values&&this.props.values[e])return this.props.values[e];let n=this.values.get(e);return n===void 0&&t!==void 0&&(n=Ms(t===null?void 0:t,{owner:this}),this.addValue(e,n)),n}readValue(e,t){let n=this.latestValues[e]!==void 0||!this.current?this.latestValues[e]:this.getBaseTargetFromProps(this.props,e)??this.readValueFromInstance(this.current,e,this.options);return n!=null&&(typeof n==`string`&&(ei(n)||ni(n))?n=parseFloat(n):!_l(n)&&ka.test(t)&&(n=Ec(e,t)),this.setBaseTarget(e,ec(n)?n.get():n)),ec(n)?n.get():n}setBaseTarget(e,t){this.baseTarget[e]=t}getBaseTarget(e){let{initial:t}=this.props,n;if(typeof t==`string`||typeof t==`object`){let r=qs(this.props,t,this.presenceContext?.custom);r&&(n=r[e])}if(t&&n!==void 0)return n;let r=this.getBaseTargetFromProps(this.props,e);return r!==void 0&&!ec(r)?r:this.initialValues[e]!==void 0&&n===void 0?void 0:this.baseTarget[e]}on(e,t){return this.events[e]||(this.events[e]=new si),this.events[e].add(t)}notify(e,...t){this.events[e]&&this.events[e].notify(...t)}scheduleRenderMicrotask(){Pc.render(this.render)}},Rl=class extends Ll{constructor(){super(...arguments),this.KeyframeResolver=kc}sortInstanceNodePosition(e,t){return e.compareDocumentPosition(t)&2?1:-1}getBaseTargetFromProps(e,t){let n=e.style;return n?n[t]:void 0}removeValueFromRenderState(e,{vars:t,style:n}){delete t[e],delete n[e]}handleChildMotionValue(){this.childSubscription&&(this.childSubscription(),delete this.childSubscription);let{children:e}=this.props;ec(e)&&(this.childSubscription=e.on(`change`,e=>{this.current&&(this.current.textContent=`${e}`)}))}},zl=class{constructor(e){this.isMounted=!1,this.node=e}update(){}};function Bl({top:e,left:t,right:n,bottom:r}){return{x:{min:t,max:n},y:{min:e,max:r}}}function W({x:e,y:t}){return{top:t.min,right:e.max,bottom:t.max,left:e.min}}function G(e,t){if(!t)return e;let n=t({x:e.left,y:e.top}),r=t({x:e.right,y:e.bottom});return{top:n.y,left:n.x,bottom:r.y,right:r.x}}function K(e){return e===void 0||e===1}function q({scale:e,scaleX:t,scaleY:n}){return!K(e)||!K(t)||!K(n)}function J(e){return q(e)||Vl(e)||e.z||e.rotate||e.rotateX||e.rotateY||e.skewX||e.skewY}function Vl(e){return Hl(e.x)||Hl(e.y)}function Hl(e){return e&&e!==`0%`}function Ul(e,t,n){return n+t*(e-n)}function Wl(e,t,n,r,i){return i!==void 0&&(e=Ul(e,i,r)),Ul(e,n,r)+t}function Gl(e,t=0,n=1,r,i){e.min=Wl(e.min,t,n,r,i),e.max=Wl(e.max,t,n,r,i)}function Y(e,{x:t,y:n}){Gl(e.x,t.translate,t.scale,t.originPoint),Gl(e.y,n.translate,n.scale,n.originPoint)}var Kl=.999999999999,ql=1.0000000000001;function Jl(e,t,n,r=!1){let i=n.length;if(!i)return;t.x=t.y=1;let a,o;for(let s=0;s<i;s++){a=n[s],o=a.projectionDelta;let{visualElement:i}=a.options;i&&i.props.style&&i.props.style.display===`contents`||(r&&a.options.layoutScroll&&a.scroll&&a!==a.root&&(Yl(e.x,-a.scroll.offset.x),Yl(e.y,-a.scroll.offset.y)),o&&(t.x*=o.x.scale,t.y*=o.y.scale,Y(e,o)),r&&J(a.latestValues)&&Ql(e,a.latestValues,a.layout?.layoutBox))}t.x<ql&&t.x>Kl&&(t.x=1),t.y<ql&&t.y>Kl&&(t.y=1)}function Yl(e,t){e.min+=t,e.max+=t}function Xl(e,t,n,r,i=.5){Gl(e,t,n,I(e.min,e.max,i),r)}function Zl(e,t){return typeof e==`string`?parseFloat(e)/100*(t.max-t.min):e}function Ql(e,t,n){let r=n??e;Xl(e.x,Zl(t.x,r.x),t.scaleX,t.scale,t.originX),Xl(e.y,Zl(t.y,r.y),t.scaleY,t.scale,t.originY)}function $l(e,t){return Bl(G(e.getBoundingClientRect(),t))}function eu(e,t,n){let r=$l(e,n),{scroll:i}=t;return i&&(Yl(r.x,i.offset.x),Yl(r.y,i.offset.y)),r}var tu={x:`translateX`,y:`translateY`,z:`translateZ`,transformPerspective:`perspective`},nu=Io.length;function ru(e,t,n){let r=``,i=!0;for(let a=0;a<nu;a++){let o=Io[a],s=e[o];if(s===void 0)continue;let c=!0;if(typeof s==`number`)c=s===+!!o.startsWith(`scale`);else{let e=parseFloat(s);c=o.startsWith(`scale`)?e===1:e===0}if(!c||n){let e=Mc(s,Sc[o]);if(!c){i=!1;let t=tu[o]||o;r+=`${t}(${e}) `}n&&(t[o]=e)}}let a=e.pathRotation;return a&&(i=!1,r+=`rotate(${Mc(a,Sc.pathRotation)}) `),r=r.trim(),n?r=n(t,i?``:r):i&&(r=`none`),r}function iu(e,t,n){let{style:r,vars:i,transformOrigin:a}=e,o=!1,s=!1;for(let e in t){let n=t[e];if(Lo.has(e)){o=!0;continue}if(Hi(e)){i[e]=n;continue}{let t=Mc(n,Sc[e]);e.startsWith(`origin`)?(s=!0,a[e]=t):r[e]=t}}if(t.transform||(o||n?r.transform=ru(t,e.transform,n):r.transform&&=`none`),s){let{originX:e=`50%`,originY:t=`50%`,originZ:n=0}=a;r.transformOrigin=`${e} ${t} ${n}`}}function au(e,{style:t,vars:n},r,i){let a=e.style,o;for(o in t)a[o]=t[o];for(o in i?.applyProjectionStyles(a,r),n)a.setProperty(o,n[o])}function ou(e,t){return t.max===t.min?0:e/(t.max-t.min)*100}var su={correct:(e,t)=>{if(!t.target)return e;if(typeof e==`string`){if(P.test(e))e=parseFloat(e);else return e}return`${ou(e,t.target.x)}% ${ou(e,t.target.y)}%`}},cu={correct:(e,{treeScale:t,projectionDelta:n})=>{let r=e,i=ka.parse(e);if(i.length>5)return r;let a=ka.createTransformer(e),o=typeof i[0]==`number`?0:1,s=n.x.scale*t.x,c=n.y.scale*t.y;i[0+o]/=s,i[1+o]/=c;let l=I(s,c,.5);return typeof i[2+o]==`number`&&(i[2+o]/=l),typeof i[3+o]==`number`&&(i[3+o]/=l),a(i)}},lu={borderRadius:{...su,applyTo:[...Ac]},borderTopLeftRadius:su,borderTopRightRadius:su,borderBottomLeftRadius:su,borderBottomRightRadius:su,boxShadow:cu};function uu(e,{layout:t,layoutId:n}){return Lo.has(e)||e.startsWith(`origin`)||(t||n!==void 0)&&(!!lu[e]||e===`opacity`)}function du(e,t,n){let r=e.style,i=t?.style,a={};if(!r)return a;for(let t in r)(ec(r[t])||i&&ec(i[t])||uu(t,e)||n?.getValue(t)?.liveStyle!==void 0)&&(a[t]=r[t]);return a}function fu(e){return window.getComputedStyle(e)}var pu=class extends Rl{constructor(){super(...arguments),this.type=`html`,this.renderInstance=au}mount(e){e.style,super.mount(e)}readValueFromInstance(e,t){if(Lo.has(t))return this.projection?.isProjecting?Mo(t):Po(e,t);{let n=fu(e),r=(Hi(t)?n.getPropertyValue(t):n[t])||0;return typeof r==`string`?r.trim():r}}measureInstanceViewportBox(e,{transformPagePoint:t}){return $l(e,t)}build(e,t,n){iu(e,t,n.transformTemplate)}scrapeMotionValuesFromProps(e,t,n){return du(e,t,n)}},mu={offset:`stroke-dashoffset`,array:`stroke-dasharray`},hu={offset:`strokeDashoffset`,array:`strokeDasharray`};function gu(e,t,n=1,r=0,i=!0){e.pathLength=1;let a=i?mu:hu;e[a.offset]=`${-r}`,e[a.array]=`${t} ${n}`}var _u=[`transform`,`opacity`,`offsetDistance`,`offsetPath`,`offsetRotate`,`offsetAnchor`];function vu(e,{attrX:t,attrY:n,attrScale:r,pathLength:i,pathSpacing:a=1,pathOffset:o=0,...s},c,l,u){if(iu(e,s,l),c){e.style.viewBox&&(e.attrs.viewBox=e.style.viewBox);return}e.attrs=e.style,e.style={};let{attrs:d,style:f}=e;for(let e of _u)d[e]!==void 0&&(f[e]=d[e],delete d[e]);(f.transform||d.transformOrigin)&&(f.transformOrigin=d.transformOrigin??`50% 50%`,delete d.transformOrigin),f.transform&&(f.transformBox=u?.transformBox??`fill-box`,delete d.transformBox),t!==void 0&&(d.x=t),n!==void 0&&(d.y=n),r!==void 0&&(d.scale=r),i!==void 0&&gu(d,i,a,o,!1)}var yu=new Set([`baseFrequency`,`diffuseConstant`,`kernelMatrix`,`kernelUnitLength`,`keySplines`,`keyTimes`,`limitingConeAngle`,`markerHeight`,`markerWidth`,`numOctaves`,`targetX`,`targetY`,`surfaceScale`,`specularConstant`,`specularExponent`,`stdDeviation`,`tableValues`,`viewBox`,`gradientTransform`,`pathLength`,`startOffset`,`textLength`,`lengthAdjust`]),bu=e=>typeof e==`string`&&e.toLowerCase()===`svg`;function xu(e,t,n,r){au(e,t,void 0,r);for(let n in t.attrs)e.setAttribute(yu.has(n)?n:rc(n),t.attrs[n])}function Su(e,t,n){let r=du(e,t,n);for(let n in e)if(ec(e[n])||ec(t[n])){let t=Io.indexOf(n)===-1?n:`attr`+n.charAt(0).toUpperCase()+n.substring(1);r[t]=e[n]}return r}var Cu=class extends Rl{constructor(){super(...arguments),this.type=`svg`,this.isSVGTag=!1,this.measureInstanceViewportBox=U}getBaseTargetFromProps(e,t){return e[t]}readValueFromInstance(e,t){if(Lo.has(t)){let e=wc(t);return e&&e.default||0}if(_u.includes(t)){let n=getComputedStyle(e)[t];if(typeof n==`string`&&n)return n.trim()}return t=yu.has(t)?t:rc(t),e.getAttribute(t)}scrapeMotionValuesFromProps(e,t,n){return Su(e,t,n)}build(e,t,n){vu(e,t,this.isSVGTag,n.transformTemplate,n.style)}renderInstance(e,t,n,r){xu(e,t,n,r)}mount(e){this.isSVGTag=bu(e.tagName),super.mount(e)}},wu=Tl.length;function Tu(e){if(!e)return;if(!e.isControllingVariants){let t=e.parent&&Tu(e.parent)||{};return e.props.initial!==void 0&&(t.initial=e.props.initial),t}let t={};for(let n=0;n<wu;n++){let r=Tl[n],i=e.props[r];(Cl(i)||i===!1)&&(t[r]=i)}return t}function Eu(e,t){if(!Array.isArray(t))return!1;let n=t.length;if(n!==e.length)return!1;for(let r=0;r<n;r++)if(t[r]!==e[r])return!1;return!0}var Du=[...wl].reverse(),Ou=wl.length;function ku(e){return t=>Promise.all(t.map(({animation:t,options:n})=>uc(e,t,n)))}function Au(e){let t=ku(e),n=Nu(),r=!0,i=!1,a=t=>(n,r)=>{let i=Js(e,r,t===`exit`?e.presenceContext?.custom:void 0);if(i){let{transition:e,transitionEnd:t,...r}=i;n={...n,...r,...t}}return n};function o(n){t=n(e)}function s(o){let{props:s}=e,c=Tu(e.parent)||{},l=[],u=new Set,d={},f=1/0;for(let t=0;t<Ou;t++){let p=Du[t],m=n[p],h=s[p]===void 0?c[p]:s[p],g=Cl(h),_=p===o?m.isActive:null;_===!1&&(f=t);let v=h===c[p]&&h!==s[p]&&g;if(v&&(r||i)&&e.manuallyAnimateOnMount&&(v=!1),m.protectedKeys={...d},!m.isActive&&_===null||!h&&!m.prevProp||Sl(h)||typeof h==`boolean`)continue;if(p===`exit`&&m.isActive&&_!==!0){m.prevResolvedValues&&(d={...d,...m.prevResolvedValues});continue}let y=ju(m.prevProp,h),b=y||p===o&&m.isActive&&!v&&g||t>f&&g,x=!1,S=Array.isArray(h)?h:[h],C=S.reduce(a(p),{});_===!1&&(C={});let{prevResolvedValues:w={}}=m,ee={...w,...C},te=t=>{b=!0,u.has(t)&&(x=!0,u.delete(t)),m.needsAnimating[t]=!0;let n=e.getValue(t);n&&(n.liveStyle=!1)};for(let e in ee){let t=C[e],n=w[e];if(d.hasOwnProperty(e))continue;let r=!1;r=Xs(t)&&Xs(n)?!Eu(t,n)||y:t!==n,r?t==null?u.add(e):te(e):t!==void 0&&u.has(e)?te(e):m.protectedKeys[e]=!0}m.prevProp=h,m.prevResolvedValues=C,m.isActive&&(d={...d,...C}),(r||i)&&e.blockInitialAnimation&&(b=!1);let ne=v&&y;b&&(!ne||x)&&l.push(...S.map(t=>{let n={type:p};if(typeof t==`string`&&(r||i)&&!ne&&e.manuallyAnimateOnMount&&e.parent){let{parent:r}=e,i=Js(r,t);if(r.enteringChildren&&i){let{delayChildren:t}=i.transition||{};n.delay=Ds(r.enteringChildren,e,t)}}return{animation:t,options:n}}))}if(u.size){let t={};if(typeof s.initial!=`boolean`){let n=Js(e,Array.isArray(s.initial)?s.initial[0]:s.initial);n&&n.transition&&(t.transition=n.transition)}u.forEach(n=>{let r=e.getBaseTarget(n),i=e.getValue(n);i&&(i.liveStyle=!0),t[n]=r??null}),l.push({animation:t})}let p=!!l.length;return r&&(s.initial===!1||s.initial===s.animate)&&!e.manuallyAnimateOnMount&&(p=!1),r=!1,i=!1,p?t(l):Promise.resolve()}function c(t,r){if(n[t].isActive===r)return Promise.resolve();e.variantChildren?.forEach(e=>e.animationState?.setActive(t,r)),n[t].isActive=r;let i=s(t);for(let e in n)n[e].protectedKeys={};return i}return{animateChanges:s,setActive:c,setAnimateFunction:o,getState:()=>n,reset:()=>{n=Nu(),i=!0}}}function ju(e,t){return typeof t==`string`?t!==e:Array.isArray(t)?!Eu(t,e):!1}function Mu(e=!1){return{isActive:e,protectedKeys:{},needsAnimating:{},prevResolvedValues:{}}}function Nu(){return{animate:Mu(!0),whileInView:Mu(),whileHover:Mu(),whileTap:Mu(),whileDrag:Mu(),whileFocus:Mu(),exit:Mu()}}function Pu(e,t){e.min=t.min,e.max=t.max}function Fu(e,t){Pu(e.x,t.x),Pu(e.y,t.y)}function Iu(e,t){e.translate=t.translate,e.scale=t.scale,e.originPoint=t.originPoint,e.origin=t.origin}var Lu=.9999,Ru=1.0001,zu=-.01,Bu=.01;function Vu(e){return e.max-e.min}function Hu(e,t,n){return Math.abs(e-t)<=n}function Uu(e,t,n,r=.5){e.origin=r,e.originPoint=I(t.min,t.max,e.origin),e.scale=Vu(n)/Vu(t),e.translate=I(n.min,n.max,e.origin)-e.originPoint,(e.scale>=Lu&&e.scale<=Ru||isNaN(e.scale))&&(e.scale=1),(e.translate>=zu&&e.translate<=Bu||isNaN(e.translate))&&(e.translate=0)}function Wu(e,t,n,r){Uu(e.x,t.x,n.x,r?r.originX:void 0),Uu(e.y,t.y,n.y,r?r.originY:void 0)}function Gu(e,t,n,r=0){e.min=(r?I(n.min,n.max,r):n.min)+t.min,e.max=e.min+Vu(t)}function X(e,t,n,r){Gu(e.x,t.x,n.x,r?.x),Gu(e.y,t.y,n.y,r?.y)}function Ku(e,t,n,r=0){let i=r?I(n.min,n.max,r):n.min;e.min=t.min-i,e.max=e.min+Vu(t)}function qu(e,t,n,r){Ku(e.x,t.x,n.x,r?.x),Ku(e.y,t.y,n.y,r?.y)}function Ju(e,t,n,r,i){return e-=t,e=Ul(e,1/n,r),i!==void 0&&(e=Ul(e,1/i,r)),e}function Yu(e,t=0,n=1,r=.5,i,a=e,o=e){if(la.test(t)&&(t=parseFloat(t),t=I(o.min,o.max,t/100)-o.min),typeof t!=`number`)return;let s=I(a.min,a.max,r);e===a&&(s-=t),e.min=Ju(e.min,t,n,s,i),e.max=Ju(e.max,t,n,s,i)}function Xu(e,t,[n,r,i],a,o){Yu(e,t[n],t[r],t[i],t.scale,a,o)}var Zu=[`x`,`scaleX`,`originX`],Qu=[`y`,`scaleY`,`originY`];function $u(e,t,n,r){Xu(e.x,t,Zu,n?n.x:void 0,r?r.x:void 0),Xu(e.y,t,Qu,n?n.y:void 0,r?r.y:void 0)}function ed(e){return e.translate===0&&e.scale===1}function td(e){return ed(e.x)&&ed(e.y)}function nd(e,t){return e.min===t.min&&e.max===t.max}function rd(e,t){return nd(e.x,t.x)&&nd(e.y,t.y)}function id(e,t){return Math.round(e.min)===Math.round(t.min)&&Math.round(e.max)===Math.round(t.max)}function ad(e,t){return id(e.x,t.x)&&id(e.y,t.y)}function od(e){return Vu(e.x)/Vu(e.y)}function sd(e,t){return e.translate===t.translate&&e.scale===t.scale&&e.originPoint===t.originPoint}function cd(e){return[e(`x`),e(`y`)]}function ld(e,t,n){let r=``,i=e.x.translate/t.x,a=e.y.translate/t.y,o=n?.z||0;if((i||a||o)&&(r=`translate3d(${i}px, ${a}px, ${o}px) `),(t.x!==1||t.y!==1)&&(r+=`scale(${1/t.x}, ${1/t.y}) `),n){let{transformPerspective:e,rotate:t,pathRotation:i,rotateX:a,rotateY:o,skewX:s,skewY:c}=n;e&&(r=`perspective(${e}px) ${r}`),t&&(r+=`rotate(${t}deg) `),i&&(r+=`rotate(${i}deg) `),a&&(r+=`rotateX(${a}deg) `),o&&(r+=`rotateY(${o}deg) `),s&&(r+=`skewX(${s}deg) `),c&&(r+=`skewY(${c}deg) `)}let s=e.x.scale*t.x,c=e.y.scale*t.y;return(s!==1||c!==1)&&(r+=`scale(${s}, ${c})`),r||`none`}var ud=Ac.length,dd=e=>typeof e==`string`?parseFloat(e):e,fd=e=>typeof e==`number`||P.test(e);function pd(e,t,n,r,i,a){i?(e.opacity=I(0,n.opacity??1,hd(r)),e.opacityExit=I(t.opacity??1,0,gd(r))):a&&(e.opacity=I(t.opacity??1,n.opacity??1,r));for(let i=0;i<ud;i++){let a=Ac[i],o=md(t,a),s=md(n,a);(o!==void 0||s!==void 0)&&(o||=0,s||=0,o===0||s===0||fd(o)===fd(s)?(e[a]=Math.max(I(dd(o),dd(s),r),0),(la.test(s)||la.test(o))&&(e[a]+=`%`)):e[a]=s)}(t.rotate||n.rotate)&&(e.rotate=I(t.rotate||0,n.rotate||0,r))}function md(e,t){return e[t]===void 0?e.borderRadius:e[t]}var hd=_d(0,.5,Ci),gd=_d(.5,.95,ii);function _d(e,t,n){return r=>r<e?0:r>t?1:n(oi(e,t,r))}function vd(e,t,n){let r=ec(e)?e:Ms(e);return r.start(Hs(``,r,t,n)),r.animation}function yd(e,t,n,r={passive:!0}){return e.addEventListener(t,n,r),()=>e.removeEventListener(t,n,r)}var bd=(e,t)=>e.depth-t.depth,Z=class{constructor(){this.children=[],this.isDirty=!1}add(e){Xr(this.children,e),this.isDirty=!0}remove(e){Zr(this.children,e),this.isDirty=!0}forEach(e){this.isDirty&&this.children.sort(bd),this.isDirty=!1,this.children.forEach(e)}};function xd(e,t){let n=N.now(),r=({timestamp:i})=>{let a=i-n;a>=t&&(Li(r),e(a-t))};return j.setup(r,!0),()=>Li(r)}function Sd(e){return ec(e)?e.get():e}var Cd=class{constructor(){this.members=[]}add(e){Xr(this.members,e);for(let t=this.members.length-1;t>=0;t--){let n=this.members[t];if(n===e||n===this.lead||n===this.prevLead)continue;let r=n.instance;(!r||r.isConnected===!1)&&!n.snapshot&&(Zr(this.members,n),n.unmount())}e.scheduleRender()}remove(e){if(Zr(this.members,e),e===this.prevLead&&(this.prevLead=void 0),e===this.lead){let e=this.members[this.members.length-1];e&&this.promote(e)}}relegate(e){for(let t=this.members.indexOf(e)-1;t>=0;t--){let e=this.members[t];if(e.isPresent!==!1&&e.instance?.isConnected!==!1)return this.promote(e),!0}return!1}promote(e,t){let n=this.lead;if(e!==n&&(this.prevLead=n,this.lead=e,e.show(),n)){n.updateSnapshot(),e.scheduleRender();let{layoutDependency:r}=n.options,{layoutDependency:i}=e.options;(r===void 0||r!==i)&&(e.resumeFrom=n,t&&(n.preserveOpacity=!0),n.snapshot&&(e.snapshot=n.snapshot,e.snapshot.latestValues=n.animationValues||n.latestValues),e.root?.isUpdating&&(e.isLayoutDirty=!0)),e.options.crossfade===!1&&n.hide()}}exitAnimationComplete(){this.members.forEach(e=>{e.options.onExitComplete?.(),e.resumingFrom?.options.onExitComplete?.()})}scheduleRender(){this.members.forEach(e=>e.instance&&e.scheduleRender(!1))}removeLeadSnapshot(){this.lead?.snapshot&&(this.lead.snapshot=void 0)}},wd={hasAnimatedSinceResize:!0,hasEverUpdated:!1},Td={nodes:0,calculatedTargetDeltas:0,calculatedProjections:0},Ed=[``,`X`,`Y`,`Z`],Dd=1e3,Od=0;function kd(e,t,n,r){let{latestValues:i}=t;i[e]&&(n[e]=i[e],t.setStaticValue(e,0),r&&(r[e]=0))}function Ad(e){if(e.hasCheckedOptimisedAppear=!0,e.root===e)return;let{visualElement:t}=e.options;if(!t)return;let n=ac(t);if(window.MotionHasOptimisedAnimation(n,`transform`)){let{layout:t,layoutId:r}=e.options;window.MotionCancelOptimisedAnimation(n,`transform`,j,!(t||r))}let{parent:r}=e;r&&!r.hasCheckedOptimisedAppear&&Ad(r)}function jd({attachResizeListener:e,defaultParent:t,measureScroll:n,checkIsScrollRoot:r,resetTransform:i}){return class{constructor(e={},n=t?.()){this.id=Od++,this.animationId=0,this.animationCommitId=0,this.children=new Set,this.options={},this.isTreeAnimating=!1,this.isAnimationBlocked=!1,this.isLayoutDirty=!1,this.isProjectionDirty=!1,this.isSharedProjectionDirty=!1,this.isTransformDirty=!1,this.updateManuallyBlocked=!1,this.updateBlockedByResize=!1,this.isUpdating=!1,this.isSVG=!1,this.needsReset=!1,this.shouldResetTransform=!1,this.hasCheckedOptimisedAppear=!1,this.treeScale={x:1,y:1},this.eventHandlers=new Map,this.hasTreeAnimated=!1,this.layoutVersion=0,this.updateScheduled=!1,this.scheduleUpdate=()=>this.update(),this.projectionUpdateScheduled=!1,this.checkUpdateFailed=()=>{this.isUpdating&&(this.isUpdating=!1,this.clearAllSnapshots())},this.updateProjection=()=>{this.projectionUpdateScheduled=!1,ml.value&&(Td.nodes=Td.calculatedTargetDeltas=Td.calculatedProjections=0),this.nodes.forEach(Q),this.nodes.forEach(Hd),this.nodes.forEach(Ud),this.nodes.forEach(Pd),ml.addProjectionMetrics&&ml.addProjectionMetrics(Td)},this.resolvedRelativeTargetAt=0,this.linkedParentVersion=0,this.hasProjected=!1,this.isVisible=!0,this.animationProgress=0,this.sharedNodes=new Map,this.latestValues=e,this.root=n?n.root||n:this,this.path=n?[...n.path,n]:[],this.parent=n,this.depth=n?n.depth+1:0;for(let e=0;e<this.path.length;e++)this.path[e].shouldResetTransform=!0;this.root===this&&(this.nodes=new Z)}addEventListener(e,t){return this.eventHandlers.has(e)||this.eventHandlers.set(e,new si),this.eventHandlers.get(e).add(t)}notifyListeners(e,...t){let n=this.eventHandlers.get(e);n&&n.notify(...t)}hasListeners(e){return this.eventHandlers.has(e)}mount(t){if(this.instance)return;this.isSVG=el(t)&&!hl(t),this.instance=t;let{layoutId:n,layout:r,visualElement:i}=this.options;if(i&&!i.current&&i.mount(t),this.root.nodes.add(this),this.parent&&this.parent.children.add(this),this.root.hasTreeAnimated&&(r||n)&&(this.isLayoutDirty=!0),e){let n,r=0,i=()=>this.root.updateBlockedByResize=!1;j.read(()=>{r=window.innerWidth}),e(t,()=>{let e=window.innerWidth;e!==r&&(r=e,this.root.updateBlockedByResize=!0,n&&n(),n=xd(i,250),wd.hasAnimatedSinceResize&&(wd.hasAnimatedSinceResize=!1,this.nodes.forEach(Vd)))})}n&&this.root.registerSharedNode(n,this),this.options.animate!==!1&&i&&(n||r)&&this.addEventListener(`didUpdate`,({delta:e,hasLayoutChanged:t,hasRelativeLayoutChanged:n,layout:r})=>{if(this.isTreeAnimationBlocked()){this.target=void 0,this.relativeTarget=void 0;return}let a=this.options.transition||i.getDefaultTransition()||Xd,{onLayoutAnimationStart:o,onLayoutAnimationComplete:s}=i.getProps(),c=!this.targetLayout||!ad(this.targetLayout,r),l=!t&&n;if(this.options.layoutRoot||this.resumeFrom||l||t&&(c||!this.currentAnimation)){this.resumeFrom&&(this.resumingFrom=this.resumeFrom,this.resumingFrom.resumingFrom=void 0);let t={...Ps(a,`layout`),onPlay:o,onComplete:s};(i.shouldReduceMotion||this.options.layoutRoot)&&(t.delay=0,t.type=!1),this.startAnimation(t),this.setAnimationOrigin(e,l,t.path)}else t||Vd(this),this.isLead()&&this.options.onExitComplete&&this.options.onExitComplete();this.targetLayout=r})}unmount(){this.options.layoutId&&this.willUpdate(),this.root.nodes.remove(this);let e=this.getStack();e&&e.remove(this),this.parent&&this.parent.children.delete(this),this.instance=void 0,this.eventHandlers.clear(),Li(this.updateProjection)}blockUpdate(){this.updateManuallyBlocked=!0}unblockUpdate(){this.updateManuallyBlocked=!1}isUpdateBlocked(){return this.updateManuallyBlocked||this.updateBlockedByResize}isTreeAnimationBlocked(){return this.isAnimationBlocked||this.parent&&this.parent.isTreeAnimationBlocked()||!1}startUpdate(){this.isUpdateBlocked()||(this.isUpdating=!0,this.nodes&&this.nodes.forEach(Wd),this.animationId++)}getTransformTemplate(){let{visualElement:e}=this.options;return e&&e.getProps().transformTemplate}willUpdate(e=!0){if(this.root.hasTreeAnimated=!0,this.root.isUpdateBlocked()){this.options.onExitComplete&&this.options.onExitComplete();return}if(window.MotionCancelOptimisedAnimation&&!this.hasCheckedOptimisedAppear&&Ad(this),!this.root.isUpdating&&this.root.startUpdate(),this.isLayoutDirty)return;this.isLayoutDirty=!0;for(let e=0;e<this.path.length;e++){let t=this.path[e];t.shouldResetTransform=!0,(typeof t.latestValues.x==`string`||typeof t.latestValues.y==`string`)&&(t.isLayoutDirty=!0),t.updateScroll(`snapshot`),t.options.layoutRoot&&t.willUpdate(!1)}let{layoutId:t,layout:n}=this.options;if(t===void 0&&!n)return;let r=this.getTransformTemplate();this.prevTransformTemplateValue=r?r(this.latestValues,``):void 0,this.updateSnapshot(),e&&this.notifyListeners(`willUpdate`)}update(){if(this.updateScheduled=!1,this.isUpdateBlocked()){let e=this.updateBlockedByResize;this.unblockUpdate(),this.updateBlockedByResize=!1,this.clearAllSnapshots(),e&&this.nodes.forEach(Ld),this.nodes.forEach(Id);return}if(this.animationId<=this.animationCommitId){this.nodes.forEach(Rd);return}this.animationCommitId=this.animationId,this.isUpdating?(this.isUpdating=!1,this.nodes.forEach(zd),this.nodes.forEach(Bd),this.nodes.forEach(Md),this.nodes.forEach(Nd)):this.nodes.forEach(Rd),this.clearAllSnapshots();let e=N.now();Ri.delta=Qr(0,1e3/60,e-Ri.timestamp),Ri.timestamp=e,Ri.isProcessing=!0,zi.update.process(Ri),zi.preRender.process(Ri),zi.render.process(Ri),Ri.isProcessing=!1}didUpdate(){this.updateScheduled||(this.updateScheduled=!0,Pc.read(this.scheduleUpdate))}clearAllSnapshots(){this.nodes.forEach(Fd),this.sharedNodes.forEach(Gd)}scheduleUpdateProjection(){this.projectionUpdateScheduled||(this.projectionUpdateScheduled=!0,j.preRender(this.updateProjection,!1,!0))}scheduleCheckAfterUnmount(){j.postRender(()=>{this.isLayoutDirty?this.root.didUpdate():this.root.checkUpdateFailed()})}updateSnapshot(){this.snapshot||!this.instance||(this.snapshot=this.measure(),this.snapshot&&!Vu(this.snapshot.measuredBox.x)&&!Vu(this.snapshot.measuredBox.y)&&(this.snapshot=void 0))}updateLayout(){if(!this.instance||(this.updateScroll(),!(this.options.alwaysMeasureLayout&&this.isLead())&&!this.isLayoutDirty))return;if(this.resumeFrom&&!this.resumeFrom.instance)for(let e=0;e<this.path.length;e++)this.path[e].updateScroll();let e=this.layout;this.layout=this.measure(!1),this.layoutVersion++,this.layoutCorrected||=U(),this.isLayoutDirty=!1,this.projectionDelta=void 0,this.notifyListeners(`measure`,this.layout.layoutBox);let{visualElement:t}=this.options;t&&t.notify(`LayoutMeasure`,this.layout.layoutBox,e?e.layoutBox:void 0)}updateScroll(e=`measure`){let t=!!(this.options.layoutScroll&&this.instance);if(this.scroll&&this.scroll.animationId===this.root.animationId&&this.scroll.phase===e&&(t=!1),t&&this.instance){let t=r(this.instance);this.scroll={animationId:this.root.animationId,phase:e,isRoot:t,offset:n(this.instance),wasRoot:this.scroll?this.scroll.isRoot:t}}}resetTransform(){if(!i)return;let e=this.isLayoutDirty||this.shouldResetTransform||this.options.alwaysMeasureLayout,t=this.projectionDelta&&!td(this.projectionDelta),n=this.getTransformTemplate(),r=n?n(this.latestValues,``):void 0,a=r!==this.prevTransformTemplateValue;e&&this.instance&&(t||J(this.latestValues)||a)&&(i(this.instance,r),this.shouldResetTransform=!1,this.scheduleRender())}measure(e=!0){let t=this.measurePageBox(),n=this.removeElementScroll(t);return e&&(n=this.removeTransform(n)),ef(n),{animationId:this.root.animationId,measuredBox:t,layoutBox:n,latestValues:{},source:this.id}}measurePageBox(){let{visualElement:e}=this.options;if(!e)return U();let t=e.measureViewportBox();if(!(this.scroll?.wasRoot||this.path.some(nf))){let{scroll:e}=this.root;e&&(Yl(t.x,e.offset.x),Yl(t.y,e.offset.y))}return t}removeElementScroll(e){let t=U();if(Fu(t,e),this.scroll?.wasRoot)return t;for(let n=0;n<this.path.length;n++){let r=this.path[n],{scroll:i,options:a}=r;r!==this.root&&i&&a.layoutScroll&&(i.wasRoot&&Fu(t,e),Yl(t.x,i.offset.x),Yl(t.y,i.offset.y))}return t}applyTransform(e,t=!1,n){let r=n||U();Fu(r,e);for(let e=0;e<this.path.length;e++){let n=this.path[e];!t&&n.options.layoutScroll&&n.scroll&&n!==n.root&&(Yl(r.x,-n.scroll.offset.x),Yl(r.y,-n.scroll.offset.y)),J(n.latestValues)&&Ql(r,n.latestValues,n.layout?.layoutBox)}return J(this.latestValues)&&Ql(r,this.latestValues,this.layout?.layoutBox),r}removeTransform(e){let t=U();Fu(t,e);for(let e=0;e<this.path.length;e++){let n=this.path[e];if(!J(n.latestValues))continue;let r;n.instance&&(q(n.latestValues)&&n.updateSnapshot(),r=U(),Fu(r,n.measurePageBox())),$u(t,n.latestValues,n.snapshot?.layoutBox,r)}return J(this.latestValues)&&$u(t,this.latestValues),t}setTargetDelta(e){this.targetDelta=e,this.root.scheduleUpdateProjection(),this.isProjectionDirty=!0}setOptions(e){this.options={...this.options,...e,crossfade:e.crossfade===void 0||e.crossfade}}clearMeasurements(){this.scroll=void 0,this.layout=void 0,this.snapshot=void 0,this.prevTransformTemplateValue=void 0,this.targetDelta=void 0,this.target=void 0,this.isLayoutDirty=!1}forceRelativeParentToResolveTarget(){this.relativeParent&&this.relativeParent.resolvedRelativeTargetAt!==Ri.timestamp&&this.relativeParent.resolveTargetDelta(!0)}resolveTargetDelta(e=!1){let t=this.getLead();this.isProjectionDirty||=t.isProjectionDirty,this.isTransformDirty||=t.isTransformDirty,this.isSharedProjectionDirty||=t.isSharedProjectionDirty;let n=!!this.resumingFrom||this!==t;if(!(e||n&&this.isSharedProjectionDirty||this.isProjectionDirty||this.parent?.isProjectionDirty||this.attemptToResolveRelativeTarget||this.root.updateBlockedByResize))return;let{layout:r,layoutId:i}=this.options;if(!this.layout||!(r||i))return;this.resolvedRelativeTargetAt=Ri.timestamp;let a=this.getClosestProjectingParent();a&&this.linkedParentVersion!==a.layoutVersion&&!a.options.layoutRoot&&this.removeRelativeTarget(),!this.targetDelta&&!this.relativeTarget&&(this.options.layoutAnchor!==!1&&a&&a.layout?this.createRelativeTarget(a,this.layout.layoutBox,a.layout.layoutBox):this.removeRelativeTarget()),!(!this.relativeTarget&&!this.targetDelta)&&(this.target||(this.target=U(),this.targetWithTransforms=U()),this.relativeTarget&&this.relativeTargetOrigin&&this.relativeParent&&this.relativeParent.target?(this.forceRelativeParentToResolveTarget(),X(this.target,this.relativeTarget,this.relativeParent.target,this.options.layoutAnchor||void 0)):this.targetDelta?(this.resumingFrom?this.applyTransform(this.layout.layoutBox,!1,this.target):Fu(this.target,this.layout.layoutBox),Y(this.target,this.targetDelta)):Fu(this.target,this.layout.layoutBox),this.attemptToResolveRelativeTarget&&(this.attemptToResolveRelativeTarget=!1,this.options.layoutAnchor!==!1&&a&&!!a.resumingFrom==!!this.resumingFrom&&!a.options.layoutScroll&&a.target&&this.animationProgress!==1?this.createRelativeTarget(a,this.target,a.target):this.relativeParent=this.relativeTarget=void 0),ml.value&&Td.calculatedTargetDeltas++)}getClosestProjectingParent(){if(!(!this.parent||q(this.parent.latestValues)||Vl(this.parent.latestValues)))return this.parent.isProjecting()?this.parent:this.parent.getClosestProjectingParent()}isProjecting(){return!!((this.relativeTarget||this.targetDelta||this.options.layoutRoot)&&this.layout)}createRelativeTarget(e,t,n){this.relativeParent=e,this.linkedParentVersion=e.layoutVersion,this.forceRelativeParentToResolveTarget(),this.relativeTarget=U(),this.relativeTargetOrigin=U(),qu(this.relativeTargetOrigin,t,n,this.options.layoutAnchor||void 0),Fu(this.relativeTarget,this.relativeTargetOrigin)}removeRelativeTarget(){this.relativeParent=this.relativeTarget=void 0}calcProjection(){let e=this.getLead(),t=!!this.resumingFrom||this!==e,n=!0;if((this.isProjectionDirty||this.parent?.isProjectionDirty)&&(n=!1),t&&(this.isSharedProjectionDirty||this.isTransformDirty)&&(n=!1),this.resolvedRelativeTargetAt===Ri.timestamp&&(n=!1),n)return;let{layout:r,layoutId:i}=this.options;if(this.isTreeAnimating=!!(this.parent&&this.parent.isTreeAnimating||this.currentAnimation||this.pendingAnimation),this.isTreeAnimating||(this.targetDelta=this.relativeTarget=void 0),!this.layout||!(r||i))return;Fu(this.layoutCorrected,this.layout.layoutBox);let a=this.treeScale.x,o=this.treeScale.y;Jl(this.layoutCorrected,this.treeScale,this.path,t),e.layout&&!e.target&&(this.treeScale.x!==1||this.treeScale.y!==1)&&(e.target=e.layout.layoutBox,e.targetWithTransforms=U());let{target:s}=e;if(!s){this.prevProjectionDelta&&(this.createProjectionDeltas(),this.scheduleRender());return}!this.projectionDelta||!this.prevProjectionDelta?this.createProjectionDeltas():(Iu(this.prevProjectionDelta.x,this.projectionDelta.x),Iu(this.prevProjectionDelta.y,this.projectionDelta.y)),Wu(this.projectionDelta,this.layoutCorrected,s,this.latestValues),(this.treeScale.x!==a||this.treeScale.y!==o||!sd(this.projectionDelta.x,this.prevProjectionDelta.x)||!sd(this.projectionDelta.y,this.prevProjectionDelta.y))&&(this.hasProjected=!0,this.scheduleRender(),this.notifyListeners(`projectionUpdate`,s)),ml.value&&Td.calculatedProjections++}hide(){this.isVisible=!1}show(){this.isVisible=!0}scheduleRender(e=!0){if(this.options.visualElement?.scheduleRender(),e){let e=this.getStack();e&&e.scheduleRender()}this.resumingFrom&&!this.resumingFrom.instance&&(this.resumingFrom=void 0)}createProjectionDeltas(){this.prevProjectionDelta=yl(),this.projectionDelta=yl(),this.projectionDeltaWithTransform=yl()}setAnimationOrigin(e,t=!1,n){let r=this.snapshot,i=r?r.latestValues:{},a={...this.latestValues},o=yl();(!this.relativeParent||!this.relativeParent.options.layoutRoot)&&(this.relativeTarget=this.relativeTargetOrigin=void 0),this.attemptToResolveRelativeTarget=!t;let s=U(),c=(r?r.source:void 0)!==(this.layout?this.layout.source:void 0),l=this.getStack(),u=!l||l.members.length<=1,d=!!(c&&!u&&this.options.crossfade===!0&&!this.path.some(Yd));this.animationProgress=0;let f,p=n?.interpolateProjection(e);this.mixTargetDelta=t=>{let n=t/1e3,r=p?.(n);r?(o.x.translate=r.x,o.x.scale=I(e.x.scale,1,n),o.x.origin=e.x.origin,o.x.originPoint=e.x.originPoint,o.y.translate=r.y,o.y.scale=I(e.y.scale,1,n),o.y.origin=e.y.origin,o.y.originPoint=e.y.originPoint):(Kd(o.x,e.x,n),Kd(o.y,e.y,n)),this.setTargetDelta(o),this.relativeTarget&&this.relativeTargetOrigin&&this.layout&&this.relativeParent&&this.relativeParent.layout&&(qu(s,this.layout.layoutBox,this.relativeParent.layout.layoutBox,this.options.layoutAnchor||void 0),Jd(this.relativeTarget,this.relativeTargetOrigin,s,n),f&&rd(this.relativeTarget,f)&&(this.isProjectionDirty=!1),f||=U(),Fu(f,this.relativeTarget)),c&&(this.animationValues=a,pd(a,i,this.latestValues,n,d,u)),r&&r.rotate!==void 0&&(this.animationValues||=a,this.animationValues.pathRotation=r.rotate),this.root.scheduleUpdateProjection(),this.scheduleRender(),this.animationProgress=n},this.mixTargetDelta(this.options.layoutRoot?1e3:0)}startAnimation(e){this.notifyListeners(`animationStart`),this.currentAnimation?.stop(),this.resumingFrom?.currentAnimation?.stop(),this.pendingAnimation&&=(Li(this.pendingAnimation),void 0),this.pendingAnimation=j.update(()=>{wd.hasAnimatedSinceResize=!0,this.motionValue||=Ms(0),this.motionValue.jump(0,!1),this.currentAnimation=vd(this.motionValue,[0,1e3],{...e,velocity:0,isSync:!0,onUpdate:t=>{this.mixTargetDelta(t),e.onUpdate&&e.onUpdate(t)},onComplete:()=>{e.onComplete&&e.onComplete(),this.completeAnimation()}}),this.resumingFrom&&(this.resumingFrom.currentAnimation=this.currentAnimation),this.pendingAnimation=void 0})}completeAnimation(){this.resumingFrom&&(this.resumingFrom.currentAnimation=void 0,this.resumingFrom.preserveOpacity=void 0);let e=this.getStack();e&&e.exitAnimationComplete(),this.resumingFrom=this.currentAnimation=this.animationValues=void 0,this.notifyListeners(`animationComplete`)}finishAnimation(){this.currentAnimation&&(this.mixTargetDelta&&this.mixTargetDelta(Dd),this.currentAnimation.stop()),this.completeAnimation()}applyTransformsToTarget(){let e=this.getLead(),{targetWithTransforms:t,target:n,layout:r,latestValues:i}=e;if(!(!t||!n||!r)){if(this!==e&&this.layout&&r&&tf(this.options.animationType,this.layout.layoutBox,r.layoutBox)){n=this.target||U();let t=Vu(this.layout.layoutBox.x);n.x.min=e.target.x.min,n.x.max=n.x.min+t;let r=Vu(this.layout.layoutBox.y);n.y.min=e.target.y.min,n.y.max=n.y.min+r}Fu(t,n),Ql(t,i),Wu(this.projectionDeltaWithTransform,this.layoutCorrected,t,i)}}registerSharedNode(e,t){this.sharedNodes.has(e)||this.sharedNodes.set(e,new Cd),this.sharedNodes.get(e).add(t);let n=t.options.initialPromotionConfig;t.promote({transition:n?n.transition:void 0,preserveFollowOpacity:n&&n.shouldPreserveFollowOpacity?n.shouldPreserveFollowOpacity(t):void 0})}isLead(){let e=this.getStack();return!e||e.lead===this}getLead(){let{layoutId:e}=this.options;return e&&this.getStack()?.lead||this}getPrevLead(){let{layoutId:e}=this.options;return e?this.getStack()?.prevLead:void 0}getStack(){let{layoutId:e}=this.options;if(e)return this.root.sharedNodes.get(e)}promote({needsReset:e,transition:t,preserveFollowOpacity:n}={}){let r=this.getStack();r&&r.promote(this,n),e&&(this.projectionDelta=void 0,this.needsReset=!0),t&&this.setOptions({transition:t})}relegate(){let e=this.getStack();return e?e.relegate(this):!1}resetSkewAndRotation(){let{visualElement:e}=this.options;if(!e)return;let t=!1,{latestValues:n}=e;if((n.z||n.rotate||n.rotateX||n.rotateY||n.rotateZ||n.skewX||n.skewY)&&(t=!0),!t)return;let r={};n.z&&kd(`z`,e,r,this.animationValues);for(let t=0;t<Ed.length;t++)kd(`rotate${Ed[t]}`,e,r,this.animationValues),kd(`skew${Ed[t]}`,e,r,this.animationValues);e.render();for(let t in r)e.setStaticValue(t,r[t]),this.animationValues&&(this.animationValues[t]=r[t]);e.scheduleRender()}applyProjectionStyles(e,t){if(!this.instance||this.isSVG)return;if(!this.isVisible){e.visibility=`hidden`;return}let n=this.getTransformTemplate();if(this.needsReset){this.needsReset=!1,e.visibility=``,e.opacity=``,e.pointerEvents=Sd(t?.pointerEvents)||``,e.transform=n?n(this.latestValues,``):`none`;return}let r=this.getLead();if(!this.projectionDelta||!this.layout||!r.target){this.options.layoutId&&(e.opacity=this.latestValues.opacity===void 0?1:this.latestValues.opacity,e.pointerEvents=Sd(t?.pointerEvents)||``),this.hasProjected&&!J(this.latestValues)&&(e.transform=n?n({},``):`none`,this.hasProjected=!1);return}e.visibility=``;let i=r.animationValues||r.latestValues;this.applyTransformsToTarget();let a=ld(this.projectionDeltaWithTransform,this.treeScale,i);n&&(a=n(i,a)),e.transform=a;let{x:o,y:s}=this.projectionDelta;e.transformOrigin=`${o.origin*100}% ${s.origin*100}% 0`,e.opacity=r.animationValues?r===this?i.opacity??this.latestValues.opacity??1:this.preserveOpacity?this.latestValues.opacity:i.opacityExit:r===this?i.opacity===void 0?``:i.opacity:i.opacityExit===void 0?0:i.opacityExit;for(let t in lu){if(i[t]===void 0)continue;let{correct:n,applyTo:o,isCSSVariable:s}=lu[t],c=a===`none`?i[t]:n(i[t],r);if(o){let t=o.length;for(let n=0;n<t;n++)e[o[n]]=c}else s?this.options.visualElement.renderState.vars[t]=c:e[t]=c}this.options.layoutId&&(e.pointerEvents=r===this?Sd(t?.pointerEvents)||``:`none`)}clearSnapshot(){this.resumeFrom=this.snapshot=void 0}resetTree(){this.root.nodes.forEach(e=>e.currentAnimation?.stop()),this.root.nodes.forEach(Id),this.root.sharedNodes.clear()}}}function Md(e){e.updateLayout()}function Nd(e){let t=e.resumeFrom?.snapshot||e.snapshot;if(e.isLead()&&e.layout&&t&&e.hasListeners(`didUpdate`)){let{layoutBox:n,measuredBox:r}=e.layout,{animationType:i}=e.options,a=t.source!==e.layout.source;if(i===`size`)cd(e=>{let r=a?t.measuredBox[e]:t.layoutBox[e],i=Vu(r);r.min=n[e].min,r.max=r.min+i});else if(i===`x`||i===`y`){let e=i===`x`?`y`:`x`;Pu(a?t.measuredBox[e]:t.layoutBox[e],n[e])}else tf(i,t.layoutBox,n)&&cd(r=>{let i=a?t.measuredBox[r]:t.layoutBox[r],o=Vu(n[r]);i.max=i.min+o,e.relativeTarget&&!e.currentAnimation&&(e.isProjectionDirty=!0,e.relativeTarget[r].max=e.relativeTarget[r].min+o)});let o=yl();Wu(o,n,t.layoutBox);let s=yl();a?Wu(s,e.applyTransform(r,!0),t.measuredBox):Wu(s,n,t.layoutBox);let c=!td(o),l=!1;if(!e.resumeFrom){let r=e.getClosestProjectingParent();if(r&&!r.resumeFrom){let{snapshot:i,layout:a}=r;if(i&&a){let o=e.options.layoutAnchor||void 0,s=U();qu(s,t.layoutBox,i.layoutBox,o);let c=U();qu(c,n,a.layoutBox,o),ad(s,c)||(l=!0),r.options.layoutRoot&&(e.relativeTarget=c,e.relativeTargetOrigin=s,e.relativeParent=r)}}}e.notifyListeners(`didUpdate`,{layout:n,snapshot:t,delta:s,layoutDelta:o,hasLayoutChanged:c,hasRelativeLayoutChanged:l})}else if(e.isLead()){let{onExitComplete:t}=e.options;t&&t()}e.options.transition=void 0}function Q(e){ml.value&&Td.nodes++,e.parent&&(e.isProjecting()||(e.isProjectionDirty=e.parent.isProjectionDirty),e.isSharedProjectionDirty||=!!(e.isProjectionDirty||e.parent.isProjectionDirty||e.parent.isSharedProjectionDirty),e.isTransformDirty||=e.parent.isTransformDirty)}function Pd(e){e.isProjectionDirty=e.isSharedProjectionDirty=e.isTransformDirty=!1}function Fd(e){e.clearSnapshot()}function Id(e){e.clearMeasurements()}function Ld(e){e.isLayoutDirty=!0,e.updateLayout()}function Rd(e){e.isLayoutDirty=!1}function zd(e){e.isAnimationBlocked&&e.layout&&!e.isLayoutDirty&&(e.snapshot=e.layout,e.isLayoutDirty=!0)}function Bd(e){let{visualElement:t}=e.options;t&&t.getProps().onBeforeLayoutMeasure&&t.notify(`BeforeLayoutMeasure`),e.resetTransform()}function Vd(e){e.finishAnimation(),e.targetDelta=e.relativeTarget=e.target=void 0,e.isProjectionDirty=!0}function Hd(e){e.resolveTargetDelta()}function Ud(e){e.calcProjection()}function Wd(e){e.resetSkewAndRotation()}function Gd(e){e.removeLeadSnapshot()}function Kd(e,t,n){e.translate=I(t.translate,0,n),e.scale=I(t.scale,1,n),e.origin=t.origin,e.originPoint=t.originPoint}function qd(e,t,n,r){e.min=I(t.min,n.min,r),e.max=I(t.max,n.max,r)}function Jd(e,t,n,r){qd(e.x,t.x,n.x,r),qd(e.y,t.y,n.y,r)}function Yd(e){return e.animationValues&&e.animationValues.opacityExit!==void 0}var Xd={duration:.45,ease:[.4,0,.1,1]},Zd=e=>typeof navigator<`u`&&navigator.userAgent&&navigator.userAgent.toLowerCase().includes(e),Qd=Zd(`applewebkit/`)&&!Zd(`chrome/`)?Math.round:ii;function $d(e){e.min=Qd(e.min),e.max=Qd(e.max)}function ef(e){$d(e.x),$d(e.y)}function tf(e,t,n){return e===`position`||e===`preserve-aspect`&&!Hu(od(t),od(n),.2)}function nf(e){return e!==e.root&&e.scroll?.wasRoot}var rf=jd({attachResizeListener:(e,t)=>yd(e,`resize`,t),measureScroll:()=>({x:document.documentElement.scrollLeft||document.body?.scrollLeft||0,y:document.documentElement.scrollTop||document.body?.scrollTop||0}),checkIsScrollRoot:()=>!0}),af={current:void 0},of=jd({measureScroll:e=>({x:e.scrollLeft,y:e.scrollTop}),defaultParent:()=>{if(!af.current){let e=new rf({});e.mount(window),e.setOptions({layoutScroll:!0}),af.current=e}return af.current},resetTransform:(e,t)=>{e.style.transform=t===void 0?`none`:t},checkIsScrollRoot:e=>window.getComputedStyle(e).position===`fixed`}),sf=(0,x.createContext)({transformPagePoint:e=>e,isStatic:!1,reducedMotion:`never`});function cf(e,t){if(typeof e==`function`)return e(t);e!=null&&(e.current=t)}function lf(...e){return t=>{let n=!1,r=e.map(e=>{let r=cf(e,t);return!n&&typeof r==`function`&&(n=!0),r});if(n)return()=>{for(let t=0;t<r.length;t++){let n=r[t];typeof n==`function`?n():cf(e[t],null)}}}}function uf(...e){return x.useCallback(lf(...e),e)}var df=class extends x.Component{getSnapshotBeforeUpdate(e){let t=this.props.childRef.current;if(Nc(t)&&e.isPresent&&!this.props.isPresent&&this.props.pop!==!1){let e=t.offsetParent,n=Nc(e)&&e.offsetWidth||0,r=Nc(e)&&e.offsetHeight||0,i=getComputedStyle(t),a=this.props.sizeRef.current;a.height=parseFloat(i.height),a.width=parseFloat(i.width),a.top=t.offsetTop,a.left=t.offsetLeft,a.right=n-a.width-a.left,a.bottom=r-a.height-a.top,a.direction=i.direction}return null}componentDidUpdate(){}render(){return this.props.children}};function ff({children:e,isPresent:t,anchorX:n,anchorY:r,root:i,pop:a}){let o=(0,x.useId)(),s=(0,x.useRef)(null),c=(0,x.useRef)({width:0,height:0,top:0,left:0,right:0,bottom:0,direction:`ltr`}),{nonce:l}=(0,x.useContext)(sf),u=uf(s,a===!1?void 0:e.props?.ref??e?.ref);return(0,x.useInsertionEffect)(()=>{let{width:e,height:u,top:d,left:f,right:p,bottom:m,direction:h}=c.current;if(t||a===!1||!s.current||!e||!u)return;let g=h===`rtl`,_=n===`left`?g?`right: ${p}`:`left: ${f}`:g?`left: ${f}`:`right: ${p}`,v=r===`bottom`?`bottom: ${m}`:`top: ${d}`;s.current.dataset.motionPopId=o;let y=document.createElement(`style`);l&&(y.nonce=l);let b=i??document.head;return b.appendChild(y),y.sheet&&y.sheet.insertRule(`
        ...
        `),()=>{s.current?.removeAttribute(`data-motion-pop-id`),b.contains(y)&&b.removeChild(y)}},[t]),(0,A.jsx)(df,{isPresent:t,childRef:s,sizeRef:c,pop:a,children:a===!1?e:x.cloneElement(e,{ref:u})})}var pf=({children:e,initial:t,isPresent:n,onExitComplete:r,custom:i,presenceAffectsLayout:a,mode:o,anchorX:s,anchorY:c,root:l})=>{let u=qr(mf),d=(0,x.useId)(),f=(0,x.useRef)(n),p=(0,x.useRef)(r);Jr(()=>{f.current=n,p.current=r});let m=!0,h=(0,x.useMemo)(()=>(m=!1,{id:d,initial:t,isPresent:n,custom:i,onExitComplete:e=>{u.set(e,!0);for(let e of u.values())if(!e)return;r&&r()},register:e=>(u.set(e,!1),()=>{u.delete(e),!f.current&&!u.size&&p.current?.()})}),[n,u,r]);return a&&m&&(h={...h}),(0,x.useMemo)(()=>{u.forEach((e,t)=>u.set(t,!1))},[n]),x.useEffect(()=>{!n&&!u.size&&r&&r()},[n]),e=(0,A.jsx)(ff,{pop:o===`popLayout`,isPresent:n,anchorX:s,anchorY:c,root:l,children:e}),(0,A.jsx)(Yr.Provider,{value:h,children:e})};function mf(){return new Map}function hf(e=!0){let t=(0,x.useContext)(Yr);if(t===null)return[!0,null];let{isPresent:n,onExitComplete:r,register:i}=t,a=(0,x.useId)();(0,x.useEffect)(()=>{if(e)return i(a)},[e]);let o=(0,x.useCallback)(()=>e&&r&&r(a),[a,r,e]);return!n&&r?[!1,o]:[!0]}var gf=e=>e.key||``;function _f(e){let t=[];return x.Children.forEach(e,e=>{(0,x.isValidElement)(e)&&t.push(e)}),t}var vf=({children:e,custom:t,initial:n=!0,onExitComplete:r,presenceAffectsLayout:i=!0,mode:a=`sync`,propagate:o=!1,anchorX:s=`left`,anchorY:c=`top`,root:l})=>{let[u,d]=hf(o),f=(0,x.useMemo)(()=>_f(e),[e]),p=o&&!u?[]:f.map(gf),m=(0,x.useRef)(!0),h=(0,x.useRef)(f),g=qr(()=>new Map),_=(0,x.useRef)(new Set),[v,y]=(0,x.useState)(f),[b,S]=(0,x.useState)(f);Jr(()=>{o&&!u&&!b.length&&d?.()},[u,o,b.length,d]),Jr(()=>{m.current=!1,h.current=f;for(let e=0;e<b.length;e++){let t=gf(b[e]);p.includes(t)?(g.delete(t),_.current.delete(t)):g.get(t)!==!0&&g.set(t,!1)}},[b,p.length,p.join(`-`)]);let C=[];if(f!==v){let e=[...f];for(let t=0;t<b.length;t++){let n=b[t],r=gf(n);p.includes(r)||(e.splice(t,0,n),C.push(n))}return a===`wait`&&C.length&&(e=C),S(_f(e)),y(f),null}let{forceRender:w}=(0,x.useContext)(Kr);return(0,A.jsx)(A.Fragment,{children:b.map(e=>{let v=gf(e),y=o&&!u?!1:f===b||p.includes(v);return(0,A.jsx)(pf,{isPresent:y,initial:!m.current||n?void 0:!1,custom:t,presenceAffectsLayout:i,mode:a,root:l,onExitComplete:y?void 0:()=>{if(_.current.has(v))return;if(g.has(v))_.current.add(v),g.set(v,!0);else return;let e=!0;g.forEach(t=>{t||(e=!1)}),e&&(w?.(),S(h.current),o&&d?.(),r&&r())},anchorX:s,anchorY:c,children:e},v)})})},yf=(0,x.createContext)({strict:!1}),bf={animation:[`animate`,`variants`,`whileHover`,`whileTap`,`exit`,`whileInView`,`whileFocus`,`whileDrag`],exit:[`exit`],drag:[`drag`,`dragControls`],focus:[`whileFocus`],hover:[`whileHover`,`onHoverStart`,`onHoverEnd`],tap:[`whileTap`,`onTap`,`onTapStart`,`onTapCancel`],pan:[`onPan`,`onPanStart`,`onPanSessionStart`,`onPanEnd`],inView:[`whileInView`,`onViewportEnter`,`onViewportLeave`],layout:[`layout`,`layoutId`]},xf=!1;function Sf(){if(xf)return;let e={};for(let t in bf)e[t]={isEnabled:e=>bf[t].some(t=>!!e[t])};Fl(e),xf=!0}function Cf(){return Sf(),Il()}function wf(e){let t=Cf();for(let n in e)t[n]={...t[n],...e[n]};Fl(t)}var Tf=(0,x.createContext)({});function Ef(e,t){if(El(e)){let{initial:t,animate:n}=e;return{initial:t===!1||Cl(t)?t:void 0,animate:Cl(n)?n:void 0}}return e.inherit===!1?{}:t}function Df(e){let{initial:t,animate:n}=Ef(e,(0,x.useContext)(Tf));return(0,x.useMemo)(()=>({initial:t,animate:n}),[Of(t),Of(n)])}function Of(e){return Array.isArray(e)?e.join(` `):e}var kf=()=>({style:{},transform:{},transformOrigin:{},vars:{}});function Af(e,t,n){for(let r in t)!ec(t[r])&&!uu(r,n)&&(e[r]=t[r])}function jf({transformTemplate:e},t){return(0,x.useMemo)(()=>{let n=kf();return iu(n,t,e),Object.assign({},n.vars,n.style)},[t])}function Mf(e,t){let n=e.style||{},r={};return Af(r,n,e),Object.assign(r,jf(e,t)),r}function Nf(e,t){let n={},r=Mf(e,t);return e.drag&&e.dragListener!==!1&&(n.draggable=!1,r.userSelect=r.WebkitUserSelect=r.WebkitTouchCallout=`none`,r.touchAction=e.drag===!0?`none`:`pan-${e.drag===`x`?`y`:`x`}`),e.tabIndex===void 0&&(e.onTap||e.onTapStart||e.whileTap)&&(n.tabIndex=0),n.style=r,n}var Pf=()=>({...kf(),attrs:{}});function Ff(e,t,n,r){let i=(0,x.useMemo)(()=>{let n=Pf();return vu(n,t,bu(r),e.transformTemplate,e.style),{...n.attrs,style:{...n.style}}},[t]);if(e.style){let t={};Af(t,e.style,e),i.style={...t,...i.style}}return i}var If=new Set(`animate.exit.variants.initial.style.values.variants.transition.transformTemplate.custom.inherit.onBeforeLayoutMeasure.onAnimationStart.onAnimationComplete.onUpdate.onDragStart.onDrag.onDragEnd.onMeasureDragConstraints.onDirectionLock.onDragTransitionEnd._dragX._dragY.onHoverStart.onHoverEnd.onViewportEnter.onViewportLeave.globalTapTarget.propagate.ignoreStrict.viewport`.split(`.`));function Lf(e){return e.startsWith(`while`)||e.startsWith(`drag`)&&e!==`draggable`||e.startsWith(`layout`)||e.startsWith(`onTap`)||e.startsWith(`onPan`)||e.startsWith(`onLayout`)||If.has(e)}function Rf(e,t){return e.startsWith(`on`)?!Lf(e):t?.(e)??!Lf(e)}function zf(e,t,n,r){let i={};for(let a in e)(a!==`values`||typeof e.values!=`object`)&&(ec(e[a])||(Rf(a,r)||n===!0&&Lf(a)||!t&&!Lf(a)||e.draggable&&a.startsWith(`onDrag`))&&(i[a]=e[a]));return i}var Bf=[`animate`,`circle`,`defs`,`desc`,`ellipse`,`g`,`image`,`line`,`filter`,`marker`,`mask`,`metadata`,`path`,`pattern`,`polygon`,`polyline`,`rect`,`stop`,`switch`,`symbol`,`svg`,`text`,`tspan`,`use`,`view`];function Vf(e){return typeof e!=`string`||e.includes(`-`)?!1:!!(Bf.indexOf(e)>-1||/[A-Z]/u.test(e))}function Hf(e,t,n,{latestValues:r},i,a=!1,o,s){let c=(o??Vf(e)?Ff:Nf)(t,r,i,e),l=zf(t,typeof e==`string`,a,s),u=e===x.Fragment?{}:{...l,...c,ref:n},{children:d}=t,f=(0,x.useMemo)(()=>ec(d)?d.get():d,[d]);return(0,x.createElement)(e,{...u,children:f})}function Uf({scrapeMotionValuesFromProps:e,createRenderState:t},n,r,i){return{latestValues:Wf(n,r,i,e),renderState:t()}}function Wf(e,t,n,r){let i={},a=r(e,{});for(let e in a)i[e]=Sd(a[e]);let{initial:o,animate:s}=e,c=El(e),l=Dl(e);t&&l&&!c&&e.inherit!==!1&&(o===void 0&&(o=t.initial),s===void 0&&(s=t.animate));let u=n?n.initial===!1:!1;u||=o===!1;let d=u?s:o;if(d&&typeof d!=`boolean`&&!Sl(d)){let t=Array.isArray(d)?d:[d];for(let n=0;n<t.length;n++){let r=qs(e,t[n]);if(r){let{transitionEnd:e,transition:t,...n}=r;for(let e in n){let t=n[e];if(Array.isArray(t)){let e=u?t.length-1:0;t=t[e]}t!==null&&(i[e]=t)}for(let t in e)i[t]=e[t]}}}return i}var Gf=e=>(t,n)=>{let r=(0,x.useContext)(Tf),i=(0,x.useContext)(Yr),a=()=>Uf(e,t,r,i);return n?a():qr(a)},Kf=Gf({scrapeMotionValuesFromProps:du,createRenderState:kf}),qf=Gf({scrapeMotionValuesFromProps:Su,createRenderState:Pf}),Jf=Symbol.for(`motionComponentSymbol`);function Yf(e,t,n){let r=(0,x.useRef)(n);(0,x.useInsertionEffect)(()=>{r.current=n});let i=(0,x.useRef)(null);return(0,x.useCallback)(n=>{n&&e.onMount?.(n),t&&(n?t.mount(n):t.unmount());let a=r.current;if(typeof a==`function`){if(n){let e=a(n);typeof e==`function`&&(i.current=e)}else i.current?(i.current(),i.current=null):a(n)}else a&&(a.current=n)},[t])}var Xf=(0,x.createContext)({});function Zf(e){return e&&typeof e==`object`&&Object.prototype.hasOwnProperty.call(e,`current`)}function Qf(e,t,n,r,i,a){let{visualElement:o}=(0,x.useContext)(Tf),s=(0,x.useContext)(yf),c=(0,x.useContext)(Yr),l=(0,x.useContext)(sf),u=l.reducedMotion,d=l.skipAnimations,f=(0,x.useRef)(null),p=(0,x.useRef)(!1);r||=s.renderer,!f.current&&r&&(f.current=r(e,{visualState:t,parent:o,props:n,presenceContext:c,blockInitialAnimation:c?c.initial===!1:!1,reducedMotionConfig:u,skipAnimations:d,isSVG:a}),p.current&&f.current&&(f.current.manuallyAnimateOnMount=!0));let m=f.current,h=(0,x.useContext)(Xf);m&&!m.projection&&i&&(m.type===`html`||m.type===`svg`)&&$f(f.current,n,i,h);let g=(0,x.useRef)(!1);(0,x.useInsertionEffect)(()=>{m&&g.current&&m.update(n,c)});let _=n[ic],v=(0,x.useRef)(!!_&&typeof window<`u`&&!window.MotionHandoffIsComplete?.(_)&&window.MotionHasOptimisedAnimation?.(_));return Jr(()=>{p.current=!0,m&&(g.current=!0,window.MotionIsMounted=!0,m.updateFeatures(),m.scheduleRenderMicrotask(),v.current&&m.animationState&&m.animationState.animateChanges())}),(0,x.useEffect)(()=>{m&&(!v.current&&m.animationState&&m.animationState.animateChanges(),v.current&&=(queueMicrotask(()=>{window.MotionHandoffMarkAsComplete?.(_)}),!1),m.enteringChildren=void 0)}),m}function $f(e,t,n,r){let{layoutId:i,layout:a,drag:o,dragConstraints:s,layoutScroll:c,layoutRoot:l,layoutAnchor:u,layoutCrossfade:d}=t;e.projection=new n(e.latestValues,t[`data-framer-portal-id`]?void 0:ep(e.parent)),e.projection.setOptions({layoutId:i,layout:a,alwaysMeasureLayout:!!o||s&&Zf(s),visualElement:e,animationType:typeof a==`string`?a:`both`,initialPromotionConfig:r,crossfade:d,layoutScroll:c,layoutRoot:l,layoutAnchor:u})}function ep(e){if(e)return e.options.allowProjection===!1?ep(e.parent):e.projection}function tp(e,{forwardMotionProps:t=!1,type:n}={},r,i){r&&wf(r);let a=n?n===`svg`:Vf(e),o=a?qf:Kf;function s(n,s){let c,l={...(0,x.useContext)(sf),...n,layoutId:np(n)},{isStatic:u,isValidProp:d}=l,f=Df(n),p=o(n,u);if(!u&&typeof window<`u`){rp(l,r);let t=ip(l);c=t.MeasureLayout,f.visualElement=Qf(e,p,l,i,t.ProjectionNode,a)}return(0,A.jsxs)(Tf.Provider,{value:f,children:[c&&f.visualElement?(0,A.jsx)(c,{visualElement:f.visualElement,...l}):null,Hf(e,n,Yf(p,f.visualElement,s),p,u,t,a,d)]})}s.displayName=`motion.${typeof e==`string`?e:`create(${e.displayName??e.name??``})`}`;let c=(0,x.forwardRef)(s);return c[Jf]=e,c}function np({layoutId:e}){let t=(0,x.useContext)(Kr).id;return t&&e!==void 0?t+`-`+e:e}function rp(e,t){(0,x.useContext)(yf).strict}function ip(e){let{drag:t,layout:n}=Cf();if(!t&&!n)return{};let r={...t,...n};return{MeasureLayout:t?.isEnabled(e)||n?.isEnabled(e)?r.MeasureLayout:void 0,ProjectionNode:r.ProjectionNode}}function ap(e,t){if(typeof Proxy>`u`)return tp;let n=new Map,r=(n,r)=>tp(n,r,e,t);return new Proxy((e,t)=>r(e,t),{get:(i,a)=>a===`create`?r:(n.has(a)||n.set(a,tp(a,void 0,e,t)),n.get(a))})}var op=(e,t)=>t.isSVG??Vf(e)?new Cu(t):new pu(t,{allowProjection:e!==x.Fragment}),sp=class extends zl{constructor(e){super(e),e.animationState||=Au(e)}updateAnimationControlsSubscription(){let{animate:e}=this.node.getProps();Sl(e)&&(this.unmountControls=e.subscribe(this.node))}mount(){this.updateAnimationControlsSubscription()}update(){let{animate:e}=this.node.getProps(),{animate:t}=this.node.prevProps||{};e!==t&&this.updateAnimationControlsSubscription()}unmount(){this.node.animationState.reset(),this.unmountControls?.()}},cp=0,lp={animation:{Feature:sp},exit:{Feature:class extends zl{constructor(){super(...arguments),this.id=cp++,this.isExitComplete=!1}update(){if(!this.node.presenceContext)return;let{isPresent:e,onExitComplete:t}=this.node.presenceContext,{isPresent:n}=this.node.prevPresenceContext||{};if(!this.node.animationState||e===n)return;if(e&&n===!1){if(this.isExitComplete){let{initial:e,custom:t}=this.node.getProps();if(typeof e==`string`||typeof e==`object`&&e&&!Array.isArray(e)){let n=Js(this.node,e,t);if(n){let{transition:e,transitionEnd:t,...r}=n;for(let e in r)this.node.getValue(e)?.jump(r[e])}}this.node.animationState.reset(),this.node.animationState.animateChanges()}else this.node.animationState.setActive(`exit`,!1);this.isExitComplete=!1;return}let r=this.node.animationState.setActive(`exit`,!e);t&&!e&&r.then(()=>{this.isExitComplete=!0,t(this.id)})}mount(){let{register:e,onExitComplete:t}=this.node.presenceContext||{};t&&t(this.id),e&&(this.unmount=e(this.id))}unmount(){}}}};function up(e){return{point:{x:e.pageX,y:e.pageY}}}var dp=e=>t=>Hc(t)&&e(t,up(t));function fp(e,t,n,r){return yd(e,t,dp(n),r)}var pp=({current:e})=>e?e.ownerDocument.defaultView:null,mp=(e,t)=>Math.abs(e-t);function hp(e,t){let n=mp(e.x,t.x),r=mp(e.y,t.y);return Math.sqrt(n**2+r**2)}var gp=new Set([`auto`,`scroll`]),_p=class{constructor(e,t,{transformPagePoint:n,contextWindow:r=window,dragSnapToOrigin:i=!1,distanceThreshold:a=3,element:o}={}){if(this.startEvent=null,this.lastMoveEvent=null,this.lastMoveEventInfo=null,this.lastRawMoveEventInfo=null,this.handlers={},this.contextWindow=window,this.scrollPositions=new Map,this.removeScrollListeners=null,this.onElementScroll=e=>{this.handleScroll(e.target)},this.onWindowScroll=()=>{this.handleScroll(window)},this.updatePoint=()=>{if(!(this.lastMoveEvent&&this.lastMoveEventInfo))return;this.lastRawMoveEventInfo&&(this.lastMoveEventInfo=vp(this.lastRawMoveEventInfo,this.transformPagePoint));let e=bp(this.lastMoveEventInfo,this.history),t=this.startEvent!==null,n=hp(e.offset,{x:0,y:0})>=this.distanceThreshold;if(!t&&!n)return;let{point:r}=e,{timestamp:i}=Ri;this.history.push({...r,timestamp:i});let{onStart:a,onMove:o}=this.handlers;t||(a&&a(this.lastMoveEvent,e),this.startEvent=this.lastMoveEvent),o&&o(this.lastMoveEvent,e)},this.handlePointerMove=(e,t)=>{this.lastMoveEvent=e,this.lastRawMoveEventInfo=t,this.lastMoveEventInfo=vp(t,this.transformPagePoint),j.update(this.updatePoint,!0)},this.handlePointerUp=(e,t)=>{this.end();let{onEnd:n,onSessionEnd:r,resumeAnimation:i}=this.handlers;if((this.dragSnapToOrigin||!this.startEvent)&&i&&i(),!(this.lastMoveEvent&&this.lastMoveEventInfo))return;let a=bp(e.type===`pointercancel`?this.lastMoveEventInfo:vp(t,this.transformPagePoint),this.history);this.startEvent&&n&&n(e,a),r&&r(e,a)},!Hc(e))return;this.dragSnapToOrigin=i,this.handlers=t,this.transformPagePoint=n,this.distanceThreshold=a,this.contextWindow=r||window;let s=vp(up(e),this.transformPagePoint),{point:c}=s,{timestamp:l}=Ri;this.history=[{...c,timestamp:l}];let{onSessionStart:u}=t;u&&u(e,bp(s,this.history));let d={passive:!0,capture:!0};this.removeListeners=ai(fp(this.contextWindow,`pointermove`,this.handlePointerMove,d),fp(this.contextWindow,`pointerup`,this.handlePointerUp,d),fp(this.contextWindow,`pointercancel`,this.handlePointerUp,d)),o&&this.startScrollTracking(o)}startScrollTracking(e){let t=e.parentElement;for(;t;){let e=getComputedStyle(t);(gp.has(e.overflowX)||gp.has(e.overflowY))&&this.scrollPositions.set(t,{x:t.scrollLeft,y:t.scrollTop}),t=t.parentElement}this.scrollPositions.set(window,{x:window.scrollX,y:window.scrollY}),window.addEventListener(`scroll`,this.onElementScroll,{capture:!0}),window.addEventListener(`scroll`,this.onWindowScroll),this.removeScrollListeners=()=>{window.removeEventListener(`scroll`,this.onElementScroll,{capture:!0}),window.removeEventListener(`scroll`,this.onWindowScroll)}}handleScroll(e){let t=this.scrollPositions.get(e);if(!t)return;let n=e===window,r=n?{x:window.scrollX,y:window.scrollY}:{x:e.scrollLeft,y:e.scrollTop},i={x:r.x-t.x,y:r.y-t.y};(i.x!==0||i.y!==0)&&(n?this.lastMoveEventInfo&&(this.lastMoveEventInfo.point.x+=i.x,this.lastMoveEventInfo.point.y+=i.y):this.history.length>0&&(this.history[0].x-=i.x,this.history[0].y-=i.y),this.scrollPositions.set(e,r),j.update(this.updatePoint,!0))}updateHandlers(e){this.handlers=e}end(){this.removeListeners&&this.removeListeners(),this.removeScrollListeners&&this.removeScrollListeners(),this.scrollPositions.clear(),Li(this.updatePoint)}};function vp(e,t){return t?{point:t(e.point)}:e}function yp(e,t){return{x:e.x-t.x,y:e.y-t.y}}function bp({point:e},t){return{point:e,delta:yp(e,Sp(t)),offset:yp(e,xp(t)),velocity:Cp(t,.1)}}function xp(e){return e[0]}function Sp(e){return e[e.length-1]}function Cp(e,t){if(e.length<2)return{x:0,y:0};let n=e.length-1,r=null,i=Sp(e);for(;n>=0&&(r=e[n],!(i.timestamp-r.timestamp>ci(t)));)n--;if(!r)return{x:0,y:0};r===e[0]&&e.length>2&&i.timestamp-r.timestamp>ci(t)*2&&(r=e[1]);let a=li(i.timestamp-r.timestamp);if(a===0)return{x:0,y:0};let o={x:(i.x-r.x)/a,y:(i.y-r.y)/a};return o.x===1/0&&(o.x=0),o.y===1/0&&(o.y=0),o}function wp(e,{min:t,max:n},r){return t!==void 0&&e<t?e=r?I(t,e,r.min):Math.max(e,t):n!==void 0&&e>n&&(e=r?I(n,e,r.max):Math.min(e,n)),e}function Tp(e,t,n){return{min:t===void 0?void 0:e.min+t,max:n===void 0?void 0:e.max+n-(e.max-e.min)}}function Ep(e,{top:t,left:n,bottom:r,right:i}){return{x:Tp(e.x,n,i),y:Tp(e.y,t,r)}}function Dp(e,t){let n=t.min-e.min,r=t.max-e.max;return t.max-t.min<e.max-e.min&&([n,r]=[r,n]),{min:n,max:r}}function Op(e,t){return{x:Dp(e.x,t.x),y:Dp(e.y,t.y)}}function kp(e,t){let n=.5,r=Vu(e),i=Vu(t);return i>r?n=oi(t.min,t.max-r,e.min):r>i&&(n=oi(e.min,e.max-i,t.min)),Qr(0,1,n)}function Ap(e,t){let n={};return t.min!==void 0&&(n.min=t.min-e.min),t.max!==void 0&&(n.max=t.max-e.min),n}var jp=.35;function Mp(e=jp){return e===!1?e=0:e===!0&&(e=jp),{x:Np(e,`left`,`right`),y:Np(e,`top`,`bottom`)}}function Np(e,t,n){return{min:Pp(e,t),max:Pp(e,n)}}function Pp(e,t){return typeof e==`number`?e:e[t]||0}var Fp=new WeakMap,Ip=class{constructor(e){this.openDragLock=null,this.isDragging=!1,this.currentDirection=null,this.originPoint={x:0,y:0},this.constraints=!1,this.hasMutatedConstraints=!1,this.elastic=U(),this.latestPointerEvent=null,this.latestPanInfo=null,this.visualElement=e}start(e,{snapToCursor:t=!1,distanceThreshold:n}={}){let{presenceContext:r}=this.visualElement;if(r&&r.isPresent===!1)return;let i=e=>{t&&this.snapToCursor(up(e).point),this.stopAnimation()},a=(e,t)=>{let{drag:n,dragPropagation:r,onDragStart:i}=this.getProps();if(n&&!r&&(this.openDragLock&&this.openDragLock(),this.openDragLock=Rc(n),!this.openDragLock))return;this.latestPointerEvent=e,this.latestPanInfo=t,this.isDragging=!0,this.currentDirection=null,this.resolveConstraints(),this.visualElement.projection&&(this.visualElement.projection.isAnimationBlocked=!0,this.visualElement.projection.target=void 0),cd(e=>{let t=this.getAxisMotionValue(e).get()||0;if(la.test(t)){let{projection:n}=this.visualElement;if(n&&n.layout){let r=n.layout.layoutBox[e];r&&(t=Vu(r)*(parseFloat(t)/100))}}this.originPoint[e]=t}),i&&j.update(()=>i(e,t),!1,!0),nc(this.visualElement,`transform`);let{animationState:a}=this.visualElement;a&&a.setActive(`whileDrag`,!0)},o=(e,t)=>{this.latestPointerEvent=e,this.latestPanInfo=t;let{dragPropagation:n,dragDirectionLock:r,onDirectionLock:i,onDrag:a}=this.getProps();if(!n&&!this.openDragLock)return;let{offset:o}=t;if(r&&this.currentDirection===null){this.currentDirection=Bp(o),this.currentDirection!==null&&i&&i(this.currentDirection);return}this.updateAxis(`x`,t.point,o),this.updateAxis(`y`,t.point,o),this.visualElement.render(),a&&j.update(()=>a(e,t),!1,!0)},s=(e,t)=>{this.latestPointerEvent=e,this.latestPanInfo=t,this.stop(e,t),this.latestPointerEvent=null,this.latestPanInfo=null},c=()=>{let{dragSnapToOrigin:e}=this.getProps();(e||this.constraints)&&this.startAnimation({x:0,y:0})},{dragSnapToOrigin:l}=this.getProps();this.panSession=new _p(e,{onSessionStart:i,onStart:a,onMove:o,onSessionEnd:s,resumeAnimation:c},{transformPagePoint:this.visualElement.getTransformPagePoint(),dragSnapToOrigin:l,distanceThreshold:n,contextWindow:pp(this.visualElement),element:this.visualElement.current})}stop(e,t){let n=e||this.latestPointerEvent,r=t||this.latestPanInfo,i=this.isDragging;if(this.cancel(),!i||!r||!n)return;let{velocity:a}=r;this.startAnimation(a);let{onDragEnd:o}=this.getProps();o&&j.postRender(()=>o(n,r))}cancel(){this.isDragging=!1;let{projection:e,animationState:t}=this.visualElement;e&&(e.isAnimationBlocked=!1),this.endPanSession();let{dragPropagation:n}=this.getProps();!n&&this.openDragLock&&(this.openDragLock(),this.openDragLock=null),t&&t.setActive(`whileDrag`,!1)}endPanSession(){this.panSession&&this.panSession.end(),this.panSession=void 0}updateAxis(e,t,n){let{drag:r}=this.getProps();if(!n||!zp(e,r,this.currentDirection))return;let i=this.getAxisMotionValue(e),a=this.originPoint[e]+n[e];this.constraints&&this.constraints[e]&&(a=wp(a,this.constraints[e],this.elastic[e])),i.set(a)}resolveConstraints(){let{dragConstraints:e,dragElastic:t}=this.getProps(),n=this.visualElement.projection&&!this.visualElement.projection.layout?this.visualElement.projection.measure(!1):this.visualElement.projection?.layout,r=this.constraints;e&&Zf(e)?this.constraints||=this.resolveRefConstraints():this.constraints=e&&n?Ep(n.layoutBox,e):!1,this.elastic=Mp(t),r!==this.constraints&&!Zf(e)&&n&&this.constraints&&!this.hasMutatedConstraints&&cd(e=>{this.constraints!==!1&&this.getAxisMotionValue(e)&&(this.constraints[e]=Ap(n.layoutBox[e],this.constraints[e]))})}resolveRefConstraints(){let{dragConstraints:e,onMeasureDragConstraints:t}=this.getProps();if(!e||!Zf(e))return!1;let n=e.current,{projection:r}=this.visualElement;if(!r||!r.layout)return!1;r.root&&(r.root.scroll=void 0,r.root.updateScroll());let i=eu(n,r.root,this.visualElement.getTransformPagePoint()),a=Op(r.layout.layoutBox,i);if(t){let e=t(W(a));this.hasMutatedConstraints=!!e,e&&(a=Bl(e))}return a}startAnimation(e){let{drag:t,dragMomentum:n,dragElastic:r,dragTransition:i,dragSnapToOrigin:a,onDragTransitionEnd:o}=this.getProps(),s=this.constraints||{},c=cd(o=>{if(!zp(o,t,this.currentDirection))return;let c=s&&s[o]||{};(a===!0||a===o)&&(c={min:0,max:0});let l=r?200:1e6,u=r?40:1e7,d={type:`inertia`,velocity:n?e[o]:0,bounceStiffness:l,bounceDamping:u,timeConstant:750,restDelta:1,restSpeed:10,...i,...c};return this.startAxisValueAnimation(o,d)});return Promise.all(c).then(o)}startAxisValueAnimation(e,t){let n=this.getAxisMotionValue(e);return nc(this.visualElement,e),n.start(Hs(e,n,0,t,this.visualElement,!1))}stopAnimation(){cd(e=>this.getAxisMotionValue(e).stop())}getAxisMotionValue(e){let t=`_drag${e.toUpperCase()}`;return this.visualElement.getProps()[t]||this.visualElement.getValue(e,this.visualElement.latestValues[e]??0)}snapToCursor(e){cd(t=>{let{drag:n}=this.getProps();if(!zp(t,n,this.currentDirection))return;let{projection:r}=this.visualElement,i=this.getAxisMotionValue(t);if(r&&r.layout){let{min:n,max:a}=r.layout.layoutBox[t],o=i.get()||0;i.set(e[t]-I(n,a,.5)+o)}})}scalePositionWithinConstraints(){if(!this.visualElement.current)return;let{drag:e,dragConstraints:t}=this.getProps(),{projection:n}=this.visualElement;if(!Zf(t)||!n||!this.constraints)return;this.stopAnimation();let r={x:0,y:0};cd(e=>{let t=this.getAxisMotionValue(e);if(t&&this.constraints!==!1){let n=t.get();r[e]=kp({min:n,max:n},this.constraints[e])}});let{transformTemplate:i}=this.visualElement.getProps();this.visualElement.current.style.transform=i?i({},``):`none`,n.root&&n.root.updateScroll(),n.updateLayout(),this.constraints=!1,this.resolveConstraints(),cd(t=>{if(!zp(t,e,null))return;let n=this.getAxisMotionValue(t),{min:i,max:a}=this.constraints[t];n.set(I(i,a,r[t]))}),this.visualElement.render()}addListeners(){if(!this.visualElement.current)return;Fp.set(this.visualElement,this);let e=this.visualElement.current,t=fp(e,`pointerdown`,t=>{let{drag:n,dragListener:r=!0}=this.getProps(),i=t.target,a=i!==e&&Kc(i);n&&r&&!a&&this.start(t)}),n,r=()=>{let{dragConstraints:t}=this.getProps();Zf(t)&&t.current&&(this.constraints=this.resolveRefConstraints(),n||=Rp(e,t.current,()=>this.scalePositionWithinConstraints()))},{projection:i}=this.visualElement,a=i.addEventListener(`measure`,r);i&&!i.layout&&(i.root&&i.root.updateScroll(),i.updateLayout()),j.read(r);let o=yd(window,`resize`,()=>this.scalePositionWithinConstraints()),s=i.addEventListener(`didUpdate`,(({delta:e,hasLayoutChanged:t})=>{this.isDragging&&t&&(cd(t=>{let n=this.getAxisMotionValue(t);n&&(this.originPoint[t]+=e[t].translate,n.set(n.get()+e[t].translate))}),this.visualElement.render())}));return()=>{o(),t(),a(),s&&s(),n&&n()}}getProps(){let e=this.visualElement.getProps(),{drag:t=!1,dragDirectionLock:n=!1,dragPropagation:r=!1,dragConstraints:i=!1,dragElastic:a=jp,dragMomentum:o=!0}=e;return{...e,drag:t,dragDirectionLock:n,dragPropagation:r,dragConstraints:i,dragElastic:a,dragMomentum:o}}};function Lp(e){let t=!0;return()=>{if(t){t=!1;return}e()}}function Rp(e,t,n){let r=pl(e,Lp(n)),i=pl(t,Lp(n));return()=>{r(),i()}}function zp(e,t,n){return(t===!0||t===e)&&(n===null||n===e)}function Bp(e,t=10){let n=null;return Math.abs(e.y)>t?n=`y`:Math.abs(e.x)>t&&(n=`x`),n}var Vp=class extends zl{constructor(e){super(e),this.removeGroupControls=ii,this.removeListeners=ii,this.controls=new Ip(e)}mount(){let{dragControls:e}=this.node.getProps();e&&(this.removeGroupControls=e.subscribe(this.controls)),this.removeListeners=this.controls.addListeners()||ii}update(){let{dragControls:e}=this.node.getProps(),{dragControls:t}=this.node.prevProps||{};e!==t&&(this.removeGroupControls(),e&&(this.removeGroupControls=e.subscribe(this.controls)))}unmount(){this.removeGroupControls(),this.removeListeners(),this.controls.isDragging||this.controls.endPanSession()}},Hp=e=>(t,n)=>{e&&j.update(()=>e(t,n),!1,!0)},Up=class extends zl{constructor(){super(...arguments),this.removePointerDownListener=ii}onPointerDown(e){this.session=new _p(e,this.createPanHandlers(),{transformPagePoint:this.node.getTransformPagePoint(),contextWindow:pp(this.node)})}createPanHandlers(){let{onPanSessionStart:e,onPanStart:t,onPan:n,onPanEnd:r}=this.node.getProps();return{onSessionStart:Hp(e),onStart:Hp(t),onMove:Hp(n),onEnd:(e,t)=>{delete this.session,r&&j.postRender(()=>r(e,t))}}}mount(){this.removePointerDownListener=fp(this.node.current,`pointerdown`,e=>this.onPointerDown(e))}update(){this.session&&this.session.updateHandlers(this.createPanHandlers())}unmount(){this.removePointerDownListener(),this.session&&this.session.end()}},Wp=!1,Gp=class extends x.Component{componentDidMount(){let{visualElement:e,layoutGroup:t,switchLayoutGroup:n,layoutId:r}=this.props,{projection:i}=e;i&&(t.group&&t.group.add(i),n&&n.register&&r&&n.register(i),Wp&&i.root.didUpdate(),i.addEventListener(`animationComplete`,()=>{this.safeToRemove()}),i.setOptions({...i.options,layoutDependency:this.props.layoutDependency,onExitComplete:()=>this.safeToRemove()})),wd.hasEverUpdated=!0}getSnapshotBeforeUpdate(e){let{layoutDependency:t,visualElement:n,drag:r,isPresent:i}=this.props,{projection:a}=n;return a?(a.isPresent=i,e.layoutDependency!==t&&a.setOptions({...a.options,layoutDependency:t}),Wp=!0,r||e.layoutDependency!==t||t===void 0||e.isPresent!==i?a.willUpdate():this.safeToRemove(),e.isPresent!==i&&(i?a.promote():a.relegate()||j.postRender(()=>{let e=a.getStack();(!e||!e.members.length)&&this.safeToRemove()})),null):null}componentDidUpdate(){let{visualElement:e,layoutAnchor:t}=this.props,{projection:n}=e;n&&(n.options.layoutAnchor=t,n.root.didUpdate(),Pc.postRender(()=>{!n.currentAnimation&&n.isLead()&&this.safeToRemove()}))}componentWillUnmount(){let{visualElement:e,layoutGroup:t,switchLayoutGroup:n}=this.props,{projection:r}=e;Wp=!0,r&&(r.scheduleCheckAfterUnmount(),t&&t.group&&t.group.remove(r),n&&n.deregister&&n.deregister(r))}safeToRemove(){let{safeToRemove:e}=this.props;e&&e()}render(){return null}};function Kp(e){let[t,n]=hf(),r=(0,x.useContext)(Kr);return(0,A.jsx)(Gp,{...e,layoutGroup:r,switchLayoutGroup:(0,x.useContext)(Xf),isPresent:t,safeToRemove:n})}var qp={pan:{Feature:Up},drag:{Feature:Vp,ProjectionNode:of,MeasureLayout:Kp}};function Jp(e,t,n){let{props:r}=e;e.animationState&&r.whileHover&&e.animationState.setActive(`whileHover`,n===`Start`);let i=r[`onHover`+n];i&&j.postRender(()=>i(t,up(t)))}var Yp=class extends zl{mount(){let{current:e}=this.node;e&&(this.unmount=V(e,(e,t)=>(Jp(this.node,t,`Start`),e=>Jp(this.node,e,`End`))))}unmount(){}},Xp=class extends zl{constructor(){super(...arguments),this.isActive=!1}onFocus(){let e=!1;try{e=this.node.current.matches(`:focus-visible`)}catch{e=!0}!e||!this.node.animationState||(this.node.animationState.setActive(`whileFocus`,!0),this.isActive=!0)}onBlur(){!this.isActive||!this.node.animationState||(this.node.animationState.setActive(`whileFocus`,!1),this.isActive=!1)}mount(){this.unmount=ai(yd(this.node.current,`focus`,()=>this.onFocus()),yd(this.node.current,`blur`,()=>this.onBlur()))}unmount(){}};function Zp(e,t,n){let{props:r}=e;if(e.current instanceof HTMLButtonElement&&e.current.disabled)return;e.animationState&&r.whileTap&&e.animationState.setActive(`whileTap`,n===`Start`);let i=r[`onTap`+(n===`End`?``:n)];i&&j.postRender(()=>i(t,up(t)))}var Qp=class extends zl{mount(){let{current:e}=this.node;if(!e)return;let{globalTapTarget:t,propagate:n}=this.node.props;this.unmount=$c(e,(e,t)=>(Zp(this.node,t,`Start`),(e,{success:t})=>Zp(this.node,e,t?`End`:`Cancel`)),{useGlobalTarget:t,stopPropagation:n?.tap===!1})}unmount(){}},$p=new WeakMap,em=new WeakMap,tm=e=>{let t=$p.get(e.target);t&&t(e)},nm=e=>{e.forEach(tm)};function rm({root:e,...t}){let n=e||document;em.has(n)||em.set(n,{});let r=em.get(n),i=JSON.stringify(t);return r[i]||(r[i]=new IntersectionObserver(nm,{root:e,...t})),r[i]}function im(e,t,n){let r=rm(t);return $p.set(e,n),r.observe(e),()=>{$p.delete(e),r.unobserve(e)}}var am={some:0,all:1},om=class extends zl{constructor(){super(...arguments),this.hasEnteredView=!1,this.isInView=!1}startObserver(){this.stopObserver?.();let{viewport:e={}}=this.node.getProps(),{root:t,margin:n,amount:r=`some`,once:i}=e,a={root:t?t.current:void 0,rootMargin:n,threshold:typeof r==`number`?r:am[r]},o=e=>{let{isIntersecting:t}=e;if(this.isInView===t||(this.isInView=t,i&&!t&&this.hasEnteredView))return;t&&(this.hasEnteredView=!0),this.node.animationState&&this.node.animationState.setActive(`whileInView`,t);let{onViewportEnter:n,onViewportLeave:r}=this.node.getProps(),a=t?n:r;a&&a(e)};this.stopObserver=im(this.node.current,a,o)}mount(){this.startObserver()}update(){if(typeof IntersectionObserver>`u`)return;let{props:e,prevProps:t}=this.node;[`amount`,`margin`,`root`].some(sm(e,t))&&this.startObserver()}unmount(){this.stopObserver?.(),this.hasEnteredView=!1,this.isInView=!1}};function sm({viewport:e={}},{viewport:t={}}={}){return n=>e[n]!==t[n]}var cm={inView:{Feature:om},tap:{Feature:Qp},focus:{Feature:Xp},hover:{Feature:Yp}},lm={layout:{ProjectionNode:of,MeasureLayout:Kp}},$=ap({...lp,...cm,...qp,...lm},op),um=`/assets/logo-CWmmc0Ip.jpeg`;function dm(){let e=mt(),[t,n]=(0,x.useState)(!1),[r,i]=(0,x.useState)(!1);(0,x.useEffect)(()=>{let e=()=>{i(window.scrollY>10)};return e(),window.addEventListener(`scroll`,e),()=>window.removeEventListener(`scroll`,e)},[]),(0,x.useEffect)(()=>{n(!1)},[e.pathname]),(0,x.useEffect)(()=>(t?document.body.style.overflow=`hidden`:document.body.style.overflow=`unset`,()=>{document.body.style.overflow=`unset`}),[t]);let a=()=>{n(!1)},o=[{to:`/`,label:`Home`},{to:`/about`,label:`About Us`},{to:`/programs`,label:`MBBS Programs`},{to:`/admissions`,label:`Admissions & Services`},{to:`/gallery`,label:`Gallery`},{to:`/contact`,label:`Contact Us`}];return(0,A.jsxs)(A.Fragment,{children:[(0,A.jsx)(`header`,{className:`sticky top-0 z-50 transition-all duration-300 ${r?`border-b border-slate-200/70 bg-white/80 backdrop-blur-xl shadow-[0_8px_30px_rgba(8,47,91,0.06)]`:`border-b border-transparent bg-white`}`,children:(0,A.jsx)(`div`,{className:`mx-auto max-w-[1440px] px-4 sm:px-6 lg:px-10`,children:(0,A.jsxs)(`div`,{className:`flex h-[72px] items-center justify-between lg:h-[88px]`,children:[(0,A.jsxs)(jn,{to:`/`,onClick:a,className:`z-10 flex shrink-0 items-center gap-3 transition-transform duration-300 hover:scale-[1.02]`,children:[(0,A.jsx)(`img`,{src:um,alt:`Kantule Edutech`,className:`h-[52px] w-auto object-contain sm:h-[60px] lg:h-[72px]`}),(0,A.jsxs)(`div`,{className:`flex flex-col leading-none`,children:[(0,A.jsx)(`span`,{className:`font-serif text-[17px] font-extrabold tracking-[0.08em] text-[#C62828] sm:text-[19px] lg:text-[23px]`,children:`KANTULE`}),(0,A.jsx)(`span`,{className:`font-serif text-[17px] font-extrabold tracking-[0.08em] text-[#C62828] sm:text-[19px] lg:text-[23px]`,children:`    EDUTECH`})]})]}),(0,A.jsx)(`nav`,{className:`hidden items-center lg:flex`,children:(0,A.jsx)(`div`,{className:`flex items-center gap-1`,children:o.map(t=>(0,A.jsx)(fm,{to:t.to,label:t.label,active:e.pathname===t.to},t.to))})}),(0,A.jsx)(`div`,{className:`hidden lg:block`,children:(0,A.jsxs)(jn,{to:`/contact`,className:`group flex items-center gap-2 rounded-full bg-gradient-to-r from-[#071F3D] to-[#0B2E52] px-6 py-3 text-[12px] font-bold uppercase tracking-wide text-white shadow-[0_10px_25px_rgba(8,47,91,0.15)] transition-all duration-300 hover:-translate-y-0.5 hover:shadow-[0_14px_30px_rgba(11,143,211,0.25)]`,children:[(0,A.jsx)(kr,{size:16,className:`text-[#16B9D9]`}),`Book Free Counselling`,(0,A.jsx)($n,{size:15,className:`transition-transform duration-300 group-hover:translate-x-1`})]})}),(0,A.jsx)(`button`,{type:`button`,onClick:()=>n(!0),className:`z-10 flex h-11 w-11 items-center justify-center rounded-xl border border-slate-200 bg-white text-[#082F5B] shadow-sm transition-colors hover:bg-slate-50 lg:hidden`,"aria-label":`Open menu`,children:(0,A.jsx)(Or,{size:22,strokeWidth:2})})]})})}),(0,A.jsx)(vf,{children:t&&(0,A.jsxs)(`div`,{className:`fixed inset-0 z-[100] lg:hidden`,children:[(0,A.jsx)($.div,{initial:{opacity:0},animate:{opacity:1},exit:{opacity:0},onClick:a,className:`absolute inset-0 bg-[#040814]/60 backdrop-blur-md`}),(0,A.jsxs)($.div,{initial:{x:`100%`},animate:{x:0},exit:{x:`100%`},transition:{duration:.4,ease:[.22,1,.36,1]},className:`absolute right-0 top-0 flex h-full w-[85%] max-w-[400px] flex-col bg-white shadow-2xl`,children:[(0,A.jsxs)(`div`,{className:`flex items-center justify-between border-b border-slate-100 px-5 py-4`,children:[(0,A.jsxs)(`div`,{className:`flex items-center gap-3`,children:[(0,A.jsx)(`img`,{src:`/assets/logo-CWmmc0Ip.jpeg`,alt:`Kantule Edutech`,className:`h-12 w-auto object-contain`}),(0,A.jsx)(`span`,{className:`text-[15px] font-bold tracking-wide text-red-600`,children:`KANTULE EDUTECH`})]}),(0,A.jsx)(`button`,{type:`button`,onClick:a,className:`flex h-10 w-10 items-center justify-center rounded-xl border border-slate-200 bg-white text-[#082F5B] transition-colors hover:bg-slate-50`,"aria-label":`Close menu`,children:(0,A.jsx)(Vr,{size:20,strokeWidth:2})})]}),(0,A.jsx)(`div`,{className:`flex-1 overflow-y-auto px-5 py-6`,children:(0,A.jsx)($.div,{className:`space-y-2`,initial:`hidden`,animate:`visible`,variants:{visible:{transition:{staggerChildren:.06,delayChildren:.1}}},children:o.map(t=>(0,A.jsx)(pm,{to:t.to,label:t.label,active:e.pathname===t.to,onClick:a},t.to))})}),(0,A.jsx)(`div`,{className:`border-t border-slate-100 bg-slate-50/50 p-5`,children:(0,A.jsxs)(jn,{to:`/contact`,onClick:a,className:`group flex w-full items-center justify-center gap-2 rounded-xl bg-gradient-to-r from-[#0B8FD3] to-[#16B9D9] px-5 py-4 text-sm font-bold text-white shadow-lg transition-transform active:scale-[0.98]`,children:[(0,A.jsx)(kr,{size:18}),`Book Free Counselling`,(0,A.jsx)($n,{size:16,className:`transition-transform duration-300 group-hover:translate-x-1`})]})})]})]})})]})}function fm({to:e,label:t,active:n}){return(0,A.jsxs)(jn,{to:e,className:`group relative flex items-center px-4 py-2 text-[13.5px] font-semibold transition-colors`,children:[(0,A.jsx)(`span`,{className:`relative z-10 ${n?`text-[#0B5EA8]`:`text-slate-600 group-hover:text-[#082F5B]`}`,children:t}),(0,A.jsx)(`span`,{className:`absolute bottom-0 left-1/2 h-[3px] -translate-x-1/2 rounded-full bg-gradient-to-r from-[#0B8FD3] to-[#16B9D9] transition-all duration-300 ease-out ${n?`w-1/2 opacity-100`:`w-0 opacity-0 group-hover:w-1/2 group-hover:opacity-100`}`})]})}function pm({to:e,label:t,active:n,onClick:r}){return(0,A.jsx)($.div,{variants:{hidden:{opacity:0,x:20},visible:{opacity:1,x:0}},transition:{duration:.3,ease:[.22,1,.36,1]},children:(0,A.jsxs)(jn,{to:e,onClick:r,className:`group flex items-center justify-between rounded-2xl px-4 py-4 transition-all duration-200 ${n?`bg-gradient-to-r from-[#071F3D] to-[#0B2E52] text-white shadow-md`:`text-slate-700 hover:bg-slate-100`}`,children:[(0,A.jsx)(`span`,{className:`text-[15px] font-semibold`,children:t}),(0,A.jsx)(`span`,{className:`flex h-8 w-8 items-center justify-center rounded-full transition-all duration-300 ${n?`bg-white/20 text-white`:`bg-slate-100 text-slate-400 group-hover:bg-[#0B8FD3] group-hover:text-white`}`,children:(0,A.jsx)($n,{size:16})})]})})}var mm=[{label:`Home`,href:`/`},{label:`About Us`,href:`/about`},{label:`MBBS Programs`,href:`/programs`},{label:`Admissions & Services`,href:`/admissions`},{label:`Contact Us`,href:`/contact`}],hm=[{label:`MBBS in India`,href:`/programs?country=India`},{label:`MBBS in Russia`,href:`/programs?country=Russia`},{label:`MBBS in Kyrgyzstan`,href:`/programs?country=Kyrgyzstan`},{label:`MBBS in Kazakhstan`,href:`/programs?country=Kazakhstan`},{label:`MBBS in Georgia`,href:`/programs?country=Georgia`},{label:`MBBS in Vietnam`,href:`/programs?country=Vietnam`},{label:`MBBS in Nepal`,href:`/programs?country=Nepal`},{label:`MBBS in Philippines`,href:`/programs?country=Philippines`}],gm=[{icon:Er,content:(0,A.jsxs)(A.Fragment,{children:[`Rukmini Complex, Pachod Road,`,(0,A.jsx)(`br`,{}),`Ambad, District Jalna,`,(0,A.jsx)(`br`,{}),`Maharashtra – 431204`]})},{icon:jr,content:(0,A.jsxs)(A.Fragment,{children:[(0,A.jsx)(`a`,{href:`tel:8830451660`,children:`8830451660`}),(0,A.jsx)(`br`,{}),(0,A.jsx)(`a`,{href:`tel:8237794917`,children:`8237794917`})]})},{icon:kr,content:(0,A.jsx)(`a`,{href:`https://wa.me/918830451660`,target:`_blank`,rel:`noreferrer`,children:`8830451660 / 8237794917`})},{icon:Tr,content:(0,A.jsx)(`a`,{href:`mailto:kantuleedutech@gmail.com`,children:`kantuleedutech@gmail.com`})}],_m=`918830451660`;function vm(){return(0,A.jsxs)(A.Fragment,{children:[(0,A.jsx)(`style`,{children:`
        .ke-footer {
          background: #051c40;
          color: #ffffff;
          position: relative;
...
Exact requirements can vary by destination.`,[`Admission Process`,`MBBS in India`,`MBBS Abroad`,`Free Counselling`]);return}if(t.includes(`free counselling`)||t.includes(`free counseling`)||t.includes(`counselling`)||t.includes(`counseling`)||t.includes(`guidance`)){p(e,`Absolutely. Kantule Edutech provides personalised MBBS admission counselling for students and parents. Guidance can cover your NEET profile, suitable course/university options, budget, documentation and admission journey.`,v);return}if(t.includes(`share my neet score`)||t.includes(`neet score`)){p(e,`Please share your NEET score with our counsellor along with your preferred option — MBBS in India or MBBS Abroad. Our team can then guide you based on your profile.`,[`WhatsApp Counsellor`,`MBBS in India`,`MBBS Abroad`,`Back to Main Menu`]);return}if(t.includes(`india or abroad`)||t.includes(`which is better`)||t.includes(`india vs abroad`)){p(e,`The right choice depends on your NEET profile, academic background, budget, preferred location, career goals and applicable admission requirements. Kantule Edutech can help you compare suitable options through personalised counselling.`,[`MBBS in India`,`MBBS Abroad`,`Free Counselling`]);return}if(t.includes(`duration`)||t.includes(`how many years`)||t.includes(`course duration`)){p(e,`MBBS in India is generally 5.5 years including internship, as applicable under current regulations. MBBS Abroad duration varies depending on the country and university.`,[`MBBS in India`,`MBBS Abroad`,`Free Counselling`]);return}if(t.includes(`career`)||t.includes(`after mbbs`)||t.includes(`career opportunities`)){p(e,`After completing medical education and fulfilling applicable licensing/regulatory requirements, students can pursue medical practice, postgraduate studies such as MD/MS, hospitals, healthcare organisations, research and academics.`,[`MBBS in India`,`MBBS Abroad`,`Free Counselling`]);return}if(t.includes(`contact`)||t.includes(`phone`)||t.includes(`number`)||t.includes(`call`)){p(e,`You can contact Kantule Edutech for MBBS admission guidance through phone or WhatsApp.`,v);return}if(t===`hi`||t===`hello`||t===`hey`||t.includes(`good morning`)||t.includes(`good afternoon`)){p(e,`Hello! 👋 How can I help you with your MBBS admission journey?`,m);return}p(e,`I can help you with MBBS admissions in India and abroad, NEET guidance, eligibility, admission process, documents, university selection and counselling. Please select an option below or ask your question in simple words.`,m)},C=()=>{let e=n.trim();!e||i||(r(``),a(!0),l(t=>[...t,{id:Date.now(),type:`user`,text:e}]),setTimeout(()=>{a(!1),S(e)},600))};return(0,A.jsxs)(A.Fragment,{children:[e&&(0,A.jsxs)(`div`,{className:`
            ...
            sm:right-4
            sm:bottom-[104px]
          `,style:{height:`min(650px, calc(100vh - 130px))`},children:[(0,A.jsxs)(`div`,{className:`
              flex
              shrink-0
              items-center
              justify-between
              ...
              py-3.5
              text-white
            `,children:[(0,A.jsxs)(`div`,{className:`flex min-w-0 items-center gap-3`,children:[(0,A.jsx)(`div`,{className:`
                  flex
                  h-10
                  w-10
                  shrink-0
                  ...
                  text-[#078FC9]
                  shadow-sm
                `,children:(0,A.jsxs)(`svg`,{width:`23`,height:`23`,viewBox:`0 0 24 24`,fill:`none`,children:[(0,A.jsx)(`path`,{d:`M12 3C7.03 3 3 6.58 3 11c0 2.14.91 4.08 2.42 5.49L5 21l4.77-2.19c.71.19 1.46.29 2.23.29 4.97 0 9-3.58 9-8S16.97 3 12 3Z`,stroke:`currentColor`,strokeWidth:`1.8`,strokeLinejoin:`round`}),(0,A.jsx)(`path`,{d:`M8 11h.01M12 11h.01M16 11h.01`,stroke:`currentColor`,strokeWidth:`2.2`,strokeLinecap:`round`})]})}),(0,A.jsxs)(`div`,{className:`min-w-0`,children:[(0,A.jsx)(`p`,{className:`truncate text-[14px] font-bold`,children:`Kantule Edutech`}),(0,A.jsxs)(`div`,{className:`mt-0.5 flex items-center gap-1.5`,children:[(0,A.jsx)(`span`,{className:`h-2 w-2 rounded-full bg-green-400`}),(0,A.jsx)(`span`,{className:`text-[10px] text-white/85`,children:`Online • MBBS Admission Assistant`})]})]})]}),(0,A.jsxs)(`div`,{className:`flex items-center gap-1`,children:[(0,A.jsx)(`button`,{type:`button`,onClick:()=>{l([{id:Date.now(),type:`bot`,text:`Hello! 👋 Welcome to Kantule Edutech.`},{id:Date.now()+1,type:`bot`,text:`I’m your MBBS Admission Assistant. How can I help you today?`,options:m}]),r(``)},className:`
                  flex
                  h-8
                  w-8
                  items-center
                  ...
                  hover:bg-white/10
                  hover:text-white
                `,"aria-label":`Reset chat`,title:`Start new chat`,children:(0,A.jsxs)(`svg`,{width:`17`,height:`17`,viewBox:`0 0 24 24`,fill:`none`,children:[(0,A.jsx)(`path`,{d:`M3 12a9 9 0 1 0 3-6.7`,stroke:`currentColor`,strokeWidth:`2`,strokeLinecap:`round`}),(0,A.jsx)(`path`,{d:`M3 4v5h5`,stroke:`currentColor`,strokeWidth:`2`,strokeLinecap:`round`,strokeLinejoin:`round`})]})}),(0,A.jsx)(`button`,{type:`button`,onClick:()=>t(!1),className:`
                  flex
                  h-8
                  w-8
                  items-center
                  ...
                  hover:bg-white/10
                  hover:text-white
                `,"aria-label":`Close chatbot`,children:(0,A.jsx)(`svg`,{width:`18`,height:`18`,viewBox:`0 0 24 24`,fill:`none`,children:(0,A.jsx)(`path`,{d:`M6 6l12 12M18 6 6 18`,stroke:`currentColor`,strokeWidth:`2`,strokeLinecap:`round`})})})]})]}),(0,A.jsx)(`div`,{className:`
              min-h-0
              flex-1
              overflow-y-auto
              bg-[#F7FAFC]
              px-3
              py-4
            `,children:(0,A.jsxs)(`div`,{className:`space-y-3`,children:[c.map(e=>(0,A.jsxs)(`div`,{children:[(0,A.jsx)(`div`,{className:`flex ${e.type===`user`?`justify-end`:`justify-start`}`,children:(0,A.jsx)(`div`,{className:`
                        max-w-[82%]
                        whitespace-pre-line
                        rounded-2xl
                        px-3.5
                      ...
                      `,children:e.text})}),e.type===`bot`&&e.options&&e.options.length>0&&(0,A.jsx)(`div`,{className:`mt-2 flex flex-wrap gap-1.5 pl-1`,children:e.options.map(e=>(0,A.jsx)(`button`,{type:`button`,onClick:()=>b(e),disabled:i,className:`
                              rounded-full
                              border
                              border-[#B7DDEC]
                              bg-white
                              ...
                              disabled:opacity-50
                            `,children:e},e))})]},e.id)),i&&(0,A.jsx)(`div`,{className:`flex justify-start`,children:(0,A.jsx)(`div`,{className:`
                      rounded-2xl
                      rounded-bl-md
                      border
                      border-slate-100
                      ...
                      py-3
                      shadow-sm
                    `,children:(0,A.jsxs)(`div`,{className:`flex items-center gap-1`,children:[(0,A.jsx)(`span`,{className:`typing-dot`}),(0,A.jsx)(`span`,{className:`typing-dot delay-1`}),(0,A.jsx)(`span`,{className:`typing-dot delay-2`})]})})}),(0,A.jsx)(`div`,{ref:u})]})}),(0,A.jsxs)(`div`,{className:`shrink-0 border-t border-slate-200 bg-white p-3`,children:[(0,A.jsxs)(`div`,{className:`
                flex
                min-h-[48px]
                items-center
                gap-2
              ...
              `,children:[(0,A.jsx)(`input`,{type:`text`,value:n,onChange:e=>r(e.target.value),onKeyDown:e=>{e.key===`Enter`&&!e.shiftKey&&(e.preventDefault(),C())},disabled:i,placeholder:`Ask about MBBS admissions...`,className:`
                  min-w-0
                  flex-1
                  bg-transparent
                  py-2
                  ...
                  disabled:opacity-60
                `}),(0,A.jsx)(`button`,{type:`button`,onClick:C,disabled:!n.trim()||i,className:`
                  flex
                  h-9
                  w-9
                  shrink-0
                ...
                `,"aria-label":`Send message`,title:`Send message`,children:(0,A.jsxs)(`svg`,{width:`17`,height:`17`,viewBox:`0 0 24 24`,fill:`none`,children:[(0,A.jsx)(`path`,{d:`M22 2 11 13`,stroke:`currentColor`,strokeWidth:`2`,strokeLinecap:`round`,strokeLinejoin:`round`}),(0,A.jsx)(`path`,{d:`m22 2-7 20-4-9-9-4 20-7Z`,stroke:`currentColor`,strokeWidth:`2`,strokeLinecap:`round`,strokeLinejoin:`round`})]})})]}),(0,A.jsx)(`p`,{className:`mt-2 text-center text-[9px] text-slate-400`,children:`Kantule Edutech • Medical Education Guidance`})]})]}),(0,A.jsxs)(`div`,{className:`
          fixed
          bottom-[88px]
          ...
          items-center
          gap-3
        `,onMouseEnter:()=>s(!0),onMouseLeave:()=>{e||s(!1)},children:[o&&!e&&(0,A.jsxs)(`div`,{className:`
              rounded-2xl
              border
              border-slate-100
              bg-white
            ...
            `,style:{animation:`chatTooltipIn 0.35s cubic-bezier(0.34,1.56,0.64,1)`},children:[(0,A.jsx)(`p`,{className:`whitespace-nowrap text-[12px] font-bold text-slate-900`,children:`Need MBBS Guidance?`}),(0,A.jsx)(`p`,{className:`mt-0.5 whitespace-nowrap text-[10px] text-slate-500`,children:`Chat with our admission assistant`})]}),(0,A.jsxs)(`button`,{type:`button`,onClick:()=>{t(e=>!e),s(!1)},onMouseEnter:()=>{e||s(!0)},"aria-label":e?`Close Kantule Edutech chatbot`:`Open Kantule Edutech chatbot`,title:`Kantule Edutech Admission Assistant`,className:`
            relative
            flex
            h-[60px]
            w-[60px]
          ...
          `,children:[(0,A.jsx)(`span`,{className:`
              ...
              border-white
              bg-green-500
            `}),e?(0,A.jsx)(`svg`,{width:`26`,height:`26`,viewBox:`0 0 24 24`,fill:`none`,children:(0,A.jsx)(`path`,{d:`M6 6l12 12M18 6 6 18`,stroke:`currentColor`,strokeWidth:`2.2`,strokeLinecap:`round`})}):(0,A.jsxs)(`svg`,{width:`29`,height:`29`,viewBox:`0 0 24 24`,fill:`none`,children:[(0,A.jsx)(`path`,{d:`M20 11.5a7.5 7.5 0 0 1-7.5 7.5c-1.15 0-2.24-.26-3.21-.72L5 20l1.72-4.29A7.46 7.46 0 0 1 5 11.5 7.5 7.5 0 1 1 20 11.5Z`,stroke:`currentColor`,strokeWidth:`1.8`,strokeLinejoin:`round`}),(0,A.jsx)(`path`,{d:`M8.5 11.5h.01M12 11.5h.01M15.5 11.5h.01`,stroke:`currentColor`,strokeWidth:`2.5`,strokeLinecap:`round`})]})]})]}),(0,A.jsx)(`style`,{children:`
...
`;function Um({university:e}){let[t,n]=(0,x.useState)(!1),r=Im(e.id),i=zm(e),a=e.fallbackImage||r?.image||``,o=t&&a&&a!==i?a:i;return(0,A.jsxs)($.div,{layout:!0,initial:{opacity:0,y:20},animate:{opacity:1,y:0},exit:{opacity:0,scale:.96},transition:{duration:.35,ease:`easeOut`},className:`group relative flex flex-col h-full bg-white rounded-2xl sm:rounded-3xl border border-[#e2edf8] shadow-[0_8px_25px_rgba(11,45,92,0.05)] hover:shadow-[0_22px_45px_rgba(11,45,92,0.12)] transition-all duration-300 hover:-translate-y-1.5 overflow-hidden`,children:[(0,A.jsxs)(`div`,{className:`relative aspect-[16/10] w-full overflow-hidden bg-[#f0f6fc]`,children:[o?(0,A.jsx)(`img`,{src:o,alt:e.name,loading:`lazy`,onError:()=>n(!0),className:`w-full h-full object-cover transition-transform duration-500 ease-out group-hover:scale-105`}):(0,A.jsxs)(`div`,{className:`w-full h-full flex flex-col items-center justify-center bg-gradient-to-br from-[#0B2D5C] to-[#1455A0] text-white p-6 text-center`,children:[(0,A.jsx)(`div`,{className:`w-12 h-12 rounded-2xl bg-white/10 border border-white/20 flex items-center justify-center mb-3 text-[#18B8D4]`,children:(0,A.jsx)(rr,{size:24})}),(0,A.jsx)(`span`,{className:`text-xs uppercase tracking-widest text-cyan-200 font-semibold`,children:e.country}),(0,A.jsx)(`span`,{className:`text-sm font-bold text-white line-clamp-2 mt-1`,children:e.name})]}),(0,A.jsx)(`div`,{className:`absolute inset-0 bg-gradient-to-t from-slate-950/40 via-transparent to-transparent pointer-events-none`}),(0,A.jsx)(`div`,{className:`absolute top-3.5 left-3.5 z-10`,children:(0,A.jsxs)(`span`,{className:`inline-flex items-center gap-1.5 px-3 py-1 rounded-full text-xs font-semibold bg-white/95 text-[#0B2D5C] backdrop-blur-md shadow-sm border border-white/80`,children:[(0,A.jsx)(`span`,{className:`w-2 h-2 rounded-full bg-[#18B8D4]`}),e.country]})})]}),(0,A.jsxs)(`div`,{className:`p-5 sm:p-6 flex flex-col flex-grow justify-between bg-white`,children:[(0,A.jsxs)(`div`,{children:[(0,A.jsx)(`h3`,{className:`text-lg sm:text-xl font-bold text-[#0B2D5C] group-hover:text-[#1455A0] transition-colors duration-200 leading-snug`,children:e.name}),(0,A.jsxs)(`p`,{className:`text-sm text-slate-500 mt-2.5 flex items-center gap-1.5 font-medium`,children:[(0,A.jsx)(Er,{size:15,className:`text-[#18B8D4] shrink-0`}),(0,A.jsx)(`span`,{children:e.city?`${e.city}, ${e.country}`:e.country})]}),r&&(0,A.jsxs)(`div`,{className:`card-meta-pills`,children:[r.type&&(0,A.jsxs)(`span`,{className:`card-meta-pill type`,children:[(0,A.jsx)(rr,{size:10}),r.type]}),r.recognition&&(0,A.jsxs)(`span`,{className:`card-meta-pill recog`,children:[(0,A.jsx)(Fr,{size:10}),r.recognition]})]})]}),(0,A.jsx)(`div`,{className:`mt-4 pt-1`,children:(0,A.jsxs)(jn,{to:`/university/${e.id}`,className:`view-details-trigger`,children:[`View Details`,(0,A.jsx)(cr,{size:14})]})})]})]})}function Wm(){let[e,t]=(0,x.useState)(`All Universities`),n=[...jm,...Bm,...Vm].filter((e,t,n)=>t===n.findIndex(t=>t.id===e.id)),r=e===`All Universities`?n:n.filter(t=>t.country===e),i=[`All Universities`,`Kyrgyzstan`,...Am.filter(e=>e!==`All Universities`&&e!==`Kyrgyzstan`)];return(0,A.jsxs)(`section`,{className:`relative py-20 lg:py-28 bg-[#f8fbfe] overflow-hidden border-t border-slate-100`,children:[(0,A.jsx)(`style`,{children:Hm}),(0,A.jsx)(`div`,{className:`absolute top-0 right-0 w-96 h-96 bg-cyan-100/40 rounded-full blur-3xl pointer-events-none -mr-32 -mt-32`}),(0,A.jsx)(`div`,{className:`absolute bottom-0 left-0 w-96 h-96 bg-blue-100/30 rounded-full blur-3xl pointer-events-none -ml-32 -mb-32`}),(0,A.jsxs)(`div`,{className:`relative mx-auto max-w-[1240px] px-4 sm:px-6 lg:px-8`,children:[(0,A.jsxs)(`div`,{className:`text-center max-w-3xl mx-auto mb-10 sm:mb-14`,children:[(0,A.jsxs)(`div`,{className:`inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-white border border-[#d6e6f5] text-[#1455A0] text-xs font-bold tracking-widest uppercase mb-4 shadow-sm`,children:[(0,A.jsx)(`span`,{className:`w-2 h-2 rounded-full bg-[#18B8D4]`}),`FEATURED UNIVERSITIES`]}),(0,A.jsxs)(`h2`,{className:`text-3xl sm:text-4xl lg:text-5xl font-extrabold text-[#0B2D5C] tracking-tight leading-[1.15]`,children:[`Explore Medical Universities`,` `,(0,A.jsx)(`span`,{className:`bg-gradient-to-r from-[#1455A0] to-[#18B8D4] bg-clip-text text-transparent`,children:`Around the World`})]}),(0,A.jsx)(`p`,{className:`mt-4 text-slate-600 text-sm sm:text-base leading-relaxed max-w-2xl mx-auto`,children:`Explore leading medical universities across popular MBBS destinations and find the right option based on your academic goals.`})]}),(0,A.jsx)(`div`,{className:`mb-10 sm:mb-12`,children:(0,A.jsx)(`div`,{className:`flex items-center justify-start lg:justify-center gap-2 sm:gap-2.5 overflow-x-auto pb-3 pt-1 px-1 scrollbar-none [-ms-overflow-style:none] [scrollbar-width:none]`,children:i.map(n=>{let r=e===n;return(0,A.jsxs)(`button`,{onClick:()=>t(n),className:`relative px-4 sm:px-5 py-2 sm:py-2.5 rounded-full text-xs sm:text-sm font-semibold transition-all duration-200 shrink-0 select-none ${r?`text-white shadow-md shadow-[#0B2D5C]/15`:`text-slate-600 hover:text-[#0B2D5C] bg-white hover:bg-slate-50 border border-slate-200/90 shadow-sm`}`,children:[r&&(0,A.jsx)($.div,{layoutId:`activeCountryPill`,className:`absolute inset-0 rounded-full bg-gradient-to-r from-[#0B2D5C] to-[#1455A0]`,transition:{type:`spring`,stiffness:400,damping:32}}),(0,A.jsx)(`span`,{className:`relative z-10 flex items-center gap-1.5`,children:n})]},n)})})}),(0,A.jsx)(vf,{mode:`wait`,children:r.length>0?(0,A.jsx)($.div,{initial:{opacity:0},animate:{opacity:1},exit:{opacity:0},transition:{duration:.3},className:`grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8`,children:r.map(e=>(0,A.jsx)(Um,{university:e},e.id))},e):(0,A.jsxs)($.div,{initial:{opacity:0,y:20},animate:{opacity:1,y:0},exit:{opacity:0,y:-20},transition:{duration:.35},className:`max-w-xl mx-auto text-center py-14 px-6 sm:px-10 bg-white rounded-3xl border border-[#dce8f5] shadow-[0_10px_35px_rgba(11,45,92,0.06)]`,children:[(0,A.jsx)(`div`,{className:`w-16 h-16 rounded-2xl bg-[#eef7fc] text-[#1455A0] flex items-center justify-center mx-auto mb-5 border border-[#d2e7f8]`,children:(0,A.jsx)(yr,{size:32,className:`text-[#18B8D4]`})}),(0,A.jsx)(`h3`,{className:`text-xl sm:text-2xl font-bold text-[#0B2D5C]`,children:`Universities Coming Soon`}),(0,A.jsx)(`p`,{className:`mt-3 text-sm text-slate-600 leading-relaxed`,children:`We are currently updating university information for this destination. Please contact our counselling team for guidance.`}),(0,A.jsx)(`div`,{className:`mt-6 flex justify-center`,children:(0,A.jsxs)(`a`,{href:`#contact`,className:`inline-flex items-center gap-2 px-6 py-3 rounded-full bg-[#1455A0] hover:bg-[#0B2D5C] text-white text-xs sm:text-sm font-bold shadow-md shadow-blue-900/20 hover:shadow-lg transition-all duration-200`,children:[`Book Free Counselling`,(0,A.jsx)(er,{size:16})]})})]},`empty-state`)})]})]})}var Gm=[{image:Sm,eyebrow:`MEDICAL EDUCATION & CAREER GUIDANCE`,title:`Your Trusted Partner for Medical Education & Career Guidance`,marathi:`वैद्यकीय शिक्षणासाठी योग्य मार्गदर्शन, योग्य निर्णय आणि उज्ज्वल करिअरची सुरुवात.`},{image:Cm,eyebrow:`MBBS ADMISSIONS ABROAD`,title:`Professional Guidance for Your MBBS Journey Abroad`,marathi:`वैद्यकीय शिक्षणासाठी योग्य मार्गदर्शन, योग्य निर्णय आणि उज्ज्वल करिअरची सुरुवात.`},{image:wm,eyebrow:`SHAPE YOUR MEDICAL CAREER`,title:`Build Your Future with the Right Medical Education`,marathi:`वैद्यकीय शिक्षणासाठी योग्य मार्गदर्शन, योग्य निर्णय आणि उज्ज्वल करिअरची सुरुवात.`}],Km=[{name:`Russia`,code:`ru`},{name:`Kyrgyzstan`,code:`kg`},{name:`Kazakhstan`,code:`kz`},{name:`Georgia`,code:`ge`},{name:`Philippines`,code:`ph`},{name:`Nepal`,code:`np`},{name:`Vietnam`,code:`vn`},{name:`USA`,code:`us`}],qm=[{icon:zr,title:`Experienced Counselling Team`},{icon:yr,title:`10+ Years in Education Sector`},{icon:Rr,title:`Personalized Student Counselling`},{icon:Pr,title:`Transparent Information`},{icon:mr,title:`Multiple MBBS Destinations`},{icon:ur,title:`Complete Admission Guidance`},{icon:vr,title:`Documentation & Application Assistance`},{icon:br,title:`Post-Admission Guidance & Support`},{icon:xr,title:`Parent-Friendly Counselling`}],Jm=[{number:`01`,icon:kr,title:`Counselling`},{number:`02`,icon:rr,title:`Course & University Selection`},{number:`03`,icon:vr,title:`Application`},{number:`04`,icon:Rr,title:`Admission`},{number:`05`,icon:ur,title:`Documentation & Visa Guidance`},{number:`06`,icon:Mr,title:`Pre-Departure Guidance`},{number:`07`,icon:br,title:`Post-Admission Support`}],Ym=[{quote:`The best study abroad consultancy i have seen for USA in JALNA & BEED. Highly recommend all genuine students to visit once and feel the difference and honesty in the counselling. When you visit specially ask for Swapnil Sir.`,name:`Pavan Nilkanth Joshi`,location:`Google Review`,reviews:`1 review`},{quote:`Best consultancy services for studying MBBS in the best colleges. If you are NEET exam qualify and can't get admission in India then must contact KANTULE EDUTECH.`,name:`Aniket Patare`,location:`Google Review`,reviews:`9 reviews`},{quote:`Good edutech organization as flow of all information is transperent and easy to asscable. Working environment is class professional along with that employees with human values.`,name:`Aniket Kale`,location:`Google Review`,reviews:`3 reviews`},{quote:`An ideal place for MBBS councelling. Have multiple options to opt in terms of universities.`,name:`Ajit Pawar`,location:`Google Review`,reviews:`Local Guide · 12 reviews`},{quote:`Nice guidence, good data and information they have. Trusted genuine sevices for mbbs admission.`,name:`Sudarshan Deshmukh`,location:`Google Review`,reviews:`5 reviews`},{quote:`Swapnil sir very helping and humble. Better consultancy service compared to others.`,name:`Rameshwar Kawale`,location:`Google Review`,reviews:`Local Guide · 13 reviews`},{quote:`Beat consultant .have multiple options with affordable price Thank you for counseling and admission`,name:`Anand Shinde`,location:`Google Review`,reviews:`2 reviews`},{quote:`Best abroad education consultant in beed and jalna`,name:`Swaraj Kantule`,location:`Google Review`,reviews:`2 reviews`},{quote:`Amazing councillors u have....thankuu for ur guidance`,name:`Shubham Bhadalkar`,location:`Google Review`,reviews:`11 reviews`},{quote:`Whole hearted person dedicated to his clients....`,name:`Abhi Jadhav`,location:`Google Review`,reviews:`3 reviews`},{quote:`Nice experience of service`,name:`Shridhar Waghmare`,location:`Google Review`,reviews:`Local Guide · 13 reviews · 42 photos`},{quote:`Best MBBS consultant in beed`,name:`Pavan Rajput`,location:`Google Review`,reviews:`2 reviews · 6 photos`}];function Xm(){let[e,t]=(0,x.useState)(0);return(0,x.useEffect)(()=>{let e=setInterval(()=>{t(e=>(e+1)%Gm.length)},5500);return()=>clearInterval(e)},[]),(0,A.jsxs)(A.Fragment,{children:[(0,A.jsx)(`style`,{children:`
      ...
      `}),(0,A.jsxs)(`main`,{className:`home-page`,children:[(0,A.jsxs)(`section`,{className:`hero`,children:[(0,A.jsx)(`div`,{className:`hero-image-wrap`,children:(0,A.jsx)(vf,{mode:`sync`,children:(0,A.jsx)($.img,{src:Gm[e].image,alt:`Kantule Edutech Medical Education`,className:`hero-image`,initial:{opacity:0},animate:{opacity:1},exit:{opacity:0},transition:{duration:1.2,ease:`easeInOut`}},e)})}),(0,A.jsx)(`div`,{className:`hero-overlay`}),(0,A.jsx)(`div`,{className:`hero-content`,children:(0,A.jsx)(vf,{mode:`wait`,children:(0,A.jsxs)($.div,{className:`hero-text`,initial:{opacity:0,y:40},animate:{opacity:1,y:0},exit:{opacity:0,y:-20},transition:{duration:.7,ease:`easeOut`},children:[(0,A.jsxs)($.div,{className:`hero-eyebrow`,initial:{opacity:0,scale:.8},animate:{opacity:1,scale:1},transition:{delay:.1},children:[(0,A.jsx)(`span`,{className:`hero-eyebrow-dot`}),Gm[e].eyebrow]}),(0,A.jsx)(`h1`,{className:`hero-title`,children:Gm[e].title.split(`Medical Education`).map((e,t)=>(0,A.jsxs)(x.Fragment,{children:[e,t===0&&(0,A.jsx)(A.Fragment,{children:(0,A.jsx)(`span`,{children:`Medical Education`})})]},t))}),(0,A.jsx)(`p`,{className:`hero-marathi`,children:Gm[e].marathi}),(0,A.jsx)(`p`,{className:`hero-description`,children:`Kantule Edutech is a Maharashtra-based education consultancy specializing in MBBS admission counselling in India and abroad. With around 10 years of experience in the education field, we provide students and parents with transparent, personalized and reliable guidance for medical education.`}),(0,A.jsxs)(`div`,{className:`hero-buttons`,children:[(0,A.jsxs)($.a,{href:`#contact`,className:`primary-btn`,initial:{opacity:0,y:20},animate:{opacity:1,y:0},transition:{delay:.3},whileHover:{scale:1.05},whileTap:{scale:.95},children:[`Enquire Now`,(0,A.jsx)($n,{size:16})]}),(0,A.jsxs)($.a,{href:`#contact`,className:`secondary-btn`,initial:{opacity:0,y:20},animate:{opacity:1,y:0},transition:{delay:.4},whileHover:{scale:1.05},whileTap:{scale:.95},children:[`Book Free Counselling`,(0,A.jsx)(er,{size:16})]})]})]},e)})}),(0,A.jsxs)(`div`,{className:`hero-arrows`,children:[(0,A.jsx)(`button`,{className:`hero-arrow`,onClick:()=>{t(e=>(e-1+Gm.length)%Gm.length)},"aria-label":`Previous slide`,children:(0,A.jsx)(sr,{size:19})}),(0,A.jsx)(`button`,{className:`hero-arrow`,onClick:()=>{t(e=>(e+1)%Gm.length)},"aria-label":`Next slide`,children:(0,A.jsx)(cr,{size:19})})]}),(0,A.jsx)(`div`,{className:`hero-dots`,children:Gm.map((n,r)=>(0,A.jsx)(`button`,{className:`hero-dot ${e===r?`active`:``}`,onClick:()=>t(r),"aria-label":`Go to slide ${r+1}`},r))}),(0,A.jsxs)(`div`,{className:`hero-stats`,children:[(0,A.jsxs)(`div`,{className:`stat-item`,children:[(0,A.jsx)(`div`,{className:`stat-icon`,children:(0,A.jsx)(yr,{size:23})}),(0,A.jsxs)(`div`,{children:[(0,A.jsx)(`p`,{className:`stat-number`,children:`10+ Years`}),(0,A.jsx)(`p`,{className:`stat-label`,children:`Experience in Education`})]})]}),(0,A.jsxs)(`div`,{className:`stat-item`,children:[(0,A.jsx)(`div`,{className:`stat-icon`,children:(0,A.jsx)(zr,{size:22})}),(0,A.jsxs)(`div`,{children:[(0,A.jsx)(`p`,{className:`stat-number`,children:`150+ Students`}),(0,A.jsx)(`p`,{className:`stat-label`,children:`Studying MBBS Abroad`})]})]}),(0,A.jsxs)(`div`,{className:`stat-item`,children:[(0,A.jsx)(`div`,{className:`stat-icon`,children:(0,A.jsx)(rr,{size:21})}),(0,A.jsxs)(`div`,{children:[(0,A.jsx)(`p`,{className:`stat-number`,children:`4 Centres`}),(0,A.jsx)(`p`,{className:`stat-label`,children:`Across Maharashtra`})]})]}),(0,A.jsxs)(`div`,{className:`stat-item`,children:[(0,A.jsx)(`div`,{className:`stat-icon`,children:(0,A.jsx)(mr,{size:21})}),(0,A.jsxs)(`div`,{children:[(0,A.jsx)(`p`,{className:`stat-number`,children:`Multiple Countries`}),(0,A.jsx)(`p`,{className:`stat-label`,children:`MBBS Opportunities`})]})]})]})]}),(0,A.jsx)(`section`,{className:`section`,children:(0,A.jsx)(`div`,{className:`section-container`,children:(0,A.jsxs)(`div`,{className:`intro-grid`,children:[(0,A.jsxs)($.div,{className:`intro-visual`,initial:{opacity:0,x:-50},whileInView:{opacity:1,x:0},viewport:{once:!0,amount:.2},transition:{duration:.7},children:[(0,A.jsx)(`div`,{className:`intro-main-image-wrap`,children:(0,A.jsx)($.img,{src:Sm,alt:`Kantule Edutech`,className:`intro-main-image`,initial:{scale:1.2},whileInView:{scale:1},viewport:{once:!0},transition:{duration:.8}})}),(0,A.jsxs)($.div,{className:`intro-floating-card`,initial:{opacity:0,scale:.8},whileInView:{opacity:1,scale:1},viewport:{once:!0},transition:{delay:.3,duration:.5},children:[(0,A.jsx)(`div`,{className:`intro-floating-card-icon`,children:(0,A.jsx)(Ir,{size:22})}),(0,A.jsx)(`strong`,{children:`10+ Years`}),(0,A.jsx)(`span`,{children:`Experience in Education`})]})]}),(0,A.jsxs)($.div,{className:`intro-content`,initial:{opacity:0,x:50},whileInView:{opacity:1,x:0},viewport:{once:!0,amount:.2},transition:{duration:.7},children:[(0,A.jsx)(`div`,{className:`section-kicker`,children:`ABOUT KANTULE EDUTECH`}),(0,A.jsxs)(`h2`,{children:[`Your Trusted Partner for `,(0,A.jsx)(`span`,{children:`Medical Education`})]}),(0,A.jsx)(`p`,{children:`Kantule Edutech is a Maharashtra-based education consultancy specializing in MBBS admission counselling in India and abroad. With around 10 years of experience in the education field, we provide students and parents with transparent, personalized and reliable guidance for medical education.`}),(0,A.jsx)(`p`,{children:`We guide students through the complete admission journey — from course and university selection to documentation, admission procedures and further support.`}),(0,A.jsxs)(`div`,{className:`marathi-info`,children:[(0,A.jsx)(`p`,{children:`Kantule Edutech ही महाराष्ट्रातील शिक्षण सल्लागार संस्था असून भारतात आणि परदेशात MBBS प्रवेशासाठी मार्गदर्शन करते. शिक्षण क्षेत्रातील सुमारे 10 वर्षांच्या अनुभवासह आम्ही विद्यार्थी आणि पालकांना वैद्यकीय शिक्षणासाठी पारदर्शक, वैयक्तिक आणि विश्वासार्ह मार्गदर्शन प्रदान करतो.`}),(0,A.jsx)(`p`,{children:`अभ्यासक्रम आणि विद्यापीठाची निवड करण्यापासून ते कागदपत्रे, प्रवेश प्रक्रिया आणि पुढील मार्गदर्शनापर्यंत आम्ही विद्यार्थ्यांना संपूर्ण प्रवेश प्रक्रियेत मार्गदर्शन करतो.`})]}),(0,A.jsx)(`div`,{className:`intro-points`,children:[`Professional MBBS admission counselling`,`India & Abroad medical admission guidance`,`Personalized counselling for students and parents`,`Assistance with documentation and admission procedures`,`Transparent guidance regarding fees, universities and courses`,`Around 10 years of experience in education counselling`].map((e,t)=>(0,A.jsxs)($.div,{className:`intro-point`,initial:{opacity:0,x:20},whileInView:{opacity:1,x:0},viewport:{once:!0},transition:{delay:t*.1},children:[(0,A.jsx)(`span`,{className:`check-circle`,children:(0,A.jsx)(ar,{size:12})}),e]},t))}),(0,A.jsx)(`div`,{className:`marathi-points`,children:[`व्यावसायिक MBBS प्रवेश मार्गदर्शन`,`भारत आणि परदेशातील वैद्यकीय प्रवेशासाठी मार्गदर्शन`,`विद्यार्थी आणि पालकांसाठी वैयक्तिक मार्गदर्शन`,`कागदपत्रे आणि प्रवेश प्रक्रियेसाठी सहाय्य`,`फी, विद्यापीठे आणि अभ्यासक्रमाबाबत पारदर्शक मार्गदर्शन`,`शिक्षण क्षेत्रातील सुमारे 10 वर्षांचा अनुभव`].map((e,t)=>(0,A.jsxs)($.div,{className:`intro-point`,initial:{opacity:0,x:20},whileInView:{opacity:1,x:0},viewport:{once:!0},transition:{delay:t*.1},children:[(0,A.jsx)(`span`,{className:`check-circle`,children:(0,A.jsx)(ar,{size:12})}),e]},t))})]})]})})}),(0,A.jsxs)(`section`,{className:`section soft programs-section`,children:[(0,A.jsx)(`div`,{className:`programs-bg-image`,style:{backgroundImage:`url(${Cm})`},"aria-hidden":`true`}),(0,A.jsxs)(`div`,{className:`section-container programs-content`,children:[(0,A.jsxs)(`div`,{className:`section-heading`,children:[(0,A.jsx)(`div`,{className:`section-kicker`,children:`OUR PROGRAMS`}),(0,A.jsxs)(`h2`,{className:`section-title`,children:[`Medical Education `,(0,A.jsx)(`span`,{children:`Opportunities`})]}),(0,A.jsx)(`p`,{className:`section-description`,children:`We provide transparent, personalized and reliable guidance for medical education in India and abroad.`})]}),(0,A.jsxs)(`div`,{className:`program-grid`,children:[(0,A.jsxs)($.div,{className:`program-card`,style:{backgroundImage:`url(https://images.unsplash.com/photo-1523240795612-9a054b0db644?auto=format&fit=crop&w=1800&q=90)`},initial:{opacity:0,y:40},whileInView:{opacity:1,y:0},viewport:{once:!0},transition:{duration:.6},whileHover:{y:-7},children:[(0,A.jsx)(`div`,{className:`program-card-overlay`,"aria-hidden":`true`}),(0,A.jsx)(`div`,{className:`program-icon`,children:(0,A.jsx)(rr,{size:27})}),(0,A.jsx)(`h3`,{children:`MBBS in India`}),(0,A.jsx)(`p`,{children:`Professional MBBS admission counselling`}),(0,A.jsxs)(`ul`,{className:`program-list`,children:[(0,A.jsxs)(`li`,{children:[(0,A.jsx)(ar,{size:18}),` Government Medical Colleges`]}),(0,A.jsxs)(`li`,{children:[(0,A.jsx)(ar,{size:18}),` Private Medical Colleges`]}),(0,A.jsxs)(`li`,{children:[(0,A.jsx)(ar,{size:18}),` Deemed Universities`]}),(0,A.jsxs)(`li`,{children:[(0,A.jsx)(ar,{size:18}),` NEET counselling guidance`]})]})]}),(0,A.jsxs)($.div,{className:`program-card`,style:{backgroundImage:`url(https://images.unsplash.com/photo-1538108149393-fbbd81895907?auto=format&fit=crop&w=1800&q=90)`},initial:{opacity:0,y:40},whileInView:{opacity:1,y:0},viewport:{once:!0},transition:{duration:.6,delay:.12},whileHover:{y:-7},children:[(0,A.jsx)(`div`,{className:`program-card-overlay`,"aria-hidden":`true`}),(0,A.jsx)(`div`,{className:`program-icon`,children:(0,A.jsx)(mr,{size:27})}),(0,A.jsx)(`h3`,{children:`MBBS Abroad`}),(0,A.jsx)(`p`,{children:`India & Abroad medical admission guidance`}),(0,A.jsxs)(`ul`,{className:`program-list`,children:[(0,A.jsxs)(`li`,{children:[(0,A.jsx)(ar,{size:18}),` Russia`]}),(0,A.jsxs)(`li`,{children:[(0,A.jsx)(ar,{size:18}),` Kyrgyzstan`]}),(0,A.jsxs)(`li`,{children:[(0,A.jsx)(ar,{size:18}),` Kazakhstan`]}),(0,A.jsxs)(`li`,{children:[(0,A.jsx)(ar,{size:18}),` Georgia`]}),(0,A.jsxs)(`li`,{children:[(0,A.jsx)(ar,{size:18}),` Philippines`]}),(0,A.jsxs)(`li`,{children:[(0,A.jsx)(ar,{size:18}),` Nepal`]}),(0,A.jsxs)(`li`,{children:[(0,A.jsx)(ar,{size:18}),` Vietnam`]}),(0,A.jsxs)(`li`,{children:[(0,A.jsx)(ar,{size:18}),` USA and other international opportunities`]})]})]})]})]})]}),(0,A.jsx)(`section`,{className:`section`,style:{background:`radial-gradient(circle at 8% 18%, rgba(22,183,215,.045), transparent 26%), radial-gradient(circle at 92% 82%, rgba(7,92,168,.045), transparent 26%), #ffffff`},children:(0,A.jsxs)(`div`,{className:`section-container`,children:[(0,A.jsxs)(`div`,{className:`section-heading`,children:[(0,A.jsx)(`div`,{className:`section-kicker`,children:`GLOBAL MBBS OPPORTUNITIES`}),(0,A.jsxs)(`h2`,{className:`section-title`,children:[`Study MBBS in `,(0,A.jsx)(`span`,{children:`Top Countries`})]}),(0,A.jsx)(`p`,{className:`section-description`,children:`Multiple MBBS destinations with professional guidance throughout the admission journey.`})]}),(0,A.jsx)(`div`,{className:`country-grid`,children:Km.map((e,t)=>(0,A.jsxs)($.div,{className:`country-card`,initial:{opacity:0,y:22},whileInView:{opacity:1,y:0},viewport:{once:!0,amount:.15},transition:{duration:.5,delay:t*.06,ease:[.22,1,.36,1]},whileHover:{y:-7},children:[(0,A.jsx)(`div`,{className:`country-flag`,children:(0,A.jsx)(`img`,{src:`https://flagcdn.com/w160/${e.code}.png`,alt:`${e.name} flag`,loading:`lazy`})}),(0,A.jsx)(`h3`,{children:e.name})]},e.name))})]})}),(0,A.jsx)(Wm,{}),(0,A.jsx)(`section`,{className:`section soft`,children:(0,A.jsxs)(`div`,{className:`section-container`,children:[(0,A.jsxs)(`div`,{className:`section-heading`,children:[(0,A.jsx)(`div`,{className:`section-kicker`,children:`WHY CHOOSE KANTULE EDUTECH?`}),(0,A.jsxs)(`h2`,{className:`section-title`,children:[`Guidance You Can `,(0,A.jsx)(`span`,{children:`Trust`})]}),(0,A.jsx)(`p`,{className:`section-description`,children:`Transparent, personalized and reliable guidance for students and parents throughout the medical admission journey.`})]}),(0,A.jsx)(`div`,{className:`why-grid`,children:qm.map((e,t)=>{let n=e.icon;return(0,A.jsxs)($.div,{className:`why-card`,initial:{opacity:0,y:25},whileInView:{opacity:1,y:0},viewport:{once:!0,amount:.15},transition:{duration:.45,delay:t*.05},whileHover:{y:-8},children:[(0,A.jsx)(`div`,{className:`why-icon`,children:(0,A.jsx)(n,{size:22})}),(0,A.jsx)(`h3`,{children:e.title})]},e.title)})})]})}),(0,A.jsx)(`section`,{className:`section`,children:(0,A.jsxs)(`div`,{className:`section-container`,children:[(0,A.jsxs)(`div`,{className:`section-heading`,children:[(0,A.jsx)(`div`,{className:`section-kicker`,children:`COMPLETE ADMISSION GUIDANCE`}),(0,A.jsxs)(`h2`,{className:`section-title`,children:[`Our Admission `,(0,A.jsx)(`span`,{children:`Process`})]}),(0,A.jsx)(`p`,{className:`section-description`,children:`We guide students through the complete admission journey from counselling to post-admission support.`})]}),(0,A.jsxs)(`div`,{className:`process-wrapper`,children:[(0,A.jsx)(`div`,{className:`process-line`}),(0,A.jsx)(`div`,{className:`process-grid`,children:Jm.map((e,t)=>{let n=e.icon;return(0,A.jsxs)($.div,{className:`process-item`,initial:{opacity:0,scale:.8},whileInView:{opacity:1,scale:1},viewport:{once:!0},transition:{duration:.45,delay:t*.08},children:[(0,A.jsxs)(`div`,{className:`process-circle`,children:[(0,A.jsx)(n,{size:24}),(0,A.jsx)(`span`,{className:`process-number`,children:e.number})]}),(0,A.jsx)(`h4`,{children:e.title})]},e.number)})})]})]})}),(0,A.jsx)(`section`,{className:`section soft testimonials-section`,children:(0,A.jsxs)(`div`,{className:`section-container`,children:[(0,A.jsxs)(`div`,{className:`section-heading`,children:[(0,A.jsx)(`div`,{className:`section-kicker`,children:`STUDENT & PARENT EXPERIENCES`}),(0,A.jsxs)(`h2`,{className:`section-title`,children:[`What Your Students & `,(0,A.jsx)(`span`,{children:`Parents Say`})]})]}),(0,A.jsx)(`div`,{className:`testimonial-marquee`,children:(0,A.jsx)(`div`,{className:`testimonial-track`,children:[0,1].map(e=>(0,A.jsx)(`div`,{className:`testimonial-set`,"aria-hidden":e===1,children:Ym.map((t,n)=>(0,A.jsxs)($.div,{className:`testimonial-card`,initial:{opacity:0,y:18},whileInView:{opacity:1,y:0},viewport:{once:!0,amount:.08},transition:{duration:.45,delay:n%4*.04},children:[(0,A.jsx)(`div`,{className:`testimonial-top`,children:(0,A.jsx)(`div`,{className:`testimonial-stars`,"aria-label":`5 star review`,children:[1,2,3,4,5].map(e=>(0,A.jsx)(Lr,{size:10},e))})}),(0,A.jsx)(`p`,{children:t.quote}),(0,A.jsx)(`div`,{className:`testimonial-user`,children:(0,A.jsx)(`strong`,{children:t.name})})]},`${e}-${t.name}-${n}`))},e))})})]})}),(0,A.jsx)(`section`,{className:`section`,children:(0,A.jsxs)(`div`,{className:`section-container`,children:[(0,A.jsxs)(`div`,{className:`section-heading`,children:[(0,A.jsx)(`div`,{className:`section-kicker`,children:`KANTULE EDUTECH`}),(0,A.jsxs)(`h2`,{className:`section-title`,children:[`Your Medical Career `,(0,A.jsx)(`span`,{children:`Starts Here`})]})]}),(0,A.jsxs)(`div`,{className:`gallery-grid`,children:[(0,A.jsx)(`div`,{className:`gallery-item`,children:(0,A.jsx)(`div`,{className:`gallery-image-wrap`,children:(0,A.jsx)($.img,{src:Tm,alt:`Kantule Edutech`,className:`gallery-image`,loading:`lazy`,initial:{scale:1.2},whileInView:{scale:1},viewport:{once:!0},transition:{duration:.8}})})}),(0,A.jsx)(`div`,{className:`gallery-item`,children:(0,A.jsx)(`div`,{className:`gallery-image-wrap`,children:(0,A.jsx)($.img,{src:Em,alt:`Kantule Edutech`,className:`gallery-image`,loading:`lazy`,initial:{scale:1.2},whileInView:{scale:1},viewport:{once:!0},transition:{duration:.8}})})}),(0,A.jsx)(`div`,{className:`gallery-item`,children:(0,A.jsx)(`div`,{className:`gallery-image-wrap`,children:(0,A.jsx)($.img,{src:Dm,alt:`Kantule Edutech`,className:`gallery-image`,loading:`lazy`,initial:{scale:1.2},whileInView:{scale:1},viewport:{once:!0},transition:{duration:.8}})})}),(0,A.jsx)(`div`,{className:`gallery-item`,children:(0,A.jsx)(`div`,{className:`gallery-image-wrap`,children:(0,A.jsx)($.img,{src:Om,alt:`Kantule Edutech`,className:`gallery-image`,loading:`lazy`,initial:{scale:1.2},whileInView:{scale:1},viewport:{once:!0},transition:{duration:.8}})})}),(0,A.jsx)(`div`,{className:`gallery-item`,children:(0,A.jsx)(`div`,{className:`gallery-image-wrap`,children:(0,A.jsx)($.img,{src:km,alt:`Kantule Edutech`,className:`gallery-image`,loading:`lazy`,initial:{scale:1.2},whileInView:{scale:1},viewport:{once:!0},transition:{duration:.8}})})})]})]})}),(0,A.jsx)(`section`,{className:`cta`,id:`contact`,children:(0,A.jsxs)(`div`,{className:`cta-inner`,children:[(0,A.jsxs)(`div`,{children:[(0,A.jsx)(`h2`,{children:`Start Your Medical Career Today!`}),(0,A.jsx)(`p`,{children:`Get expert guidance for MBBS admission in India and abroad.`})]}),(0,A.jsxs)(`div`,{className:`cta-buttons`,children:[(0,A.jsxs)(`a`,{href:`https://wa.me/918830451660?text=Hello%20Kantule%20Edutech%2C%20I%20would%20like%20to%20know%20more%20about%20MBBS%20admission%20guidance.`,target:`_blank`,rel:`noopener noreferrer`,className:`primary-btn`,children:[`Enquire Now`,(0,A.jsx)($n,{size:16})]}),(0,A.jsxs)(`a`,{href:`/contact`,className:`secondary-btn`,children:[`Book Free Counselling`,(0,A.jsx)(er,{size:16})]})]})]})})]})]})}var Zm=`/assets/about1-Bw_RLMe6.png`,Qm=`/assets/about2-B1ZWmJ3Y.png`,$m=`/assets/Swapnil%20R.%20Kantule-oJ4jfmgn.jpg`,eh={hidden:{opacity:0,y:35},visible:{opacity:1,y:0,transition:{duration:.7,ease:[.22,1,.36,1]}}},th={hidden:{opacity:0,x:-40},visible:{opacity:1,x:0,transition:{duration:.8,ease:[.22,1,.36,1]}}},nh={hidden:{opacity:0,x:40},visible:{opacity:1,x:0,transition:{duration:.8,ease:[.22,1,.36,1]}}},rh=({children:e})=>(0,A.jsxs)(`div`,{className:`section-label`,children:[(0,A.jsx)(`span`,{className:`label-line`}),(0,A.jsx)(`span`,{children:e})]}),ih=()=>{let e=[{icon:yr,value:`150+`,title:`Students Guided`,text:`Students guided for MBBS abroad`},{icon:rr,value:`4`,title:`Counselling Centres`,text:`Across Maharashtra`},{icon:mr,value:`10+`,title:`Years Experience`,text:`In the education sector`},{icon:Er,value:`Multiple`,title:`Regions Served`,text:`Across Maharashtra`}],t=[`To provide transparent and reliable education counselling.`,`To help students select the right medical education option.`,`To provide personalized guidance to every student.`,`To simplify the admission process for students and parents.`,`To connect students with suitable educational opportunities in India and abroad.`,`To support students throughout their admission journey.`],n=[{icon:Pr,title:`Transparent Guidance`,text:`Clear, practical and reliable information for informed decisions.`},{icon:zr,title:`Personalized Counselling`,text:`Guidance based on each student's profile, goals and requirements.`},{icon:xr,title:`Student & Parent Focus`,text:`A supportive counselling approach for students and their parents.`},{icon:_r,title:`Complete Support`,text:`Guidance throughout the medical admission journey.`}];return(0,A.jsxs)(A.Fragment,{children:[(0,A.jsx)(`style`,{children:`
...
.founder-visual img {
  ...
  display: block;
      ...
      `}),(0,A.jsx)(`main`,{className:`programs-page`,children:(0,A.jsxs)(`div`,{className:`programs-container`,children:[(0,A.jsxs)($.div,{className:`programs-hero`,initial:{opacity:0,y:18},animate:{opacity:1,y:0},transition:{duration:.5},children:[(0,A.jsxs)(`div`,{className:`programs-hero-eyebrow`,children:[(0,A.jsx)(Ir,{}),`GLOBAL MEDICAL EDUCATION`]}),(0,A.jsxs)(`h1`,{children:[`Explore MBBS Opportunities`,` `,(0,A.jsx)(`span`,{children:`Worldwide`})]}),(0,A.jsx)(`p`,{children:`Choose the right medical education destination with transparent, personalized counselling and end-to-end admission guidance from Kantule Edutech.`}),(0,A.jsxs)(`div`,{className:`hero-trust-strip`,children:[(0,A.jsxs)(`div`,{className:`hero-trust-item`,children:[(0,A.jsx)(`span`,{className:`hero-trust-icon`,children:(0,A.jsx)(mr,{})}),(0,A.jsx)(`span`,{children:`9 Global Destinations`})]}),(0,A.jsxs)(`div`,{className:`hero-trust-item`,children:[(0,A.jsx)(`span`,{className:`hero-trust-icon`,children:(0,A.jsx)(yr,{})}),(0,A.jsx)(`span`,{children:`NEET-Based Guidance`})]}),(0,A.jsxs)(`div`,{className:`hero-trust-item`,children:[(0,A.jsx)(`span`,{className:`hero-trust-icon`,children:(0,A.jsx)(Pr,{})}),(0,A.jsx)(`span`,{children:`NMC & WHO Recognized`})]}),(0,A.jsxs)(`div`,{className:`hero-trust-item`,children:[(0,A.jsx)(`span`,{className:`hero-trust-icon`,children:(0,A.jsx)(kr,{})}),(0,A.jsx)(`span`,{children:`100% Free Counselling`})]})]})]}),(0,A.jsxs)(`div`,{className:`destinations-bar`,children:[(0,A.jsxs)(`div`,{className:`destinations-bar-label`,children:[(0,A.jsx)(mr,{size:16}),(0,A.jsx)(`span`,{children:`Explore Programs by Country`})]}),(0,A.jsx)(`div`,{className:`destinations-bar-hint`,children:`Tap a destination to view fees, eligibility & course details`})]}),(0,A.jsx)($.div,{className:`dest-cards-scroll`,initial:{opacity:0,y:10},animate:{opacity:1,y:0},transition:{duration:.4},children:t.map(e=>(0,A.jsxs)(`button`,{type:`button`,className:`dest-card ${a===e.id?`active`:``}`,style:{"--accent":e.accentColor},onClick:()=>{o(e.id),i({country:e.id})},children:[(0,A.jsxs)(`div`,{className:`dest-card-top`,children:[(0,A.jsx)(`span`,{className:`dest-card-flag`,children:(0,A.jsx)(`img`,{src:`https://flagcdn.com/w80/${e.flagCode}.png`,alt:``,loading:`lazy`})}),(0,A.jsx)(`span`,{className:`dest-card-check`,children:(0,A.jsx)(lr,{size:11})})]}),(0,A.jsxs)(`div`,{children:[(0,A.jsx)(`p`,{className:`dest-card-title`,children:e.title.replace(`MBBS in `,``)}),(0,A.jsx)(`span`,{className:`dest-card-badge`,children:e.badge})]})]},e.id))}),(0,A.jsx)(vf,{mode:`wait`,children:(0,A.jsx)($.div,{className:`detail-panel`,style:{borderTop:`3px solid ${s.accentColor}`,"--accent":s.accentColor},initial:{opacity:0,y:15},animate:{opacity:1,y:0},exit:{opacity:0,y:-10},transition:{duration:.32},children:(0,A.jsxs)(`div`,{className:`detail-grid`,children:[(0,A.jsxs)(`div`,{className:`detail-main`,children:[(0,A.jsxs)(`div`,{className:`detail-header`,children:[(0,A.jsx)(`div`,{className:`detail-flag-big`,children:(0,A.jsx)(`img`,{src:`https://flagcdn.com/w160/${s.flagCode}.png`,alt:``})}),(0,A.jsxs)(`div`,{className:`detail-title-wrap`,children:[(0,A.jsxs)(`div`,{className:`detail-badges`,children:[(0,A.jsx)(`span`,{className:`detail-badge`,style:{color:s.accentColor,backgroundColor:`${s.accentColor}10`,border:`1px solid ${s.accentColor}35`},children:s.badge}),(0,A.jsx)(`span`,{className:`detail-code-pill`,children:s.code})]}),(0,A.jsx)(`h2`,{children:s.title}),(0,A.jsx)(`p`,{className:`tagline`,children:s.tagline})]})]}),(0,A.jsxs)(`div`,{className:`detail-meta-strip`,children:[(0,A.jsxs)(`div`,{className:`meta-item`,children:[(0,A.jsxs)(`span`,{className:`meta-item-label`,children:[(0,A.jsx)(fr,{}),`Duration`]}),(0,A.jsx)(`span`,{className:`meta-item-value`,children:s.meta.duration})]}),(0,A.jsxs)(`div`,{className:`meta-item`,children:[(0,A.jsxs)(`span`,{className:`meta-item-label`,children:[(0,A.jsx)(lr,{}),`Recognition`]}),(0,A.jsx)(`span`,{className:`meta-item-value`,children:s.meta.recognition})]}),(0,A.jsxs)(`div`,{className:`meta-item`,children:[(0,A.jsxs)(`span`,{className:`meta-item-label`,children:[(0,A.jsx)(mr,{}),`Medium`]}),(0,A.jsx)(`span`,{className:`meta-item-value`,children:s.meta.medium})]}),(0,A.jsxs)(`div`,{className:`meta-item`,children:[(0,A.jsxs)(`span`,{className:`meta-item-label`,children:[(0,A.jsx)(yr,{}),`Admission`]}),(0,A.jsx)(`span`,{className:`meta-item-value`,children:s.meta.admission})]})]}),(0,A.jsx)(`p`,{className:`detail-intro`,children:s.content.intro}),(0,A.jsx)(`div`,{className:`accordion`,children:f.map(e=>{let t=d[e],n=p===e,r=s.content[e];return(0,A.jsxs)(`div`,{className:`accordion-item ${n?`is-open`:``}`,children:[(0,A.jsxs)(`button`,{type:`button`,className:`accordion-trigger`,onClick:()=>m(n?null:e),children:[(0,A.jsxs)(`span`,{className:`accordion-trigger-left`,children:[(0,A.jsx)(`span`,{className:`accordion-icon`,children:(0,A.jsx)(t,{size:15})}),(0,A.jsx)(`span`,{children:u[e]}),(0,A.jsx)(`span`,{className:`accordion-count`,children:r.length})]}),(0,A.jsx)(or,{size:17,className:`accordion-chevron ${n?`rotated`:``}`})]}),(0,A.jsx)(vf,{initial:!1,children:n&&(0,A.jsx)($.div,{initial:{height:0,opacity:0},animate:{height:`auto`,opacity:1},exit:{height:0,opacity:0},children:(0,A.jsx)(`ul`,{className:`accordion-list`,children:r.map((e,t)=>(0,A.jsxs)(`li`,{children:[(0,A.jsx)(lr,{size:13}),(0,A.jsx)(`span`,{children:e})]},t))})})})]},e)})}),(0,A.jsx)(_,{})]}),(0,A.jsx)(`aside`,{className:`detail-side`,children:(0,A.jsxs)(`div`,{className:`detail-side-inner`,children:[(0,A.jsx)(g,{fees:c}),(0,A.jsxs)(`div`,{className:`side-cta-box`,children:[(0,A.jsx)(`p`,{children:`Free 1-on-1 guidance on eligibility, fees & the right university fit — from our certified admission directors.`}),(0,A.jsxs)(`div`,{className:`side-cta-buttons`,children:[(0,A.jsxs)(jn,{to:`/contact`,className:`side-cta-btn primary`,children:[(0,A.jsx)(kr,{size:14}),`Book Free Counselling`]}),(0,A.jsx)(`a`,{href:`https://wa.me/918830451660?text=I%20want%20to%20know%20more%20about%20MBBS%20programs`,target:`_blank`,rel:`noopener noreferrer`,className:`side-cta-btn secondary`,children:`💬 WhatsApp Us`})]})]})]})})]})},s.id)}),(0,A.jsxs)($.section,{className:`programs-cta`,initial:{opacity:0,y:25},whileInView:{opacity:1,y:0},viewport:{once:!0,amount:.15},children:[(0,A.jsx)(`div`,{className:`programs-cta-icon`,children:(0,A.jsx)(kr,{size:21})}),(0,A.jsx)(`h2`,{children:`Need Help Choosing the Right Destination?`}),(0,A.jsx)(`p`,{children:`Get personalized guidance based on your NEET score, academic profile, budget and career aspirations from our medical education directors.`}),(0,A.jsxs)(`div`,{className:`programs-cta-buttons`,children:[(0,A.jsxs)(jn,{to:`/contact`,className:`cta-btn cta-btn-primary`,children:[(0,A.jsx)(kr,{size:16}),`Book Free Counselling`,(0,A.jsx)($n,{size:15})]}),(0,A.jsxs)(`a`,{href:`https://wa.me/918830451660?text=I%20want%20to%20know%20more%20about%20MBBS%20programs`,target:`_blank`,rel:`noopener noreferrer`,className:`cta-btn cta-btn-secondary`,children:[`💬 WhatsApp Us`,(0,A.jsx)($n,{size:15})]})]})]})]})})]})}var oh=`918830451660`,sh=[{number:`01`,title:`Counselling`,text:`Student's academic profile, NEET score, budget and career goals are discussed thoroughly with certified counsellors.`,icon:Rr},{number:`02`,title:`Course & University Selection`,text:`Suitable colleges, universities and destination countries are shortlisted based on merit and individual preferences.`,icon:yr},{number:`03`,title:`Application & Documentation`,text:`Required application forms, transcripts and verification documents are prepared and submitted directly.`,icon:vr},{number:`04`,title:`Admission Confirmation`,text:`Official admission letter is received and seat allocation is confirmed according to university regulations.`,icon:_r},{number:`05`,title:`Visa Processing & Stamping`,text:`Students receive complete guidance and support regarding student visa paperwork and embassy appointments.`,icon:dr},{number:`06`,title:`Pre-Departure Briefing`,text:`Students and parents receive essential travel, accommodation, currency exchange and cultural onboarding guidance.`,icon:Mr},{number:`07`,title:`Post-Admission & On-Campus Support`,text:`Continuous guidance, airport pickup, hostel settlement and Indian mess assistance throughout the course.`,icon:br}],ch=[`10th Marksheet & Passing Certificate`,`12th Marksheet & Passing Certificate`,`NEET Score Card`,`Valid International Passport`,`Passport-size Photographs (White Background)`,`Other documents as required by university/country`],lh=[{title:`Phone Support`,subtitle:`+91 8830451660 / 8237794917`,icon:jr,action:`tel:+918830451660`,actionText:`Call Directly`},{title:`WhatsApp Chat`,subtitle:`Instant 1-on-1 Guidance`,icon:kr,action:`https://wa.me/${oh}`,actionText:`Chat on WhatsApp`},{title:`Online Enquiry Form`,subtitle:`Fast Response within 2 Hours`,icon:vr,action:`#enquiry`,actionText:`Fill Form Below`},{title:`Direct Office Visit`,subtitle:`Ambad, Jalna, Maharashtra`,icon:Er,action:`/contact`,actionText:`View Office Location`}];function uh(){let[e,t]=(0,x.useState)({name:``,mobile:``,score:``,interestedIn:``}),[n,r]=(0,x.useState)(!1);(0,x.useEffect)(()=>{window.scrollTo({top:0,left:0,behavior:`instant`})},[]);let i=e=>{let{name:n,value:r}=e.target;t(e=>({...e,[n]:r}))};return(0,A.jsxs)(`main`,{className:`overflow-hidden bg-[#f8fbff] text-[#09285f]`,children:[(0,A.jsx)(`style`,{children:`
        * {
          box-sizing: border-box;
        }
      ...
      `}),(0,A.jsxs)(`section`,{className:`ke-hero-section`,children:[(0,A.jsx)(`div`,{className:`ke-dot-grid`}),(0,A.jsx)(`div`,{className:`relative mx-auto max-w-7xl px-5 pb-16 pt-14 sm:px-8 lg:px-10 lg:pb-24 lg:pt-20`,children:(0,A.jsxs)(`div`,{className:`grid items-center gap-12 lg:grid-cols-[1.1fr_0.9fr] lg:gap-14`,children:[(0,A.jsxs)($.div,{initial:{opacity:0,y:22},animate:{opacity:1,y:0},transition:{duration:.55},children:[(0,A.jsxs)(`div`,{className:`mb-5 inline-flex items-center gap-2 rounded-full border border-[#08a8d5]/40 bg-white/5 px-4 py-2 text-[11px] font-bold uppercase tracking-[0.14em] text-[#38bdf8] shadow-[0_4px_14px_-4px_rgba(8,168,213,0.35)] backdrop-blur-md`,children:[(0,A.jsx)(Ir,{size:13,className:`text-[#08a8d5]`}),`Admissions & Services`]}),(0,A.jsxs)(`h1`,{className:`max-w-xl text-4xl font-extrabold leading-[1.12] tracking-tight text-white sm:text-5xl lg:text-[3.35rem]`,children:[`Your Admission`,(0,A.jsx)(`span`,{className:`mt-1 block bg-gradient-to-r from-[#38bdf8] via-[#08a8d5] to-[#00c2ff] bg-clip-text text-transparent drop-shadow-[0_4px_24px_rgba(8,168,213,0.35)]`,children:`Journey, Simplified.`})]}),(0,A.jsx)(`p`,{className:`mt-5 max-w-lg text-sm leading-relaxed text-blue-100/85 sm:text-base`,children:`Get complete, transparent guidance through profile assessment, university shortlisting, documentation, visa processing, and continuous post-admission on-campus support.`}),(0,A.jsxs)(`div`,{className:`mt-8 flex flex-wrap items-center gap-4`,children:[(0,A.jsxs)(`a`,{href:`#enquiry`,className:`inline-flex items-center gap-2.5 rounded-xl bg-gradient-to-r from-[#079ac7] via-[#08a8d5] to-[#00c2ff] px-7 py-3.5 text-sm font-extrabold text-white shadow-[0_12px_28px_-6px_rgba(8,168,213,0.5)] transition duration-300 hover:-translate-y-1 hover:shadow-[0_16px_36px_-4px_rgba(8,168,213,0.65)] hover:brightness-105`,children:[`Get Free Counselling`,(0,A.jsx)($n,{size:17})]}),(0,A.jsxs)(`a`,{href:`https://wa.me/${oh}`,target:`_blank`,rel:`noreferrer`,className:`inline-flex items-center gap-2 rounded-xl border border-white/20 bg-white/5 px-6 py-3.5 text-sm font-bold text-white backdrop-blur-sm transition duration-300 hover:border-white/40 hover:bg-white/10`,children:[(0,A.jsx)(kr,{size:17,className:`text-[#38bdf8]`}),`Chat on WhatsApp`]})]}),(0,A.jsxs)(`div`,{className:`mt-10 grid grid-cols-2 gap-4 border-t border-white/10 pt-6 sm:grid-cols-3`,children:[(0,A.jsxs)(`div`,{className:`flex items-center gap-2.5`,children:[(0,A.jsx)(`div`,{className:`flex h-8 w-8 items-center justify-center rounded-lg bg-[#08a8d5]/15 text-[#38bdf8]`,children:(0,A.jsx)(Pr,{size:16})}),(0,A.jsx)(`span`,{className:`text-xs font-semibold text-blue-100/90`,children:`100% Free Guidance`})]}),(0,A.jsxs)(`div`,{className:`flex items-center gap-2.5`,children:[(0,A.jsx)(`div`,{className:`flex h-8 w-8 items-center justify-center rounded-lg bg-[#08a8d5]/15 text-[#38bdf8]`,children:(0,A.jsx)(yr,{size:16})}),(0,A.jsx)(`span`,{className:`text-xs font-semibold text-blue-100/90`,children:`NMC & WHO Verified`})]}),(0,A.jsxs)(`div`,{className:`flex items-center gap-2.5`,children:[(0,A.jsx)(`div`,{className:`flex h-8 w-8 items-center justify-center rounded-lg bg-[#08a8d5]/15 text-[#38bdf8]`,children:(0,A.jsx)(Mr,{size:16})}),(0,A.jsx)(`span`,{className:`text-xs font-semibold text-blue-100/90`,children:`Visa & Travel Assist`})]})]})]}),(0,A.jsxs)($.div,{initial:{opacity:0,scale:.95,y:14},animate:{opacity:1,scale:1,y:0},transition:{duration:.65,delay:.15},className:`relative mx-auto w-full max-w-[440px]`,children:[(0,A.jsxs)(`div`,{className:`ke-card-sheen relative rounded-[26px] border border-[#08a8d5]/35 bg-gradient-to-br from-[#072654]/95 via-[#08336d]/90 to-[#073b82]/95 p-6 shadow-[0_24px_60px_-10px_rgba(3,18,44,0.6)] backdrop-blur-xl sm:p-7`,children:[(0,A.jsxs)(`div`,{className:`relative flex items-center justify-between border-b border-white/10 pb-4`,children:[(0,A.jsxs)(`div`,{children:[(0,A.jsx)(`p`,{className:`text-[10px] font-extrabold uppercase tracking-[0.16em] text-[#38bdf8]`,children:`ADMISSION SUPPORT`}),(0,A.jsx)(`h2`,{className:`mt-1 text-xl font-extrabold text-white`,children:`7 Simple Steps`})]}),(0,A.jsx)(`div`,{className:`flex h-11 w-11 items-center justify-center rounded-xl border border-[#08a8d5]/30 bg-[#08a8d5]/15 text-[#38bdf8] shadow-[0_4px_14px_rgba(8,168,213,0.25)]`,children:(0,A.jsx)(yr,{size:22})})]}),(0,A.jsxs)(`div`,{className:`relative mt-5 space-y-2.5`,children:[(0,A.jsx)(`div`,{className:`absolute bottom-5 left-[19px] top-4 w-0.5 bg-gradient-to-b from-[#08a8d5]/50 via-[#38bdf8]/30 to-transparent`,"aria-hidden":`true`}),sh.slice(0,4).map(e=>(0,A.jsxs)(`div`,{className:`group relative flex items-center gap-3 rounded-xl border border-white/5 bg-white/[0.04] px-3.5 py-2.5 transition duration-200 hover:border-[#08a8d5]/35 hover:bg-white/[0.08]`,children:[(0,A.jsx)(`span`,{className:`relative z-10 flex h-7 w-7 shrink-0 items-center justify-center rounded-lg border border-[#08a8d5]/40 bg-[#08a8d5]/20 text-[11px] font-extrabold text-[#38bdf8] shadow-[0_2px_8px_rgba(8,168,213,0.3)]`,children:e.number}),(0,A.jsx)(`span`,{className:`text-xs font-semibold text-blue-50`,children:e.title}),(0,A.jsx)(ar,{size:14,className:`ml-auto shrink-0 text-[#38bdf8]`})]},e.number))]}),(0,A.jsxs)(`div`,{className:`relative mt-4 flex items-center gap-2 rounded-xl border border-[#08a8d5]/25 bg-[#08a8d5]/10 px-3.5 py-3 text-xs font-medium leading-5 text-blue-100`,children:[(0,A.jsx)(lr,{size:15,className:`shrink-0 text-[#38bdf8]`}),(0,A.jsx)(`span`,{children:`Complete guidance from counselling to post-admission settlement.`})]})]}),(0,A.jsx)(`div`,{className:`pointer-events-none absolute -bottom-4 left-1/2 h-10 w-[85%] -translate-x-1/2 rounded-full bg-[#08a8d5]/20 blur-2xl`})]})]})}),(0,A.jsx)(`div`,{className:`relative h-px w-full bg-gradient-to-r from-transparent via-[#08a8d5]/40 to-transparent`})]}),(0,A.jsx)(`section`,{className:`bg-white px-5 py-16 sm:px-8 lg:px-10 lg:py-24`,children:(0,A.jsxs)(`div`,{className:`mx-auto max-w-7xl`,children:[(0,A.jsx)(dh,{eyebrow:`ADMISSION PROCESS`,title:`A Clear Path From Counselling to Admission`,description:`Our structured 7-step admission process is designed to provide complete clarity and transparency at every milestone.`}),(0,A.jsxs)(`div`,{className:`relative mt-14`,children:[(0,A.jsx)(`div`,{className:`absolute bottom-6 left-5 top-6 w-0.5 bg-gradient-to-b from-[#08a8d5] via-[#073b82] to-[#08a8d5] sm:left-6`}),(0,A.jsx)(`div`,{className:`space-y-6`,children:sh.map((e,t)=>{let n=e.icon;return(0,A.jsxs)($.div,{initial:{opacity:0,x:-18},whileInView:{opacity:1,x:0},viewport:{once:!0,amount:.25},transition:{duration:.45,delay:t*.05},className:`relative flex gap-4 pl-12 sm:pl-16`,children:[(0,A.jsx)(`span`,{className:`absolute left-0 top-0 flex h-10 w-10 items-center justify-center rounded-full border-2 border-[#08a8d5] bg-white text-[12px] font-extrabold text-[#09285f] shadow-[0_4px_14px_rgba(8,168,213,0.25)] sm:h-12 sm:w-12 sm:text-[13px]`,children:e.number}),(0,A.jsx)(`div`,{className:`flex-1 rounded-2xl border border-[#e2ecf5] bg-white p-5 shadow-[0_8px_24px_-6px_rgba(9,40,95,0.06)] transition duration-300 hover:-translate-y-1 hover:border-[#08a8d5]/40 hover:shadow-[0_16px_36px_-6px_rgba(8,168,213,0.14)] sm:p-6`,children:(0,A.jsxs)(`div`,{className:`flex items-start gap-4`,children:[(0,A.jsx)(`div`,{className:`flex h-11 w-11 shrink-0 items-center justify-center rounded-xl border border-[#08a8d5]/20 bg-[#f0f8fd] text-[#08a8d5]`,children:(0,A.jsx)(n,{size:21})}),(0,A.jsxs)(`div`,{children:[(0,A.jsx)(`h3`,{className:`text-base font-extrabold text-[#09285f] sm:text-lg`,children:e.title}),(0,A.jsx)(`p`,{className:`mt-1.5 text-sm leading-relaxed text-[#556987]`,children:e.text})]})]})})]},e.number)})})]})]})}),(0,A.jsx)(`div`,{className:`relative h-px w-full bg-gradient-to-r from-transparent via-[#08a8d5]/20 to-transparent`}),(0,A.jsx)(`section`,{className:`bg-[#f8fbff] px-5 py-16 sm:px-8 lg:px-10 lg:py-24`,children:(0,A.jsxs)(`div`,{className:`mx-auto max-w-7xl`,children:[(0,A.jsx)(dh,{eyebrow:`REQUIRED DOCUMENTS`,title:`Documents You May Need`,description:`Keep the following original documents and photocopies ready for hassle-free MBBS application and visa processing:`}),(0,A.jsx)(`div`,{className:`mt-12 grid gap-4 sm:grid-cols-2 lg:grid-cols-3`,children:ch.map((e,t)=>(0,A.jsxs)($.div,{initial:{opacity:0,y:14},whileInView:{opacity:1,y:0},viewport:{once:!0,amount:.15},transition:{duration:.4,delay:t*.04},className:`group relative flex items-center gap-3.5 overflow-hidden rounded-2xl border border-[#e2ecf5] bg-white p-4.5 shadow-sm transition-all duration-300 hover:-translate-y-1 hover:border-[#08a8d5]/45 hover:shadow-[0_12px_28px_-6px_rgba(8,168,213,0.15)]`,children:[(0,A.jsx)(`span`,{className:`ke-corner-fold`}),(0,A.jsx)(`div`,{className:`flex h-9 w-9 shrink-0 items-center justify-center rounded-xl border border-[#08a8d5]/20 bg-[#f0f8fd] text-[#08a8d5] transition group-hover:bg-[#08a8d5] group-hover:text-white`,children:(0,A.jsx)(ar,{size:16})}),(0,A.jsx)(`span`,{className:`text-sm font-bold text-[#09285f]`,children:e})]},e))})]})}),(0,A.jsx)(`div`,{className:`relative h-px w-full bg-gradient-to-r from-transparent via-[#08a8d5]/20 to-transparent`}),(0,A.jsx)(`section`,{className:`bg-white px-5 py-16 sm:px-8 lg:px-10 lg:py-24`,children:(0,A.jsxs)(`div`,{className:`mx-auto max-w-7xl`,children:[(0,A.jsx)(dh,{eyebrow:`ENQUIRY PROCESS`,title:`Connect With Kantule Edutech`,description:`Choose your preferred channel to consult directly with our senior medical admission counsellors:`}),(0,A.jsx)(`div`,{className:`mt-12 grid gap-5 sm:grid-cols-2 lg:grid-cols-4`,children:lh.map((e,t)=>{let n=e.icon;return(0,A.jsxs)($.div,{initial:{opacity:0,y:18},whileInView:{opacity:1,y:0},viewport:{once:!0,amount:.2},transition:{duration:.4,delay:t*.06},className:`group flex flex-col justify-between rounded-2xl border border-[#e2ecf5] bg-white p-6 text-center shadow-[0_8px_24px_-6px_rgba(9,40,95,0.06)] transition-all duration-300 hover:-translate-y-1.5 hover:border-[#08a8d5]/45 hover:shadow-[0_16px_36px_-6px_rgba(8,168,213,0.16)]`,children:[(0,A.jsxs)(`div`,{children:[(0,A.jsx)(`div`,{className:`mx-auto flex h-14 w-14 items-center justify-center rounded-2xl border border-[#08a8d5]/20 bg-[#f0f8fd] text-[#08a8d5] transition-all duration-300 group-hover:border-transparent group-hover:bg-gradient-to-br group-hover:from-[#079ac7] group-hover:to-[#08a8d5] group-hover:text-white group-hover:shadow-[0_8px_20px_rgba(8,168,213,0.35)]`,children:(0,A.jsx)(n,{size:24})}),(0,A.jsx)(`h3`,{className:`mt-4 text-base font-extrabold text-[#09285f]`,children:e.title}),(0,A.jsx)(`p`,{className:`mt-1 text-xs text-[#556987]`,children:e.subtitle})]}),(0,A.jsxs)(`a`,{href:e.action,className:`mt-5 inline-flex items-center justify-center gap-1.5 text-xs font-bold text-[#079ac7] transition group-hover:text-[#08a8d5]`,children:[(0,A.jsx)(`span`,{children:e.actionText}),(0,A.jsx)($n,{size:13})]})]},e.title)})})]})}),(0,A.jsxs)(`section`,{id:`enquiry`,className:`relative overflow-hidden bg-gradient-to-br from-[#061938] via-[#09285f] to-[#073b82] px-5 py-16 sm:px-8 lg:px-10 lg:py-24`,children:[(0,A.jsx)(`div`,{className:`ke-dot-grid`}),(0,A.jsx)(`div`,{className:`pointer-events-none absolute -right-24 -top-24 h-80 w-80 rounded-full bg-[#08a8d5]/15 blur-3xl`}),(0,A.jsx)(`div`,{className:`pointer-events-none absolute -bottom-24 -left-24 h-80 w-80 rounded-full bg-[#073b82]/30 blur-3xl`}),(0,A.jsxs)(`div`,{className:`relative mx-auto grid max-w-7xl gap-12 lg:grid-cols-[0.88fr_1.12fr] lg:items-center`,children:[(0,A.jsxs)($.div,{initial:{opacity:0,x:-22},whileInView:{opacity:1,x:0},viewport:{once:!0,amount:.2},transition:{duration:.5},children:[(0,A.jsxs)(`div`,{className:`inline-flex items-center gap-2 rounded-full border border-[#08a8d5]/40 bg-white/5 px-4 py-2 text-[11px] font-bold uppercase tracking-[0.14em] text-[#38bdf8] backdrop-blur-md`,children:[(0,A.jsx)(kr,{size:14,className:`text-[#08a8d5]`}),`Free Medical Counselling`]}),(0,A.jsxs)(`h2`,{className:`mt-5 text-3xl font-extrabold leading-tight text-white sm:text-4xl lg:text-[2.65rem]`,children:[`Get Expert`,(0,A.jsx)(`span`,{className:`block bg-gradient-to-r from-[#38bdf8] to-[#00c2ff] bg-clip-text text-transparent`,children:`MBBS Counselling`})]}),(0,A.jsx)(`p`,{className:`mt-4 max-w-lg text-sm leading-relaxed text-blue-100/85 sm:text-base`,children:`Please fill in your details below and our senior medical admission director will connect with you shortly for a personalized roadmap.`}),(0,A.jsx)(`div`,{className:`mt-8 space-y-3.5`,children:[`Personalized NEET score analysis & college matching`,`Transparent tuition fee & hostel breakdown`,`Direct university admission & documentation support`,`Instant WhatsApp enquiry & status tracking`].map(e=>(0,A.jsxs)(`div`,{className:`flex items-center gap-3 text-sm font-medium text-white`,children:[(0,A.jsx)(`span`,{className:`flex h-6 w-6 shrink-0 items-center justify-center rounded-full border border-[#08a8d5]/30 bg-[#08a8d5]/20 text-[#38bdf8]`,children:(0,A.jsx)(ar,{size:14})}),(0,A.jsx)(`span`,{children:e})]},e))})]}),(0,A.jsx)($.div,{initial:{opacity:0,y:22},whileInView:{opacity:1,y:0},viewport:{once:!0,amount:.2},transition:{duration:.5,delay:.1},className:`rounded-[26px] border border-[#08a8d5]/30 bg-white/[0.07] p-6 shadow-[0_24px_60px_-10px_rgba(3,18,44,0.6)] backdrop-blur-xl sm:p-8`,children:(0,A.jsxs)(`form`,{onSubmit:t=>{if(t.preventDefault(),!e.name||!e.mobile||!e.score||!e.interestedIn)return;let n=`Hello Kantule Edutech,
...
NEET Score: ${e.score}
Interested In: ${e.interestedIn}`,i=`https://wa.me/${oh}?text=${encodeURIComponent(n)}`;r(!0),window.open(i,`_blank`,`noopener,noreferrer`)},className:`space-y-4.5`,children:[(0,A.jsxs)(`div`,{className:`grid gap-4.5 sm:grid-cols-2`,children:[(0,A.jsx)(fh,{label:`Student Name *`,name:`name`,type:`text`,placeholder:`e.g. Rahul Sharma`,value:e.name,onChange:i}),(0,A.jsx)(fh,{label:`Mobile Number (WhatsApp) *`,name:`mobile`,type:`tel`,placeholder:`e.g. 8830451660`,value:e.mobile,onChange:i}),(0,A.jsx)(fh,{label:`NEET Score / Expected Score *`,name:`score`,type:`text`,placeholder:`e.g. 450 / Qualified`,value:e.score,onChange:i}),(0,A.jsxs)(`div`,{children:[(0,A.jsx)(`label`,{className:`mb-2 block text-xs font-bold text-white/90`,children:`Interested Destination *`}),(0,A.jsxs)(`select`,{name:`interestedIn`,value:e.interestedIn,onChange:i,required:!0,className:`h-12 w-full rounded-xl border border-white/15 bg-white/10 px-4 text-sm text-white outline-none transition focus:border-[#08a8d5] focus:ring-4 focus:ring-[#08a8d5]/20`,children:[(0,A.jsx)(`option`,{value:``,className:`text-[#09285f]`,children:`Select Destination Program`}),(0,A.jsx)(`option`,{value:`MBBS in India`,className:`text-[#09285f]`,children:`MBBS in India`}),(0,A.jsx)(`option`,{value:`MBBS in Russia`,className:`text-[#09285f]`,children:`MBBS in Russia`}),(0,A.jsx)(`option`,{value:`MBBS in Kyrgyzstan`,className:`text-[#09285f]`,children:`MBBS in Kyrgyzstan`}),(0,A.jsx)(`option`,{value:`MBBS in Kazakhstan`,className:`text-[#09285f]`,children:`MBBS in Kazakhstan`}),(0,A.jsx)(`option`,{value:`MBBS in Georgia`,className:`text-[#09285f]`,children:`MBBS in Georgia`}),(0,A.jsx)(`option`,{value:`MBBS in Vietnam`,className:`text-[#09285f]`,children:`MBBS in Vietnam`}),(0,A.jsx)(`option`,{value:`MBBS in Nepal`,className:`text-[#09285f]`,children:`MBBS in Nepal`}),(0,A.jsx)(`option`,{value:`MBBS in Philippines`,className:`text-[#09285f]`,children:`MBBS in Philippines`}),(0,A.jsx)(`option`,{value:`MBBS in USA & Other Destinations`,className:`text-[#09285f]`,children:`MBBS in USA & Other Destinations`})]})]})]}),(0,A.jsx)(`button`,{type:`submit`,className:`mt-6 flex h-13 w-full items-center justify-center gap-2.5 rounded-xl bg-gradient-to-r from-[#079ac7] via-[#08a8d5] to-[#00c2ff] px-5 py-3.5 text-sm font-extrabold text-white shadow-[0_12px_28px_rgba(8,168,213,0.45)] transition duration-300 hover:-translate-y-0.5 hover:shadow-[0_16px_36px_rgba(8,168,213,0.6)] hover:brightness-105`,children:n?(0,A.jsxs)(A.Fragment,{children:[(0,A.jsx)(ar,{size:18}),(0,A.jsx)(`span`,{children:`Enquiry Sent to WhatsApp`})]}):(0,A.jsxs)(A.Fragment,{children:[(0,A.jsx)(`span`,{children:`Get Free Counselling`}),(0,A.jsx)(Nr,{size:17})]})}),(0,A.jsx)(`p`,{className:`mt-3 text-center text-[11px] leading-5 text-blue-100/60`,children:`Your enquiry will be connected directly with our senior counselling team via WhatsApp.`})]})})]})]}),(0,A.jsx)(`section`,{className:`bg-[#f8fbff] px-5 py-12 sm:px-8 lg:px-10`,children:(0,A.jsx)(`div`,{className:`mx-auto max-w-5xl`,children:(0,A.jsxs)(`div`,{className:`flex flex-col items-center justify-between gap-5 rounded-[24px] border border-[#e2ecf5] bg-white p-6 text-center shadow-[0_8px_24px_-6px_rgba(9,40,95,0.06)] sm:flex-row sm:p-8 sm:text-left`,children:[(0,A.jsxs)(`div`,{children:[(0,A.jsx)(`h3`,{className:`text-xl font-extrabold text-[#09285f]`,children:`Need immediate admission assistance?`}),(0,A.jsx)(`p`,{className:`mt-1 text-sm text-[#556987]`,children:`Connect with our medical counselling directors on WhatsApp for real-time answers.`})]}),(0,A.jsxs)(`a`,{href:`https://wa.me/${oh}`,target:`_blank`,rel:`noreferrer`,className:`inline-flex shrink-0 items-center gap-2 rounded-full bg-[#16C47F] px-6 py-3.5 text-sm font-extrabold text-white shadow-[0_10px_25px_rgba(22,196,127,0.3)] transition duration-300 hover:-translate-y-1 hover:shadow-[0_14px_30px_rgba(22,196,127,0.45)]`,children:[(0,A.jsx)(kr,{size:18}),`WhatsApp Us`,(0,A.jsx)($n,{size:16})]})]})})})]})}function dh({eyebrow:e,title:t,description:n}){return(0,A.jsxs)(`div`,{className:`mx-auto max-w-2xl text-center`,children:[(0,A.jsxs)(`div`,{className:`inline-flex items-center gap-2 text-[11px] font-extrabold uppercase tracking-[0.16em] text-[#079ac7]`,children:[(0,A.jsx)(`span`,{className:`h-1.5 w-1.5 rounded-full bg-[#08a8d5]`}),e]}),(0,A.jsx)(`h2`,{className:`mt-2.5 text-2xl font-extrabold tracking-tight text-[#09285f] sm:text-3xl lg:text-4xl`,children:t}),n&&(0,A.jsx)(`p`,{className:`mt-3 text-sm leading-relaxed text-[#556987] sm:text-base`,children:n})]})}function fh({label:e,name:t,type:n,placeholder:r,value:i,onChange:a}){return(0,A.jsxs)(`div`,{children:[(0,A.jsx)(`label`,{className:`mb-2 block text-xs font-bold text-white/90`,children:e}),(0,A.jsx)(`input`,{type:n,name:t,value:i,onChange:a,placeholder:r,required:!0,className:`h-12 w-full rounded-xl border border-white/15 bg-white/10 px-4 text-sm text-white outline-none transition placeholder:text-blue-100/40 focus:border-[#08a8d5] focus:ring-4 focus:ring-[#08a8d5]/20`})]})}var ph=[{id:`KE01`,image:`/assets/KE01-DJEZ5Z-S.jpeg`},{id:`KE02`,image:`/assets/KE02-CYqwQ_Vh.jpeg`},{id:`KE03`,image:`/assets/KE03-DkBq-Ynh.jpeg`},{id:`KE04`,image:`/assets/KE04-BoqOmXK2.jpeg`},{id:`KE05`,image:`/assets/KE05-DZBfeybC.jpeg`},{id:`KE06`,image:`/assets/KE06-P0rrgIUE.jpeg`},{id:`KE07`,image:`/assets/KE07-B5x_r1r4.jpeg`},{id:`KE08`,image:`/assets/KE08-CTNKD4qQ.jpeg`},{id:`KE09`,image:`/assets/KE09-BqvwRfpd.jpeg`},{id:`KE10`,image:`/assets/KE10-DUPMqWlG.jpeg`},{id:`KE11`,image:`/assets/KE11-YFFoUlkj.jpeg`},{id:`KE12`,image:`/assets/KE12-LLp1Q4Ae.jpeg`},{id:`KE13`,image:`/assets/KE13-BnmsqCyD.jpeg`},{id:`KE14`,image:`/assets/KE14-CImgDnAX.jpeg`},{id:`KE15`,image:`/assets/KE15-Bgf68Klj.jpeg`},{id:`KE17`,image:`/assets/KE17-C1apDUNX.jpeg`},{id:`KE18`,image:`/assets/KE18-iJiDGf40.jpeg`},{id:`KE20`,image:`/assets/KE20-CQGu0hDM.jpeg`},{id:`KE22`,image:`/assets/KE22-C5IpsPOM.jpeg`},{id:`KE23`,image:`/assets/KE23-BrFz3o1M.jpeg`},{id:`KE24`,image:`/assets/KE24-2R3phRmD.jpeg`},{id:`KE25`,image:`/assets/KE25-FkyJ9-H9.jpeg`},{id:`KE26`,image:`/assets/KE26-CAA6ZnYf.jpeg`},{id:`KE27`,image:`/assets/KE27-SXuAYZ85.jpeg`}],mh=`918830451660`;function hh(){let[e,t]=(0,x.useState)(null);(0,x.useEffect)(()=>{window.scrollTo(0,0)},[]),(0,x.useEffect)(()=>{let n=n=>{e!==null&&(n.key===`Escape`&&t(null),n.key===`ArrowRight`&&t(e=>(e+1)%ph.length),n.key===`ArrowLeft`&&t(e=>e===0?ph.length-1:e-1))};return window.addEventListener(`keydown`,n),()=>{window.removeEventListener(`keydown`,n)}},[e]),(0,x.useEffect)(()=>(document.body.style.overflow=e===null?``:`hidden`,()=>{document.body.style.overflow=``}),[e]);let n=e=>{t(e)},r=()=>{t(null)};return(0,A.jsxs)(`main`,{className:`min-h-screen bg-[#f7fbff]`,children:[(0,A.jsxs)(`section`,{className:`relative overflow-hidden bg-gradient-to-br from-[#061D38] via-[#082F5B] to-[#087DB8]`,children:[(0,A.jsxs)(`div`,{className:`pointer-events-none absolute inset-0`,children:[(0,A.jsx)(`div`,{className:`
              absolute
              -left-24
              -top-24
              h-72
            ...
            lg:px-10
            lg:py-24
          `,children:(0,A.jsxs)(`div`,{className:`mx-auto max-w-3xl text-center`,children:[(0,A.jsx)($.div,{initial:{opacity:0,scale:.8},animate:{opacity:1,scale:1},transition:{duration:.5},className:`
                mx-auto
                mb-6
                flex
                h-12
                ...
                shadow-lg
                backdrop-blur-md
              `,children:(0,A.jsx)(`span`,{className:`text-xl`,children:`✦`})}),(0,A.jsxs)($.h1,{initial:{opacity:0,y:20},animate:{opacity:1,y:0},transition:{duration:.6},className:`
                text-3xl
                font-extrabold
                leading-[1.08]
                tracking-tight
                ...
                md:text-5xl
                lg:text-6xl
              `,children:[`Moments That Reflect`,` `,(0,A.jsx)(`span`,{className:`
                  bg-gradient-to-r
                  from-cyan-300
                  via-[#16B9D9]
                  to-white
                  bg-clip-text
                  text-transparent
                `,children:`Our Journey`})]}),(0,A.jsx)($.p,{initial:{opacity:0,y:20},animate:{opacity:1,y:0},transition:{duration:.6,delay:.1},className:`
                mx-auto
                mt-5
                max-w-2xl
                text-sm
                ...
                sm:text-base
                lg:text-lg
              `,children:`A glimpse into the people, experiences and moments that make the Kantule Edutech journey special.`})]})})]}),(0,A.jsx)(`section`,{className:`
          mx-auto
          max-w-7xl
          px-4
          py-10
          ...
          lg:px-10
          lg:py-16
        `,children:(0,A.jsx)($.div,{initial:{opacity:0},animate:{opacity:1},transition:{duration:.6},className:`
            columns-1
            gap-4
            sm:columns-2
            sm:gap-5
            lg:columns-3
            lg:gap-6
          `,children:ph.map((e,t)=>(0,A.jsx)($.button,{type:`button`,initial:{opacity:0,y:25},animate:{opacity:1,y:0},transition:{duration:.45,delay:Math.min(t*.035,.5)},onClick:()=>n(t),className:`
                group
                relative
                mb-4
                block
              ...
              `,children:(0,A.jsxs)(`div`,{className:`
                  ...
                  rounded-[14px]
                  bg-slate-100
                `,children:[(0,A.jsx)(`img`,{src:e.image,alt:`Kantule Edutech ${e.id}`,loading:t<6?`eager`:`lazy`,className:`
                    block
                    h-auto
                    min-h-[180px]
                    w-full
                  ...
                  `,children:(0,A.jsx)(`span`,{className:`
                    ...
                    `,children:(0,A.jsx)(Dr,{size:15})})})]})},e.id))})}),(0,A.jsx)(`div`,{className:`flex justify-center px-4 pb-12 sm:pb-16`,children:(0,A.jsxs)(`div`,{className:`
            flex
            items-center
            gap-3
            rounded-full
            ...
            py-2.5
            shadow-sm
          `,children:[(0,A.jsxs)(`div`,{className:`flex -space-x-2`,children:[(0,A.jsx)(`span`,{className:`
                h-6
                w-6
                rounded-full
                border-2
              ...
              font-semibold
              text-slate-600
            `,children:[ph.length,` moments`]})]})}),(0,A.jsx)(vf,{children:e!==null&&(0,A.jsxs)($.div,{initial:{opacity:0},animate:{opacity:1},exit:{opacity:0},onClick:r,className:`
              fixed
              inset-0
              z-[9999]
              flex
              ...
              backdrop-blur-md
              sm:p-6
            `,children:[(0,A.jsx)(`button`,{type:`button`,onClick:r,"aria-label":`Close image`,className:`
                absolute
                right-4
                top-4
                z-[10000]
                ...
                sm:right-6
                sm:top-6
              `,children:(0,A.jsx)(Vr,{size:21})}),ph.length>1&&(0,A.jsx)(`button`,{type:`button`,onClick:e=>{e.stopPropagation(),t(e=>e===0?ph.length-1:e-1)},"aria-label":`Previous image`,className:`
                  absolute
                  left-2
                  top-1/2
                  z-[10000]
                  ...
                  hover:bg-white/25
                  sm:left-6
                `,children:(0,A.jsx)(sr,{size:25})}),ph.length>1&&(0,A.jsx)(`button`,{type:`button`,onClick:e=>{e.stopPropagation(),t(e=>(e+1)%ph.length)},"aria-label":`Next image`,className:`
                  absolute
                  right-2
                  top-1/2
                  z-[10000]
                  ...
                  hover:bg-white/25
                  sm:right-6
                `,children:(0,A.jsx)(cr,{size:25})}),(0,A.jsxs)($.div,{initial:{opacity:0,scale:.92},animate:{opacity:1,scale:1},exit:{opacity:0,scale:.92},transition:{duration:.25},onClick:e=>e.stopPropagation(),className:`
                relative
                flex
                max-h-[92vh]
                max-w-6xl
                ...
                shadow-2xl
                sm:rounded-3xl
              `,children:[(0,A.jsx)(`img`,{src:ph[e].image,alt:`Kantule Edutech ${ph[e].id}`,className:`
                  max-h-[92vh]
                  max-w-full
                  object-contain
                `}),(0,A.jsxs)(`div`,{className:`
                  ...
                  text-white
                  backdrop-blur-md
                `,children:[e+1,` / `,ph.length]})]})]})}),(0,A.jsx)(`section`,{className:`
          mx-auto
          max-w-7xl
          px-4
          pb-16
        ...
        `,children:(0,A.jsxs)(`div`,{className:`
          ...
          `,children:[(0,A.jsx)(`div`,{className:`
            ...
            `}),(0,A.jsxs)(`div`,{className:`
              ...
              lg:items-center
              lg:justify-between
            `,children:[(0,A.jsxs)(`div`,{className:`max-w-2xl`,children:[(0,A.jsx)(`div`,{className:`
                  mb-4
                  flex
                  h-10
                  w-10
                  ...
                  bg-white/10
                  text-cyan-300
                `,children:(0,A.jsx)(`span`,{className:`text-lg`,children:`✦`})}),(0,A.jsx)(`h2`,{className:`
                  text-2xl
                  font-bold
                  leading-tight
                  sm:text-3xl
                  lg:text-4xl
                `,children:`Start Your Medical Journey`}),(0,A.jsx)(`p`,{className:`
                  mt-3
                  text-sm
                  leading-relaxed
                  text-slate-200
                  sm:text-base
                `,children:`Get personalized MBBS counselling, university selection and step-by-step admission guidance.`})]}),(0,A.jsxs)(`div`,{className:`
                flex
                flex-col
                gap-3
                sm:flex-row
              `,children:[(0,A.jsxs)(jn,{to:`/contact`,className:`
                  inline-flex
                  items-center
                  justify-center
                  gap-2
                ...
                `,children:[`Book Free Counselling`,(0,A.jsx)($n,{size:16})]}),(0,A.jsxs)(`a`,{href:`https://wa.me/${mh}`,target:`_blank`,rel:`noreferrer`,className:`
                  inline-flex
                  items-center
                  justify-center
                  gap-2
                  ...
                  transition-all
                  hover:bg-white/20
                `,children:[(0,A.jsx)(kr,{size:16}),`WhatsApp Us`]})]})]})]})})]})}var gh={color:void 0,size:void 0,className:void 0,style:void 0,attr:void 0},_h=x.createContext&&x.createContext(gh),vh=[`attr`,`size`,`title`];function yh(e,t){if(e==null)return{};var n,r,i=bh(e,t);if(Object.getOwnPropertySymbols){var a=Object.getOwnPropertySymbols(e);for(r=0;r<a.length;r++)n=a[r],t.indexOf(n)===-1&&{}.propertyIsEnumerable.call(e,n)&&(i[n]=e[n])}return i}function bh(e,t){if(e==null)return{};var n={};for(var r in e)if({}.hasOwnProperty.call(e,r)){if(t.indexOf(r)!==-1)continue;n[r]=e[r]}return n}function xh(){return xh=Object.assign?Object.assign.bind():function(e){for(var t=1;t<arguments.length;t++){var n=arguments[t];for(var r in n)({}).hasOwnProperty.call(n,r)&&(e[r]=n[r])}return e},xh.apply(null,arguments)}function Sh(e,t){var n=Object.keys(e);if(Object.getOwnPropertySymbols){var r=Object.getOwnPropertySymbols(e);t&&(r=r.filter(function(t){return Object.getOwnPropertyDescriptor(e,t).enumerable})),n.push.apply(n,r)}return n}function Ch(e){for(var t=1;t<arguments.length;t++){var n=arguments[t]==null?{}:arguments[t];t%2?Sh(Object(n),!0).forEach(function(t){wh(e,t,n[t])}):Object.getOwnPropertyDescriptors?Object.defineProperties(e,Object.getOwnPropertyDescriptors(n)):Sh(Object(n)).forEach(function(t){Object.defineProperty(e,t,Object.getOwnPropertyDescriptor(n,t))})}return e}function wh(e,t,n){return(t=Th(t))in e?Object.defineProperty(e,t,{value:n,enumerable:!0,configurable:!0,writable:!0}):e[t]=n,e}function Th(e){var t=Eh(e,`string`);return typeof t==`symbol`?t:t+``}function Eh(e,t){if(typeof e!=`object`||!e)return e;var n=e[Symbol.toPrimitive];if(n!==void 0){var r=n.call(e,t||`default`);if(typeof r!=`object`)return r;throw TypeError(`@@toPrimitive must return a primitive value.`)}return(t===`string`?String:Number)(e)}function Dh(e){return e&&e.map((e,t)=>x.createElement(e.tag,Ch({key:t},e.attr),Dh(e.child)))}function Oh(e){return t=>x.createElement(kh,xh({attr:Ch({},e.attr)},t),Dh(e.child))}function kh(e){var t=t=>{var n=e.attr,r=e.size,i=e.title,a=yh(e,vh),o=r||t.size||`1em`,s;return t.className&&(s=t.className),e.className&&(s=(s?s+` `:``)+e.className),x.createElement(`svg`,xh({stroke:`currentColor`,fill:`currentColor`,strokeWidth:`0`},t.attr,n,a,{className:s,style:Ch(Ch({color:e.color||t.color},t.style),e.style),height:o,width:o,xmlns:`http://www.w3.org/2000/svg`}),i&&x.createElement(`title`,null,i),e.children)};return _h===void 0?t(gh):x.createElement(_h.Consumer,null,e=>t(e))}function Ah(e){return Oh({tag:`svg`,attr:{viewBox:`0 0 448 512`},child:[{tag:`path`,attr:{d:`M224.1 141c-63.6 0-114.9 51.3-114.9 114.9s51.3 114.9 114.9 114.9S339 319.5 339 255.9 287.7 141 224.1 141zm0 189.6c-41.1 0-74.7-33.5-74.7-74.7s33.5-74.7 74.7-74.7 74.7 33.5 74.7 74.7-33.6 74.7-74.7 74.7zm146.4-194.3c0 14.9-12 26.8-26.8 26.8-14.9 0-26.8-12-26.8-26.8s12-26.8 26.8-26.8 26.8 12 26.8 26.8zm76.1 27.2c-1.7-35.9-9.9-67.7-36.2-93.9-26.2-26.2-58-34.4-93.9-36.2-37-2.1-147.9-2.1-184.9 0-35.8 1.7-67.6 9.9-93.9 36.1s-34.4 58-36.2 93.9c-2.1 37-2.1 147.9 0 184.9 1.7 35.9 9.9 67.7 36.2 93.9s58 34.4 93.9 36.2c37 2.1 147.9 2.1 184.9 0 35.9-1.7 67.7-9.9 93.9-36.2 26.2-26.2 34.4-58 36.2-93.9 2.1-37 2.1-147.8 0-184.8zM398.8 388c-7.8 19.6-22.9 34.7-42.6 42.6-29.5 11.7-99.5 9-132.1 9s-102.7 2.6-132.1-9c-19.6-7.8-34.7-22.9-42.6-42.6-11.7-29.5-9-99.5-9-132.1s-2.6-102.7 9-132.1c7.8-19.6 22.9-34.7 42.6-42.6 29.5-11.7 99.5-9 132.1-9s102.7-2.6 132.1 9c19.6 7.8 34.7 22.9 42.6 42.6 11.7 29.5 9 99.5 9 132.1s2.7 102.7-9 132.1z`},child:[]}]})(e)}function jh(e){return Oh({tag:`svg`,attr:{viewBox:`0 0 320 512`},child:[{tag:`path`,attr:{d:`M279.14 288l14.22-92.66h-88.91v-60.13c0-25.35 12.42-50.06 52.24-50.06h40.42V6.26S260.43 0 225.36 0c-73.22 0-121.08 44.38-121.08 124.72v70.62H22.89V288h81.39v224h100.17V288z`},child:[]}]})(e)}function Mh(){let e=`8830451660`,t=`8237794917`;(0,x.useEffect)(()=>{window.scrollTo({top:0,left:0,behavior:`instant`})},[]);let n=e=>{e.preventDefault();let t=new FormData(e.currentTarget),n=`Hello Kantule Edutech,
...
I would like to get free MBBS counselling.`;window.open(`https://wa.me/918830451660?text=${encodeURIComponent(n)}`,`_blank`,`noopener,noreferrer`)},r=[{type:`HEAD OFFICE`,title:`Kantule Edutech`,icon:rr,address:`Rukmini Complex, Pachod Road, Ambad, District Jalna, Maharashtra – 431204`,mapQuery:`Rukmini Complex, Pachod Road, Ambad, Jalna, Maharashtra 431204`,mapSearch:`https://www.google.com/maps/search/?api=1&query=Rukmini+Complex,+Pachod+Road,+Ambad,+Jalna,+Maharashtra+431204`,directions:`https://www.google.com/maps/dir/?api=1&destination=Rukmini+Complex,+Pachod+Road,+Ambad,+Jalna,+Maharashtra+431204`,accent:`blue`},{type:`BRANCH OFFICE`,title:`Beed Branch`,icon:Er,address:`Akshay Jewellers, Pangari Rd, near Umakiran Complex, Beed, Maharashtra – 431122, India`,mapQuery:`Akshay Jewellers, Pangari Rd, near Umakiran Complex, Beed, Maharashtra 431122`,mapSearch:`https://www.google.com/maps/search/?api=1&query=Akshay+Jewellers,+Pangari+Rd,+near+Umakiran+Complex,+Beed,+Maharashtra+431122`,directions:`https://www.google.com/maps/dir/?api=1&destination=Akshay+Jewellers,+Pangari+Rd,+near+Umakiran+Complex,+Beed,+Maharashtra+431122`,accent:`cyan`},{type:`BRANCH OFFICE`,title:`Chhatrapati Sambhaji Nagar`,icon:Er,address:`Prozone Mall, C-11, 3rd Floor, Prozone Trade Centre, Chhatrapati Sambhaji Nagar, Maharashtra – 431210, India`,mapQuery:`Prozone Mall, C-11, 3rd Floor, Prozone Trade Centre, Chhatrapati Sambhaji Nagar, Maharashtra 431210`,mapSearch:`https://www.google.com/maps/search/?api=1&query=Prozone+Mall,+C-11,+3rd+Floor,+Prozone+Trade+Centre,+Chhatrapati+Sambhaji+Nagar,+Maharashtra+431210`,directions:`https://www.google.com/maps/dir/?api=1&destination=Prozone+Mall,+C-11,+3rd+Floor,+Prozone+Trade+Centre,+Chhatrapati+Sambhaji+Nagar,+Maharashtra+431210`,accent:`blue`}];return(0,A.jsxs)(A.Fragment,{children:[(0,A.jsx)(`style`,{children:`
        * {
          box-sizing: border-box;
        }
      ...
      `}),(0,A.jsxs)(`main`,{className:`contact-page`,children:[(0,A.jsx)(`section`,{className:`contact-hero`,children:(0,A.jsx)(`div`,{className:`contact-container`,children:(0,A.jsxs)($.div,{initial:{opacity:0,y:18},animate:{opacity:1,y:0},transition:{duration:.5},children:[(0,A.jsxs)(`div`,{className:`contact-eyebrow`,children:[(0,A.jsx)(Ir,{}),`Contact Us`]}),(0,A.jsxs)(`h1`,{children:[`Let’s Start Your`,` `,(0,A.jsx)(`span`,{children:`Medical Journey.`})]}),(0,A.jsx)(`p`,{children:`Connect with Kantule Edutech for MBBS admission guidance, counselling and support in India and abroad.`})]})})}),(0,A.jsx)(`section`,{className:`contact-main`,children:(0,A.jsxs)(`div`,{className:`contact-container`,children:[(0,A.jsxs)(`div`,{className:`contact-grid`,children:[(0,A.jsxs)($.div,{className:`contact-info-card`,initial:{opacity:0,y:22},whileInView:{opacity:1,y:0},viewport:{once:!0,amount:.15},transition:{duration:.5},children:[(0,A.jsxs)(`div`,{className:`section-label`,children:[(0,A.jsx)(Pr,{size:14}),`Official Admission Support`]}),(0,A.jsx)(`h2`,{className:`section-title`,children:`Get in Touch With Us`}),(0,A.jsxs)(`div`,{className:`company-box`,children:[(0,A.jsx)(`div`,{className:`company-icon`,children:(0,A.jsx)(rr,{size:22})}),(0,A.jsxs)(`div`,{children:[(0,A.jsx)(`strong`,{children:`Kantule Edutech Pvt. Ltd.`}),(0,A.jsx)(`span`,{children:`Medical Education & Career Guidance`})]})]}),(0,A.jsxs)(`div`,{className:`info-list`,children:[(0,A.jsxs)(`div`,{className:`info-item`,children:[(0,A.jsx)(`div`,{className:`info-icon`,children:(0,A.jsx)(Er,{size:18})}),(0,A.jsxs)(`div`,{className:`info-content`,children:[(0,A.jsx)(`small`,{children:`Head Office Address`}),(0,A.jsx)(`p`,{children:`Rukmini Complex, Pachod Road, Ambad, District Jalna, Maharashtra – 431204`})]})]}),(0,A.jsxs)(`div`,{className:`info-item`,children:[(0,A.jsx)(`div`,{className:`info-icon`,children:(0,A.jsx)(jr,{size:18})}),(0,A.jsxs)(`div`,{className:`info-content`,children:[(0,A.jsx)(`small`,{children:`Call Direct Line`}),(0,A.jsxs)(`div`,{className:`phone-links`,children:[(0,A.jsxs)(`a`,{href:`tel:${e}`,children:[`+91 `,e]}),(0,A.jsxs)(`a`,{href:`tel:${t}`,children:[`+91 `,t]})]})]})]}),(0,A.jsxs)(`div`,{className:`info-item`,children:[(0,A.jsx)(`div`,{className:`info-icon`,children:(0,A.jsx)(kr,{size:18})}),(0,A.jsxs)(`div`,{className:`info-content`,children:[(0,A.jsx)(`small`,{children:`WhatsApp Enquiry`}),(0,A.jsxs)(`div`,{className:`phone-links`,children:[(0,A.jsxs)(`a`,{href:`https://wa.me/91${e}`,target:`_blank`,rel:`noreferrer`,children:[`+91 `,e]}),(0,A.jsxs)(`a`,{href:`https://wa.me/91${t}`,target:`_blank`,rel:`noreferrer`,children:[`+91 `,t]})]})]})]}),(0,A.jsxs)(`div`,{className:`info-item`,children:[(0,A.jsx)(`div`,{className:`info-icon`,children:(0,A.jsx)(Tr,{size:18})}),(0,A.jsxs)(`div`,{className:`info-content`,children:[(0,A.jsx)(`small`,{children:`Official Email`}),(0,A.jsx)(`p`,{children:(0,A.jsx)(`a`,{href:`mailto:kantuleedutech@gmail.com`,children:`kantuleedutech@gmail.com`})})]})]}),(0,A.jsxs)(`div`,{className:`info-item`,children:[(0,A.jsx)(`div`,{className:`info-icon`,children:(0,A.jsx)(fr,{size:18})}),(0,A.jsxs)(`div`,{className:`info-content`,children:[(0,A.jsx)(`small`,{children:`Office Working Hours`}),(0,A.jsx)(`p`,{children:`Mon – Sat: 9:30 AM – 7:30 PM (Sun by Appointment)`})]})]})]})]}),(0,A.jsxs)($.div,{className:`contact-form-card`,initial:{opacity:0,y:22},whileInView:{opacity:1,y:0},viewport:{once:!0,amount:.15},transition:{duration:.5,delay:.1},children:[(0,A.jsxs)(`div`,{className:`form-top`,children:[(0,A.jsxs)(`div`,{className:`section-label`,children:[(0,A.jsx)(Nr,{size:13}),`Free Medical Counselling`]}),(0,A.jsx)(`h2`,{children:`Get Expert MBBS Counselling`}),(0,A.jsx)(`p`,{children:`Please fill in your details below and our senior medical admission director will connect with you shortly.`})]}),(0,A.jsxs)(`form`,{className:`contact-form`,onSubmit:n,children:[(0,A.jsxs)(`div`,{className:`field`,children:[(0,A.jsx)(`label`,{htmlFor:`name`,children:`Student Name *`}),(0,A.jsx)(`input`,{id:`name`,name:`name`,type:`text`,placeholder:`e.g. Rahul Sharma`,required:!0})]}),(0,A.jsxs)(`div`,{className:`field`,children:[(0,A.jsx)(`label`,{htmlFor:`mobile`,children:`Mobile Number (WhatsApp) *`}),(0,A.jsx)(`input`,{id:`mobile`,name:`mobile`,type:`tel`,placeholder:`e.g. 8830451660`,required:!0})]}),(0,A.jsxs)(`div`,{className:`field`,children:[(0,A.jsx)(`label`,{htmlFor:`neet`,children:`NEET Score / Expected Score`}),(0,A.jsx)(`input`,{id:`neet`,name:`neet`,type:`text`,placeholder:`e.g. 450 / Qualified / Appearing`,required:!0})]}),(0,A.jsxs)(`div`,{className:`field`,children:[(0,A.jsx)(`label`,{htmlFor:`interested`,children:`Interested Destination *`}),(0,A.jsxs)(`select`,{id:`interested`,name:`interested`,defaultValue:``,required:!0,children:[(0,A.jsx)(`option`,{value:``,disabled:!0,children:`Select Destination Program`}),(0,A.jsx)(`option`,{value:`MBBS in India`,children:`MBBS in India`}),(0,A.jsx)(`option`,{value:`MBBS in Russia`,children:`MBBS in Russia`}),(0,A.jsx)(`option`,{value:`MBBS in Kyrgyzstan`,children:`MBBS in Kyrgyzstan`}),(0,A.jsx)(`option`,{value:`MBBS in Kazakhstan`,children:`MBBS in Kazakhstan`}),(0,A.jsx)(`option`,{value:`MBBS in Georgia`,children:`MBBS in Georgia`}),(0,A.jsx)(`option`,{value:`MBBS in Vietnam`,children:`MBBS in Vietnam`}),(0,A.jsx)(`option`,{value:`MBBS in Nepal`,children:`MBBS in Nepal`}),(0,A.jsx)(`option`,{value:`MBBS in Philippines`,children:`MBBS in Philippines`}),(0,A.jsx)(`option`,{value:`MBBS in USA & Other Destinations`,children:`MBBS in USA & Other Destinations`})]})]}),(0,A.jsxs)(`button`,{type:`submit`,className:`submit-btn`,children:[(0,A.jsx)(`span`,{children:`Get Free Counselling`}),(0,A.jsx)($n,{size:17})]})]}),(0,A.jsxs)(`div`,{className:`whatsapp-note`,children:[(0,A.jsx)(lr,{size:15}),(0,A.jsx)(`span`,{children:`Instant 1-on-1 response delivered via WhatsApp.`})]})]})]}),(0,A.jsxs)(`section`,{className:`locations-section`,children:[(0,A.jsxs)($.div,{className:`locations-heading`,initial:{opacity:0,y:18},whileInView:{opacity:1,y:0},viewport:{once:!0,amount:.2},transition:{duration:.45},children:[(0,A.jsxs)(`div`,{className:`section-label`,children:[(0,A.jsx)(Er,{size:14}),`Our Locations`]}),(0,A.jsx)(`h2`,{children:`Find Kantule Edutech Near You`}),(0,A.jsx)(`p`,{children:`Visit our offices for personalised counselling and medical admission guidance.`})]}),(0,A.jsx)(`div`,{className:`locations-grid`,children:r.map((e,t)=>{let n=e.icon;return(0,A.jsxs)($.article,{className:`location-card`,initial:{opacity:0,y:22},whileInView:{opacity:1,y:0},viewport:{once:!0,amount:.12},transition:{duration:.45,delay:t*.08},children:[(0,A.jsxs)(`div`,{className:`location-card-top`,children:[(0,A.jsx)(`div`,{className:`location-card-icon`,children:(0,A.jsx)(n,{size:21})}),(0,A.jsxs)(`div`,{className:`location-heading-content`,children:[(0,A.jsx)(`div`,{className:`location-type`,children:e.type}),(0,A.jsx)(`h3`,{children:e.title})]})]}),(0,A.jsxs)(`div`,{className:`location-address-box`,children:[(0,A.jsx)(Er,{className:`location-address-icon`,size:17}),(0,A.jsx)(`div`,{className:`location-address-text`,children:e.address})]}),(0,A.jsxs)(`div`,{className:`location-map-wrapper`,children:[(0,A.jsxs)(`div`,{className:`map-floating-label`,children:[(0,A.jsx)(Ar,{size:12}),`Location`]}),(0,A.jsx)(`iframe`,{className:`location-map`,title:`${e.title} map`,src:`https://www.google.com/maps?q=${encodeURIComponent(e.mapQuery)}&output=embed`,loading:`lazy`,referrerPolicy:`no-referrer-when-downgrade`})]}),(0,A.jsxs)(`div`,{className:`location-actions`,children:[(0,A.jsxs)(`a`,{href:e.mapSearch,target:`_blank`,rel:`noreferrer`,className:`location-map-btn`,children:[(0,A.jsx)(Ar,{size:14}),`View Map`,(0,A.jsx)(hr,{size:12})]}),(0,A.jsxs)(`a`,{href:e.directions,target:`_blank`,rel:`noreferrer`,className:`location-directions-btn`,children:[(0,A.jsx)($n,{size:14}),`Directions`]})]})]},e.title)})})]}),(0,A.jsxs)(`div`,{className:`details-strip`,children:[(0,A.jsxs)($.div,{className:`detail-card`,initial:{opacity:0,y:16},whileInView:{opacity:1,y:0},viewport:{once:!0,amount:.2},transition:{duration:.4},children:[(0,A.jsxs)(`h3`,{children:[(0,A.jsx)(Tr,{size:18}),`Official Email`]}),(0,A.jsx)(`p`,{children:(0,A.jsx)(`a`,{href:`mailto:kantuleedutech@gmail.com`,style:{color:`inherit`,textDecoration:`none`},children:`kantuleedutech@gmail.com`})})]}),(0,A.jsxs)($.div,{className:`detail-card`,initial:{opacity:0,y:16},whileInView:{opacity:1,y:0},viewport:{once:!0,amount:.2},transition:{duration:.4,delay:.08},children:[(0,A.jsxs)(`h3`,{children:[(0,A.jsx)(fr,{size:18}),`Office Hours`]}),(0,A.jsx)(`p`,{children:`Mon – Sat: 9:30 AM – 7:30 PM (Sunday by Appointment)`})]}),(0,A.jsxs)($.div,{className:`detail-card`,initial:{opacity:0,y:16},whileInView:{opacity:1,y:0},viewport:{once:!0,amount:.2},transition:{duration:.4,delay:.16},children:[(0,A.jsxs)(`h3`,{children:[(0,A.jsx)(mr,{size:18}),`Social Media`]}),(0,A.jsxs)(`div`,{className:`social-row`,children:[(0,A.jsxs)(`a`,{href:`https://www.instagram.com/kantuleedutechh/`,target:`_blank`,rel:`noreferrer`,className:`social-link-item`,children:[(0,A.jsx)(Ah,{size:14}),`@kantuleedutechh`]}),(0,A.jsxs)(`a`,{href:`https://www.facebook.com/swapyworld/`,target:`_blank`,rel:`noreferrer`,className:`social-link-item`,children:[(0,A.jsx)(jh,{size:14}),`Kantule Edutech Facebook`]})]})]})]})]})})]})]})}var Nh={ihsm:`https://th.bing.com/th/id/OIP.vSeOPrF6sN5qo0WpP9k8rQHaFj?w=233&h=180&c=7&r=0&o=7&dpr=1.3&pid=1.7&rm=3`,"kyrgyzstan-ihsm":`https://th.bing.com/th/id/OIP.vSeOPrF6sN5qo0WpP9k8rQHaFj?w=233&h=180&c=7&r=0&o=7&dpr=1.3&pid=1.7&rm=3`,ism:`https://th.bing.com/th/id/OIP.Sg0aEC4YLGauCD6krfC7RgHaFf?w=231&h=180&c=7&r=0&o=7&dpr=1.3&pid=1.7&rm=3`,"kyrgyzstan-ism":`https://th.bing.com/th/id/OIP.Sg0aEC4YLGauCD6krfC7RgHaFf?w=231&h=180&c=7&r=0&o=7&dpr=1.3&pid=1.7&rm=3`,"ksmu-kg":`https://th.bing.com/th/id/OIP.cnbM7eiEOkgs1qI-4SusbAHaE7?w=255&h=180&c=7&r=0&o=7&dpr=1.3&pid=1.7&rm=3`,ksma:`https://th.bing.com/th/id/OIP.cnbM7eiEOkgs1qI-4SusbAHaE7?w=255&h=180&c=7&r=0&o=7&dpr=1.3&pid=1.7&rm=3`,"kyrgyzstan-ksmu-kg":`https://th.bing.com/th/id/OIP.cnbM7eiEOkgs1qI-4SusbAHaE7?w=255&h=180&c=7&r=0&o=7&dpr=1.3&pid=1.7&rm=3`,"ust-manila":`https://i.pinimg.com/originals/f5/a8/b3/f5a8b368eeb595552172066fe20600df.jpg`,"university-of-santo-tomas":`https://i.pinimg.com/originals/f5/a8/b3/f5a8b368eeb595552172066fe20600df.jpg`,"up-manila":`https://th.bing.com/th/id/OIP.cR84ZeNJRaEsg2MPc8bQ3wHaFj?w=198&h=180&c=7&r=0&o=7&dpr=1.3&pid=1.7&rm=3`,"up-manila-college-of-medicine":`https://th.bing.com/th/id/OIP.cR84ZeNJRaEsg2MPc8bQ3wHaFj?w=198&h=180&c=7&r=0&o=7&dpr=1.3&pid=1.7&rm=3`,"tribhuvan-iom":`https://th.bing.com/th/id/OIP.97VIS6CI6q0r8nLiqPjIqwHaFj?w=215&h=180&c=7&r=0&o=7&dpr=1.3&pid=1.7&rm=3`},Ph=[{id:`kyrgyzstan-osh-state-university`,name:`Osh State University`,country:`Kyrgyzstan`,city:`Osh`,image:Nm},{id:`kyrgyzstan-asian-medical-institute`,name:`Asian Medical Institute`,country:`Kyrgyzstan`,city:`Kant`,image:Pm}],Fh=[{id:`tribhuvan-iom`,name:`Tribhuvan University Institute of Medicine`,country:`Nepal`,city:`Kathmandu`,image:`https://images.unsplash.com/photo-1523050854058-8df90110c9f1?auto=format&fit=crop&w=1200&q=80`}];function Ih(e){return e?String(e).trim().toLowerCase().replace(/^india-/,``).replace(/^russia-/,``).replace(/^kyrgyzstan-/,``).replace(/^kazakhstan-/,``).replace(/^georgia-/,``).replace(/^vietnam-/,``).replace(/^nepal-/,``).replace(/^philippines-/,``).replace(/^usa-/,``):``}function Lh(e,t){let n=e?.id||t?.id||``,r=String(n).trim().toLowerCase(),i=Ih(n);return Nh[r]?Nh[r]:Nh[i]?Nh[i]:e?.image?e.image:t?.image?t.image:``}function Rh(e,t){if(!e)return null;let n=String(e.location||``).trim().split(`,`).map(e=>e.trim()).filter(Boolean),r=n.length>1?n.slice(0,-1).join(`, `):n[0]||``,i=n.length>1?n[n.length-1]:``;return{id:t,name:e.name||`University`,country:i||`International`,city:r,image:e.image||``}}var zh=83;function Bh(e){if(!e)return null;let t=String(e).match(/\$?\s*([\d,]+(?:\.\d+)?)/);if(!t)return null;let n=Number(t[1].replace(/,/g,``));return Number.isFinite(n)?Math.round(n*zh).toLocaleString(`en-IN`):null}function Vh({value:e}){let t=Bh(e);return(0,A.jsxs)(`div`,{children:[(0,A.jsx)(`div`,{children:e}),t&&(0,A.jsxs)(`div`,{className:`mt-1 text-xs sm:text-sm font-semibold text-[#1455A0]`,children:[`≈ ₹`,t]})]})}function Hh(e){if(!e)return 5;let t=String(e);return/6\s*Years/i.test(t)?6:(/5\s*to\s*6\s*Years/i.test(t)||/5\s*Years/i.test(t),5)}function Uh(e){return e===1?`1st Year`:e===2?`2nd Year`:e===3?`3rd Year`:`${e}th Year`}function Wh(e,t){if(!e)return null;let n=e.tuition;if(!n)return null;let r=String(n);if(/1st\s*Year\s*:/i.test(r)){if(t===1){let e=r.match(/1st\s*Year\s*:\s*([^|]+)/i);return e?e[1].trim():r}let e=r.match(/2nd[–-](?:5th|6th)\s*Year\s*:\s*([^|]+)/i)||r.match(/2nd[–-]6th\s*Year\s*:\s*([^|]+)/i);return e?e[1].trim():r}return r}function Gh(e,t){let n=e?.fees;return n?.tuition?Wh(n,t):e?.annualTuitionFee||n?.annualTuitionFee||null}function Kh(e){let t=e?.fees;return t?t.hostelAndMess?t.hostelAndMess:t.hostel&&t.food?`${t.hostel} + ${t.food}`:t.hostel||t.food||null:null}function qh(e){return!!(e?.fees?.tuition||e?.fees?.annualTuitionFee||e?.annualTuitionFee)}function Jh({title:e,icon:t,children:n}){return(0,A.jsxs)(`div`,{className:`bg-white p-6 sm:p-8 rounded-2xl sm:rounded-3xl border border-[#e2edf8] shadow-[0_8px_30px_rgba(11,45,92,0.03)]`,children:[(0,A.jsxs)(`div`,{className:`flex items-center gap-3`,children:[t&&(0,A.jsx)(`div`,{className:`w-10 h-10 rounded-xl bg-[#eef7fc] text-[#1455A0] flex items-center justify-center`,children:(0,A.jsx)(t,{size:19})}),(0,A.jsx)(`h2`,{className:`text-xl sm:text-2xl font-bold text-[#0B2D5C]`,children:e})]}),(0,A.jsx)(`div`,{className:`w-12 h-1 bg-[#18B8D4] rounded mt-3 mb-5`}),n]})}function Yh(){let{universityId:e}=yt(),[t,n]=(0,x.useState)(!1),[r,i]=(0,x.useState)(null);(0,x.useEffect)(()=>{window.scrollTo({top:0,behavior:`instant`}),n(!1),i(null)},[e]);let a=(0,x.useMemo)(()=>[...jm,...Ph,...Fh],[]),o=Ih(e),s=Im(e);!s&&o&&(s=Im(o));let c=a.find(t=>t.id===e);if(!c&&o&&(c=a.find(e=>Ih(e.id)===o)),!c&&s&&(c=Rh(s,e)),!s||!c)return(0,A.jsx)(`div`,{className:`min-h-[70vh] flex flex-col items-center justify-center bg-[#f8fbfe] px-4 py-16 text-center`,children:(0,A.jsxs)($.div,{initial:{opacity:0,y:30},animate:{opacity:1,y:0},transition:{duration:.5},className:`max-w-md w-full bg-white p-8 sm:p-10 rounded-3xl border border-[#dce8f5] shadow-[0_10px_40px_rgba(11,45,92,0.06)]`,children:[(0,A.jsx)(`div`,{className:`w-16 h-16 rounded-2xl bg-[#eef7fc] text-[#1455A0] flex items-center justify-center mx-auto mb-6 border border-[#d2e7f8]`,children:(0,A.jsx)(rr,{size:32,className:`text-[#18B8D4]`})}),(0,A.jsx)(`h2`,{className:`text-2xl sm:text-3xl font-extrabold text-[#0B2D5C] tracking-tight`,children:`University Not Found`}),(0,A.jsx)(`p`,{className:`mt-3.5 text-sm sm:text-base text-slate-500 leading-relaxed`,children:`The university you are looking for does not exist or may have been updated. Please return to the homepage to explore all choices.`}),(0,A.jsx)(`div`,{className:`mt-8`,children:(0,A.jsxs)(jn,{to:`/`,className:`inline-flex items-center justify-center gap-2 px-7 py-3.5 rounded-full bg-gradient-to-r from-[#0B2D5C] to-[#1455A0] hover:shadow-lg hover:shadow-blue-900/20 text-white text-sm font-bold transition-all duration-200`,children:[(0,A.jsx)(Qn,{size:16}),`Back to Universities`]})})]})});let l=Lh(c,s),u=s.image||c.image||``,d=t&&u&&u!==l?u:l,f=c.city&&c.country?`${c.city}, ${c.country}`:s.location||c.country||`Location not available`,p=encodeURIComponent(`Hi, I want to get admission details for ${c.name} in ${c.country}. Please guide me.`),m=[...s.gallery?.main||[],...s.gallery?.campus||[]],h=Hh(s.duration||s.courseDuration);return(0,A.jsxs)(`div`,{className:`bg-[#f8fbfe] min-h-screen pb-16 sm:pb-24`,children:[(0,A.jsx)(`div`,{className:`bg-white border-b border-slate-100 py-4 sm:py-5 sticky top-0 z-30 shadow-[0_1px_3px_rgba(11,45,92,0.02)]`,children:(0,A.jsx)(`div`,{className:`max-w-[1240px] mx-auto px-4 sm:px-6 lg:px-8`,children:(0,A.jsxs)(jn,{to:`/`,className:`inline-flex items-center gap-2 text-xs sm:text-sm font-bold text-[#1455A0] hover:text-[#0B2D5C] transition-colors duration-150`,children:[(0,A.jsx)(Qn,{size:16}),(0,A.jsx)(`span`,{children:`Back to Universities`})]})})}),(0,A.jsx)(`section`,{className:`bg-gradient-to-b from-white to-[#f8fbfe] pt-8 sm:pt-12 pb-6 border-b border-slate-100`,children:(0,A.jsx)(`div`,{className:`max-w-[1240px] mx-auto px-4 sm:px-6 lg:px-8`,children:(0,A.jsxs)($.div,{initial:{opacity:0,y:15},animate:{opacity:1,y:0},transition:{duration:.4},children:[(0,A.jsxs)(`div`,{className:`inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-white border border-[#d6e6f5] text-[#1455A0] text-xs font-extrabold tracking-widest uppercase mb-4 shadow-sm`,children:[(0,A.jsx)(`span`,{className:`w-2 h-2 rounded-full bg-[#18B8D4]`}),c.country]}),(0,A.jsx)(`h1`,{className:`text-2xl sm:text-3xl lg:text-4xl font-extrabold text-[#0B2D5C] leading-tight`,children:c.name}),(0,A.jsxs)(`div`,{className:`mt-3 flex flex-wrap items-center gap-y-2 gap-x-4 text-sm text-slate-500 font-medium`,children:[(0,A.jsxs)(`div`,{className:`flex items-center gap-1.5`,children:[(0,A.jsx)(Er,{size:15,className:`text-[#18B8D4] shrink-0`}),(0,A.jsx)(`span`,{children:f})]}),s.established&&(0,A.jsxs)(`div`,{className:`flex items-center gap-1.5`,children:[(0,A.jsx)(ir,{size:15,className:`text-[#18B8D4]`}),(0,A.jsxs)(`span`,{children:[`Established`,` `,s.established]})]}),s.duration&&(0,A.jsxs)(`div`,{className:`flex items-center gap-1.5`,children:[(0,A.jsx)(pr,{size:15,className:`text-[#18B8D4]`}),(0,A.jsx)(`span`,{children:s.duration})]})]}),(0,A.jsxs)(`div`,{className:`mt-4 flex flex-wrap gap-2`,children:[s.type&&(0,A.jsxs)(`span`,{className:`inline-flex items-center gap-1.5 px-3 py-1 rounded-full text-xs font-semibold bg-[#eef7fc] text-[#0B2D5C] border border-[#d2e7f8]`,children:[(0,A.jsx)(rr,{size:12}),s.type]}),s.recognition&&(0,A.jsxs)(`span`,{className:`inline-flex items-center gap-1.5 px-3 py-1 rounded-full text-xs font-semibold bg-[#e6faf0] text-[#047857] border border-[#a7f3d0]`,children:[(0,A.jsx)(Fr,{size:12}),s.recognition]})]})]})})}),(0,A.jsx)(`main`,{className:`max-w-[1240px] mx-auto px-4 sm:px-6 lg:px-8 mt-8 sm:mt-10`,children:(0,A.jsxs)(`div`,{className:`grid grid-cols-1 lg:grid-cols-12 gap-8 items-start`,children:[(0,A.jsxs)($.div,{initial:{opacity:0,x:-20},animate:{opacity:1,x:0},transition:{duration:.5,delay:.1},className:`lg:col-span-8 space-y-6 sm:space-y-8`,children:[(0,A.jsx)(`div`,{className:`bg-white rounded-2xl sm:rounded-3xl border border-[#e2edf8] shadow-[0_8px_30px_rgba(11,45,92,0.03)] overflow-hidden`,children:(0,A.jsx)(`div`,{className:`relative aspect-[16/9] w-full overflow-hidden bg-[#f0f6fc]`,children:d?(0,A.jsx)(`img`,{src:d,alt:c.name,onError:()=>{if(u&&u!==l){n(!0);return}n(!0)},className:`w-full h-full object-cover`}):(0,A.jsxs)(`div`,{className:`w-full h-full flex flex-col items-center justify-center bg-gradient-to-br from-[#0B2D5C] to-[#1455A0] text-white p-8 text-center`,children:[(0,A.jsx)(rr,{size:48,className:`text-[#18B8D4] mb-3`}),(0,A.jsx)(`h3`,{className:`text-xl font-bold`,children:c.name}),(0,A.jsx)(`p`,{className:`text-sm text-cyan-200 mt-1`,children:c.country})]})})}),s.description&&(0,A.jsx)(Jh,{title:`University Overview`,icon:tr,children:(0,A.jsx)(`p`,{className:`text-slate-600 text-sm sm:text-base leading-relaxed whitespace-pre-line`,children:s.description})}),s.highlights?.length>0&&(0,A.jsx)(Jh,{title:`Key Highlights`,icon:lr,children:(0,A.jsx)(`div`,{className:`grid sm:grid-cols-2 gap-3`,children:s.highlights.map((e,t)=>(0,A.jsxs)(`div`,{className:`flex items-start gap-3 rounded-xl bg-slate-50 p-4 border border-slate-100`,children:[(0,A.jsx)(lr,{size:17,className:`text-[#18B8D4] shrink-0 mt-0.5`}),(0,A.jsx)(`span`,{className:`text-sm text-slate-600`,children:e})]},t))})}),s.advantages?.length>0&&(0,A.jsx)(Jh,{title:`Advantages`,icon:Fr,children:(0,A.jsx)(`div`,{className:`grid sm:grid-cols-2 gap-3`,children:s.advantages.map((e,t)=>(0,A.jsxs)(`div`,{className:`flex items-start gap-3 rounded-xl bg-slate-50 p-4 border border-slate-100`,children:[(0,A.jsx)(lr,{size:17,className:`text-[#18B8D4] shrink-0 mt-0.5`}),(0,A.jsx)(`span`,{className:`text-sm text-slate-600`,children:e})]},t))})}),s.courseStructure?.length>0&&(0,A.jsxs)(Jh,{title:`Course Structure`,icon:yr,children:[s.courseStructureDescription&&(0,A.jsx)(`p`,{className:`text-sm text-slate-600 leading-relaxed mb-5`,children:s.courseStructureDescription}),(0,A.jsx)(`div`,{className:`space-y-3`,children:s.courseStructure.map((e,t)=>(0,A.jsx)(`div`,{className:`rounded-xl border border-slate-100 bg-slate-50 p-4`,children:(0,A.jsxs)(`div`,{className:`flex items-start gap-3`,children:[(0,A.jsx)(`div`,{className:`w-10 h-10 rounded-lg bg-[#eef7fc] text-[#1455A0] flex items-center justify-center shrink-0`,children:(0,A.jsx)(tr,{size:17})}),(0,A.jsxs)(`div`,{children:[(0,A.jsx)(`p`,{className:`text-sm font-extrabold text-[#0B2D5C]`,children:e.year}),(0,A.jsx)(`p`,{className:`mt-1 text-sm text-slate-600 leading-relaxed`,children:e.description})]})]})},t))})]}),qh(s)&&(0,A.jsx)(Jh,{title:`Year-wise Tuition`,icon:Br,children:(0,A.jsx)(`div`,{className:`overflow-x-auto -mx-1 px-1`,children:(0,A.jsxs)(`table`,{className:`w-full min-w-[520px] border-collapse`,children:[(0,A.jsx)(`thead`,{children:(0,A.jsxs)(`tr`,{className:`border-b border-slate-200`,children:[(0,A.jsx)(`th`,{className:`px-3 py-3 text-left text-[11px] sm:text-xs font-extrabold text-slate-500 uppercase tracking-wide`,children:`Year`}),(0,A.jsx)(`th`,{className:`px-3 py-3 text-right text-[11px] sm:text-xs font-extrabold text-slate-500 uppercase tracking-wide`,children:`College Fees`}),(0,A.jsx)(`th`,{className:`px-3 py-3 text-right text-[11px] sm:text-xs font-extrabold text-slate-500 uppercase tracking-wide`,children:`Hostel + Mess`})]})}),(0,A.jsx)(`tbody`,{children:Array.from({length:h}).map((e,t)=>{let n=t+1,r=Gh(s,n),i=Kh(s);return!r&&!i?null:(0,A.jsxs)(`tr`,{className:`border-b border-slate-100 last:border-0`,children:[(0,A.jsx)(`td`,{className:`px-3 py-4 text-sm font-extrabold text-[#0B2D5C] whitespace-nowrap`,children:Uh(n)}),(0,A.jsx)(`td`,{className:`px-3 py-4 text-right text-sm font-bold text-[#1455A0] whitespace-nowrap`,children:r?(0,A.jsx)(Vh,{value:r}):`—`}),(0,A.jsx)(`td`,{className:`px-3 py-4 text-right text-sm font-bold text-[#1455A0] whitespace-nowrap`,children:i||`—`})]},n)})})]})})}),s.recognitionDetails?.length>0&&(0,A.jsx)(Jh,{title:`Recognition & Accreditation`,icon:Fr,children:(0,A.jsx)(`div`,{className:`grid sm:grid-cols-2 gap-3`,children:s.recognitionDetails.map((e,t)=>(0,A.jsxs)(`div`,{className:`flex items-start gap-3 rounded-xl bg-slate-50 p-4 border border-slate-100`,children:[(0,A.jsx)(lr,{size:17,className:`text-[#18B8D4] shrink-0 mt-0.5`}),(0,A.jsx)(`span`,{className:`text-sm text-slate-600`,children:e})]},t))})}),s.campusFacilities?.length>0&&(0,A.jsx)(Jh,{title:`Campus Facilities`,icon:rr,children:(0,A.jsx)(`div`,{className:`grid sm:grid-cols-2 gap-3`,children:s.campusFacilities.map((e,t)=>(0,A.jsxs)(`div`,{className:`flex items-start gap-3 rounded-xl bg-slate-50 p-4 border border-slate-100`,children:[(0,A.jsx)(lr,{size:17,className:`text-[#18B8D4] shrink-0 mt-0.5`}),(0,A.jsx)(`span`,{className:`text-sm text-slate-600`,children:e})]},t))})}),s.hostelFacilities?.length>0&&(0,A.jsx)(Jh,{title:`Hostel Facilities`,icon:rr,children:(0,A.jsx)(`div`,{className:`grid sm:grid-cols-2 gap-3`,children:s.hostelFacilities.map((e,t)=>(0,A.jsxs)(`div`,{className:`flex items-start gap-3 rounded-xl bg-slate-50 p-4 border border-slate-100`,children:[(0,A.jsx)(lr,{size:17,className:`text-[#18B8D4] shrink-0 mt-0.5`}),(0,A.jsx)(`span`,{className:`text-sm text-slate-600`,children:e})]},t))})}),s.staff?.length>0&&(0,A.jsx)(Jh,{title:`Staff`,icon:yr,children:(0,A.jsx)(`div`,{className:`grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-4`,children:s.staff.map((e,t)=>(0,A.jsxs)(`div`,{className:`rounded-2xl overflow-hidden bg-slate-50 border border-slate-100`,children:[e.image&&(0,A.jsx)(`img`,{src:e.image,alt:e.name,loading:`lazy`,className:`w-full aspect-square object-cover`}),(0,A.jsxs)(`div`,{className:`p-3`,children:[(0,A.jsx)(`p`,{className:`text-sm font-bold text-[#0B2D5C] leading-snug`,children:e.name}),(0,A.jsx)(`p`,{className:`mt-1 text-xs text-slate-500 leading-5`,children:e.role})]})]},`${e.name}-${t}`))})}),m.length>0&&(0,A.jsx)(Jh,{title:`University Gallery`,icon:Sr,children:(0,A.jsx)(`div`,{className:`grid grid-cols-2 sm:grid-cols-3 gap-3`,children:m.map((e,t)=>(0,A.jsx)(`button`,{type:`button`,onClick:()=>i(e),className:`group relative overflow-hidden rounded-2xl border border-slate-100 bg-slate-50 aspect-[4/3]`,children:(0,A.jsx)(`img`,{src:e,alt:`${c.name} gallery ${t+1}`,loading:`lazy`,className:`w-full h-full object-cover transition-transform duration-300 group-hover:scale-105`})},`${e}-${t}`))})}),s.faqs?.length>0&&(0,A.jsx)(Jh,{title:`Frequently Asked Questions`,icon:ur,children:(0,A.jsx)(`div`,{className:`space-y-3`,children:s.faqs.map((e,t)=>(0,A.jsxs)(`details`,{className:`group rounded-xl border border-slate-100 bg-slate-50 p-4`,children:[(0,A.jsxs)(`summary`,{className:`cursor-pointer list-none flex items-start justify-between gap-4`,children:[(0,A.jsx)(`span`,{className:`text-sm font-bold text-[#0B2D5C]`,children:e.q}),(0,A.jsx)(`span`,{className:`text-[#18B8D4] text-lg leading-none`,children:`+`})]}),(0,A.jsx)(`p`,{className:`mt-3 text-sm text-slate-600 leading-relaxed`,children:e.a})]},t))})})]}),(0,A.jsxs)($.div,{initial:{opacity:0,x:20},animate:{opacity:1,x:0},transition:{duration:.5,delay:.15},className:`lg:col-span-4 lg:sticky lg:top-24 space-y-5`,children:[(0,A.jsxs)(`div`,{className:`bg-white p-6 sm:p-7 rounded-2xl sm:rounded-3xl border border-[#e2edf8] shadow-[0_8px_30px_rgba(11,45,92,0.04)]`,children:[(0,A.jsx)(`h3`,{className:`text-lg sm:text-xl font-bold text-[#0B2D5C]`,children:`Quick Information`}),(0,A.jsx)(`div`,{className:`w-10 h-1 bg-[#18B8D4] rounded mt-2 mb-5`}),(0,A.jsxs)(`div`,{className:`space-y-3`,children:[s.course&&(0,A.jsxs)(`div`,{className:`flex items-center gap-4 p-3 bg-slate-50 rounded-xl border border-slate-100`,children:[(0,A.jsx)(`div`,{className:`w-10 h-10 rounded-lg bg-[#eef7fc] text-[#1455A0] flex items-center justify-center shrink-0`,children:(0,A.jsx)(yr,{size:18})}),(0,A.jsxs)(`div`,{children:[(0,A.jsx)(`span`,{className:`block text-[10px] text-slate-400 font-bold uppercase tracking-wider`,children:`Course`}),(0,A.jsx)(`span`,{className:`text-sm font-bold text-[#0B2D5C]`,children:s.course})]})]}),(s.duration||s.courseDuration)&&(0,A.jsxs)(`div`,{className:`flex items-center gap-4 p-3 bg-slate-50 rounded-xl border border-slate-100`,children:[(0,A.jsx)(`div`,{className:`w-10 h-10 rounded-lg bg-[#eef7fc] text-[#1455A0] flex items-center justify-center shrink-0`,children:(0,A.jsx)(pr,{size:18})}),(0,A.jsxs)(`div`,{children:[(0,A.jsx)(`span`,{className:`block text-[10px] text-slate-400 font-bold uppercase tracking-wider`,children:`Duration`}),(0,A.jsx)(`span`,{className:`text-sm font-bold text-[#0B2D5C]`,children:s.duration||s.courseDuration})]})]}),s.medium&&(0,A.jsxs)(`div`,{className:`flex items-center gap-4 p-3 bg-slate-50 rounded-xl border border-slate-100`,children:[(0,A.jsx)(`div`,{className:`w-10 h-10 rounded-lg bg-[#eef7fc] text-[#1455A0] flex items-center justify-center shrink-0`,children:(0,A.jsx)(tr,{size:18})}),(0,A.jsxs)(`div`,{children:[(0,A.jsx)(`span`,{className:`block text-[10px] text-slate-400 font-bold uppercase tracking-wider`,children:`Medium`}),(0,A.jsx)(`span`,{className:`text-sm font-bold text-[#0B2D5C]`,children:s.medium})]})]}),s.admission&&(0,A.jsxs)(`div`,{className:`flex items-center gap-4 p-3 bg-slate-50 rounded-xl border border-slate-100`,children:[(0,A.jsx)(`div`,{className:`w-10 h-10 rounded-lg bg-[#eef7fc] text-[#1455A0] flex items-center justify-center shrink-0`,children:(0,A.jsx)(ur,{size:18})}),(0,A.jsxs)(`div`,{children:[(0,A.jsx)(`span`,{className:`block text-[10px] text-slate-400 font-bold uppercase tracking-wider`,children:`Admission`}),(0,A.jsx)(`span`,{className:`text-sm font-bold text-[#0B2D5C]`,children:s.admission})]})]}),s.eligibility&&(0,A.jsxs)(`div`,{className:`flex items-center gap-4 p-3 bg-slate-50 rounded-xl border border-slate-100`,children:[(0,A.jsx)(`div`,{className:`w-10 h-10 rounded-lg bg-[#eef7fc] text-[#1455A0] flex items-center justify-center shrink-0`,children:(0,A.jsx)(ur,{size:18})}),(0,A.jsxs)(`div`,{children:[(0,A.jsx)(`span`,{className:`block text-[10px] text-slate-400 font-bold uppercase tracking-wider`,children:`Eligibility`}),(0,A.jsx)(`span`,{className:`text-sm font-bold text-[#0B2D5C]`,children:s.eligibility})]})]})]})]}),(0,A.jsxs)(`div`,{className:`bg-[#0B2D5C] text-white p-6 sm:p-8 rounded-2xl sm:rounded-3xl border border-[#0F366D] shadow-[0_8px_30px_rgba(11,45,92,0.15)] relative overflow-hidden`,children:[(0,A.jsx)(`div`,{className:`absolute -right-16 -bottom-16 w-36 h-36 rounded-full bg-white/5 pointer-events-none`}),(0,A.jsx)(`h3`,{className:`text-lg sm:text-xl font-bold tracking-tight`,children:`Interested in this University?`}),(0,A.jsx)(`p`,{className:`text-slate-300 text-xs sm:text-sm mt-2 leading-relaxed`,children:`Connect directly with our counseling experts to get complete guidance on admission eligibility, fee structures, and application procedures.`}),(0,A.jsxs)(`div`,{className:`mt-6 space-y-3.5`,children:[(0,A.jsxs)(jn,{to:`/contact`,className:`w-full inline-flex items-center justify-center gap-2 px-5 py-3 rounded-full bg-white hover:bg-slate-50 text-[#0B2D5C] text-xs sm:text-sm font-bold shadow-md transition-all duration-200`,children:[(0,A.jsx)(yr,{size:16}),`Get Free Guidance`]}),(0,A.jsxs)(`a`,{href:`https://wa.me/918830451660?text=${p}`,target:`_blank`,rel:`noopener noreferrer`,className:`w-full inline-flex items-center justify-center gap-2 px-5 py-3 rounded-full bg-[#25D366] hover:bg-[#1fb855] text-white text-xs sm:text-sm font-bold shadow-md transition-all duration-200`,children:[(0,A.jsx)(kr,{size:16}),`WhatsApp Consultation`]})]})]})]})]})}),r&&(0,A.jsx)(`div`,{className:`fixed inset-0 z-[9999] bg-black/80 backdrop-blur-sm flex items-center justify-center p-4`,onClick:()=>i(null),children:(0,A.jsxs)(`div`,{className:`relative max-w-6xl w-full max-h-[90vh]`,onClick:e=>e.stopPropagation(),children:[(0,A.jsx)(`img`,{src:r,alt:c.name,className:`w-full max-h-[85vh] object-contain rounded-2xl`}),(0,A.jsx)(`button`,{type:`button`,onClick:()=>i(null),className:`absolute top-3 right-3 w-10 h-10 rounded-full bg-black/60 text-white flex items-center justify-center hover:bg-black/80 transition`,"aria-label":`Close gallery`,children:`×`})]})})]})}function Xh(){return(0,A.jsxs)(An,{children:[(0,A.jsx)(xm,{}),(0,A.jsx)(Gr,{}),(0,A.jsx)(dm,{}),(0,A.jsxs)(Ut,{children:[(0,A.jsx)(Vt,{path:`/`,element:(0,A.jsx)(Xm,{})}),(0,A.jsx)(Vt,{path:`/about`,element:(0,A.jsx)(ih,{})}),(0,A.jsx)(Vt,{path:`/programs`,element:(0,A.jsx)(ah,{})}),(0,A.jsx)(Vt,{path:`/admissions`,element:(0,A.jsx)(uh,{})}),(0,A.jsx)(Vt,{path:`/gallery`,element:(0,A.jsx)(hh,{})}),(0,A.jsx)(Vt,{path:`/contact`,element:(0,A.jsx)(Mh,{})}),(0,A.jsx)(Vt,{path:`/university/:universityId`,element:(0,A.jsx)(Yh,{})})]}),(0,A.jsx)(vm,{}),(0,A.jsx)(ym,{}),(0,A.jsx)(bm,{})]})}Wr.createRoot(document.getElementById(`root`)).render((0,A.jsx)(x.StrictMode,{children:(0,A.jsx)(Xh,{})}));